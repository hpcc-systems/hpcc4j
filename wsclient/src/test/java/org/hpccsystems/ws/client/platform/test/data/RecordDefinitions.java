...
public class RecordDefinitions
{
    ...
    public static final String LAYOUT_DEF_STARTING_WITH__ = "__errx__ := RECORD,maxlength(2097152)\n  integer8 transaction_time{xpath('_call_latency_ms')};\n END;\n\n{ string fname1, integer8 did, DATASET(__errx__) ds };";
    public static final String RECORD_WITH_CURLY_BRACKET_BLOB_IN_FIELD = "RECORD\nSTRING data_content{blob,MAXLENGTH(20000)}; \nEND;";
}
