...
public class TraceparentTest
{
    ...
    public void testGetTraceParentHeaderWithSampledSpan()
    {
        ...
        SpanContext sampledContext = SpanContext.create("12345678901234567890123456789012", "1234567890123456", TraceFlags.getSampled(),
        ...
        assertTrue("Traceparent should contain sampled flag", traceparent.endsWith("-01") || traceparent.contains("-01"));
    }
    ...
    public void testGetTraceParentHeaderWithNonSampledSpan()
    {
        ...
        SpanContext nonSampledContext = SpanContext.create("12345678901234567890123456789012", "1234567890123456", TraceFlags.getDefault(), // Default is not sampled
                TraceState.getDefault());
        ...
        assertNotNull("Traceparent should not be null", traceparent);
        assertTrue("Traceparent should contain non-sampled flag", traceparent.endsWith("-00") || traceparent.contains("-00"));
    }
