...
public class WsResourcesClientTest extends BaseRemoteTest
{
    ...
    public void getWithCredentialsTest() throws Exception
    {
        ...
        HPCCWsResourcesClient credClient = HPCCWsResourcesClient.get("http", testHost, testPort, testUser, testPass);
    ...
    public void getWithTimeoutTest() throws Exception
    {
        ...
        HPCCWsResourcesClient timeoutClient = HPCCWsResourcesClient.get("http", testHost, testPort, testUser, testPass, testTimeout);
    ...
    public void testTargetQueryThorType() throws Exception
    {
        ...
        if (resp.getQueues() != null && resp.getQueues().getHPCCQueue() != null)
        {
            ...
            {
                assertTrue("All queues for type=Thor should be Thor type",
                        q.getType() == null || "Thor".equalsIgnoreCase(q.getType().getHPCCQueueType()));
            }
        }
    }
    ...
    public void testTargetQueryHThorType() throws Exception
    {
        ...
        if (resp.getQueues() != null && resp.getQueues().getHPCCQueue() != null)
        {
            for (HPCCQueueWrapper q : resp.getQueues().getHPCCQueue())
            {
                assertTrue("All queues for type=HThor should be HThor type",
                        q.getType() == null || "HThor".equalsIgnoreCase(q.getType().getHPCCQueueType()));
            }
        }
    }
    ...
    public void testTargetQueryAllTypeVerifyContents() throws Exception
    {
        ...
        if (queues != null && queues.getHPCCQueue() != null)
        {
            for (HPCCQueueWrapper q : queues.getHPCCQueue())
            {
                ...
                assertNotNull("Each queue should have a non-null type", q.getType());
                String typeStr = q.getType().getHPCCQueueType();
                assertTrue("Queue type should be Thor, HThor, or Roxie",
                        "Thor".equalsIgnoreCase(typeStr) || "HThor".equalsIgnoreCase(typeStr) || "Roxie".equalsIgnoreCase(typeStr));
            }
        }
    }
    ...
    public void testWebLinksContainerizedDiscoveredNonNull() throws Exception
    {
        ...
        assertNotNull("webLinks response should not be null", resp);
        ArrayOfDiscoveredWebLinkWrapper discovered = resp.getDiscoveredWebLinks();
        assertNotNull("discoveredWebLinks should be non-null on a containerized cluster", discovered);
