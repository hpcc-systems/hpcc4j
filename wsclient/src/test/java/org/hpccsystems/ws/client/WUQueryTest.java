...
public class WUQueryTest extends BaseRemoteTest
{
    ...
    public void testGetWorkunitSort() throws Exception
    {
        ...
        assumeTrue("Testing WU sortBy failed to create First WU!", null != createWU("OUTPUT('a');", thorclustername, "aTestWorkunitSortBA",
                "aTestUser", new ApplicationValueWrapper("AppA", "testkeyA", "testvalueA")));
        assumeTrue("Testing WU sortBy failed to create Second WU!", null != createWU("OUTPUT('b');", thorclustername, "bTestWorkunitSortBy",
                "bTestUser", new ApplicationValueWrapper("AppB", "testkeyB", "testvalueB")));
