...
public class UtilsTest
{
    ...
    public void testEnsureTrailingSlashTrailingWhiteSpace()
    {
        ...
        assertEquals(Character.toString(Utils.WIN_SEP) + Character.toString(Utils.LINUX_SEP),
                Utils.ensureTrailingPathSlash(Character.toString(Utils.WIN_SEP) + Character.toString(Utils.LINUX_SEP) + "\t"));
    ...
    public void testEnsureTrailingSlashNoSlashSpecified()
    {
        ...
        assertEquals(Character.toString(Utils.WIN_SEP) + Character.toString(Utils.LINUX_SEP),
                Utils.ensureTrailingPathSlash(Character.toString(Utils.WIN_SEP) + Character.toString(Utils.LINUX_SEP)));//no change expected
        assertEquals("C:\\some\\Path\\", Utils.ensureTrailingPathSlash("C:\\some\\Path"));
        assertEquals("C:\\some\\Path\\", Utils.ensureTrailingPathSlash("C:\\some\\Path\\"));
        assertEquals("/another/path/", Utils.ensureTrailingPathSlash("/another/path"));
        assertEquals("/another/path/", Utils.ensureTrailingPathSlash("/another/path/"));
    ...
    public void testEnsureTrailingSlashSlashSpecified()
    {
        ...
        assertEquals(Character.toString(Utils.LINUX_SEP) + Utils.WIN_SEP,
                Utils.ensureTrailingPathSlash(Character.toString(Utils.LINUX_SEP), Utils.WIN_SEP));
        ...
        assertEquals(Character.toString(Utils.WIN_SEP) + Character.toString(Utils.LINUX_SEP),
                Utils.ensureTrailingPathSlash(Character.toString(Utils.WIN_SEP), Utils.LINUX_SEP));
        assertEquals(Character.toString(Utils.WIN_SEP) + Character.toString(Utils.LINUX_SEP),
                Utils.ensureTrailingPathSlash(Character.toString(Utils.WIN_SEP) + Character.toString(Utils.LINUX_SEP), Utils.LINUX_SEP));
        assertEquals(Character.toString(Utils.WIN_SEP) + Character.toString(Utils.LINUX_SEP) + Character.toString(Utils.WIN_SEP),
                Utils.ensureTrailingPathSlash(Character.toString(Utils.WIN_SEP) + Character.toString(Utils.LINUX_SEP), Utils.WIN_SEP));
    ...
    public void testEnsureTrailingSlashUseLinuxBoolTest()
    {
        ...
        assertEquals(Character.toString(Utils.LINUX_SEP) + Utils.WIN_SEP,
                Utils.ensureTrailingPathSlash(Character.toString(Utils.LINUX_SEP), "false"));
        ...
        assertEquals(Character.toString(Utils.WIN_SEP) + Character.toString(Utils.LINUX_SEP),
                Utils.ensureTrailingPathSlash(Character.toString(Utils.WIN_SEP), "true"));
        assertEquals(Character.toString(Utils.WIN_SEP) + Character.toString(Utils.LINUX_SEP),
                Utils.ensureTrailingPathSlash(Character.toString(Utils.WIN_SEP) + Character.toString(Utils.LINUX_SEP), "true"));
        assertEquals(Character.toString(Utils.WIN_SEP) + Character.toString(Utils.LINUX_SEP) + Character.toString(Utils.WIN_SEP),
                Utils.ensureTrailingPathSlash(Character.toString(Utils.WIN_SEP) + Character.toString(Utils.LINUX_SEP), "false"));
