...
/**
 *  DFURecordTypeInfoResponse bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class DFURecordTypeInfoResponse implements org.apache.axis2.databinding.ADBBean {
    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("urn:hpccsystems:ws:wsdfu",
            "DFURecordTypeInfoResponse", "ns1");
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":DFURecordTypeInfoResponse", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "DFURecordTypeInfoResponse", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static DFURecordTypeInfoResponse parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            DFURecordTypeInfoResponse object = new DFURecordTypeInfoResponse();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"DFURecordTypeInfoResponse".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (DFURecordTypeInfoResponse) org.hpccsystems.ws.client.gen.axis2.wsdfu.latest.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
