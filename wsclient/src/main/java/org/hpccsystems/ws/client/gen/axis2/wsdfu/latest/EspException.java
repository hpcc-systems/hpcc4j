      ...
      try {
        ...
        while (!reader.isEndElement()) {
          if (reader.isStartElement()) {
            ...
            if (reader.isStartElement()
                && new javax.xml.namespace.QName("urn:hpccsystems:ws:wsdfu", "Code")
              ...
              reader.next();
                ...
                && new javax.xml.namespace.QName("urn:hpccsystems:ws:wsdfu", "Audience")
                    .equals(reader.getName())) {
              ...
              reader.next();
                ...
                && new javax.xml.namespace.QName("urn:hpccsystems:ws:wsdfu", "Message")
                    .equals(reader.getName())) {
