...
public class DFUXRefUnusedFilesRequest implements org.apache.axis2.databinding.ADBBean {
     ...
     */
    protected boolean localGetFileDetails = org.apache.axis2.databinding.utils.ConverterUtil.convertToBoolean(
            "false");
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":DFUXRefUnusedFilesRequest", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "DFUXRefUnusedFilesRequest", xmlWriter);
            }
        }
        ...
        if (localCheckPackageMapsTracker) {
            ...
            if (false) {
                throw new org.apache.axis2.databinding.ADBException(
                    "CheckPackageMaps cannot be null!!");
            } else {
    ...
    public static class Factory {
         ...
         */
        public static DFUXRefUnusedFilesRequest parse(
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"DFUXRefUnusedFilesRequest".equals(type)) {
                            ...
                            return (DFUXRefUnusedFilesRequest) org.hpccsystems.ws.client.gen.axis2.wsdfuxref.latest.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                    ...
                    if (reader.isStartElement()) {
                        if (reader.isStartElement() &&
                                new javax.xml.namespace.QName(
                                    "urn:hpccsystems:ws:wsdfuxref",
                                    "ProcessCluster").equals(reader.getName())) {
                         ...
                         if (reader.isStartElement() &&
                                new javax.xml.namespace.QName(
                                    "urn:hpccsystems:ws:wsdfuxref",
                                    "CheckPackageMaps").equals(reader.getName())) {
                            nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance",
                                    "nil");
                            ...
                            if ("true".equals(nillableValue) ||
                                    "1".equals(nillableValue)) {
                                throw new org.apache.axis2.databinding.ADBException(
                                    "The element: " + "CheckPackageMaps" +
                                    "  cannot be null");
                            }

                            java.lang.String content = reader.getElementText();

                            object.setCheckPackageMaps(org.apache.axis2.databinding.utils.ConverterUtil.convertToBoolean(
                                    content));
                         ...
                         if (reader.isStartElement() &&
                                new javax.xml.namespace.QName(
                                    "urn:hpccsystems:ws:wsdfuxref",
                                    "GetFileDetails").equals(reader.getName())) {
                            nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance",
                                    "nil");
                            ...
                            if ("true".equals(nillableValue) ||
                                    "1".equals(nillableValue)) {
                                throw new org.apache.axis2.databinding.ADBException(
                                    "The element: " + "GetFileDetails" +
                                    "  cannot be null");
                            }

                            java.lang.String content = reader.getElementText();

                            object.setGetFileDetails(org.apache.axis2.databinding.utils.ConverterUtil.convertToBoolean(
                                    content));
