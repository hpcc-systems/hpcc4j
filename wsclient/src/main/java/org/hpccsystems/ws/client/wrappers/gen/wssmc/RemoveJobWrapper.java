 ...
 * Wraps class: org.hpccsystems.ws.client.gen.axis2.wssmc.latest.RemoveJob
 * Output package : org.hpccsystems.ws.client.wrappers.gen.wssmc
 * TimeStamp: 2022-07-25T18:14:46.550Z
 */
public class RemoveJobWrapper
{
    ...
    public RemoveJobWrapper( org.hpccsystems.ws.client.gen.axis2.wssmc.latest.RemoveJob removejob)
    {
        copy( removejob );
    }
    ...
    private void copy( org.hpccsystems.ws.client.gen.axis2.wssmc.latest.RemoveJob raw )
    {
        if (raw == null)
            return;
    ...
    public org.hpccsystems.ws.client.gen.axis2.wssmc.latest.RemoveJob getRaw()
    {
        org.hpccsystems.ws.client.gen.axis2.wssmc.latest.RemoveJob raw = new org.hpccsystems.ws.client.gen.axis2.wssmc.latest.RemoveJob();
