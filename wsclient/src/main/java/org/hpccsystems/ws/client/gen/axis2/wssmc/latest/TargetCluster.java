...
public class TargetCluster implements org.apache.axis2.databinding.ADBBean {
  ...
  */
  ...
  public void serialize(
    ...
    if (serializeType) {
      ...
      if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
        writeAttribute(
            ...
            "type",
            namespacePrefix + ":TargetCluster",
            xmlWriter);
      } else {
        writeAttribute(
            "xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "TargetCluster", xmlWriter);
      }
    }
    ...
    if (localClusterStatusTracker) {
      ...
      if (localClusterStatus == java.lang.Integer.MIN_VALUE) {
        ...
        throw new org.apache.axis2.databinding.ADBException("ClusterStatus cannot be null!!");

      } else {
        xmlWriter.writeCharacters(
            org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localClusterStatus));
      }
  ...
  public static class Factory {
     ...
     */
    public static TargetCluster parse(javax.xml.stream.XMLStreamReader reader)
          ...
          if (reader.isStartElement()) {
            ...
            if (reader.isStartElement()
              ...
              reader.next();
                ...
                && new javax.xml.namespace.QName("urn:hpccsystems:ws:wssmc", "ClusterStatus")
                    .equals(reader.getName())) {
              ...
              if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
                throw new org.apache.axis2.databinding.ADBException(
                    "The element: " + "ClusterStatus" + "  cannot be null");
              }

              java.lang.String content = reader.getElementText();

              object.setClusterStatus(
                  org.apache.axis2.databinding.utils.ConverterUtil.convertToInt(content));
