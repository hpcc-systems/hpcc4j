...
public class TpDkcSlaveWrapper
{
    ...
    public TpDkcSlaveWrapper( org.hpccsystems.ws.client.gen.axis2.wstopology.latest.TpDkcSlave tpdkcslave)
    {
        copy( tpdkcslave );
    }
    ...
    private void copy( org.hpccsystems.ws.client.gen.axis2.wstopology.latest.TpDkcSlave raw )
    {
        if (raw == null)
            return;
    ...
    public org.hpccsystems.ws.client.gen.axis2.wstopology.latest.TpDkcSlave getRaw()
    {
        org.hpccsystems.ws.client.gen.axis2.wstopology.latest.TpDkcSlave raw = new org.hpccsystems.ws.client.gen.axis2.wstopology.latest.TpDkcSlave();
