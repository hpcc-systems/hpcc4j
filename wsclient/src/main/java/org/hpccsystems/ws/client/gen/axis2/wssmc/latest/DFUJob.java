...
public class DFUJob implements org.apache.axis2.databinding.ADBBean {
     ...
     * field for Done
     */
    protected int localDone;

    /*  This tracker boolean wil be used to detect whether the user called the set method
     *   for this attribute. It will be used to determine whether to include this field
     *   in the serialized XML
     */
    protected boolean localDoneTracker = false;
    ...
    public boolean isDoneSpecified() {
     ...
     * @param param Done
     */
    public void setDone(int param) {
        // setting primitive attribute tracker to true
        localDoneTracker = param != java.lang.Integer.MIN_VALUE;
    ...
    public void setTotal(int param) {
        // setting primitive attribute tracker to true
        localTotalTracker = param != java.lang.Integer.MIN_VALUE;
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":DFUJob", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "DFUJob", xmlWriter);
        ...
        if (localDoneTracker) {
            ...
            if (localDone == java.lang.Integer.MIN_VALUE) {
                throw new org.apache.axis2.databinding.ADBException(
                    "Done cannot be null!!");
            } else {
    ...
    public static class Factory {
         ...
         */
        public static DFUJob parse(javax.xml.stream.XMLStreamReader reader)
            throws java.lang.Exception {
            DFUJob object = new DFUJob();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"DFUJob".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (DFUJob) org.hpccsystems.ws.client.gen.axis2.wssmc.latest.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                    ...
                    if (reader.isStartElement()) {
                        if (reader.isStartElement() &&
                                new javax.xml.namespace.QName(
                                    "urn:hpccsystems:ws:wssmc", "TimeStarted").equals(
                                    reader.getName())) {
                         ...
                         if (reader.isStartElement() &&
                                new javax.xml.namespace.QName(
                                    "urn:hpccsystems:ws:wssmc", "Done").equals(
                                    reader.getName())) {
                            nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance",
                                    "nil");
                            ...
                            object.setDone(org.apache.axis2.databinding.utils.ConverterUtil.convertToInt(
                                    content));
                         ...
                         if (reader.isStartElement() &&
                                new javax.xml.namespace.QName(
                                    "urn:hpccsystems:ws:wssmc", "Total").equals(
                                    reader.getName())) {
                            nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance",
                                    "nil");
                            ...
                            object.setTotal(org.apache.axis2.databinding.utils.ConverterUtil.convertToInt(
                                    content));
