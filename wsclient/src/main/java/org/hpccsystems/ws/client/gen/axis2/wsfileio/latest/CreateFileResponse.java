...
public class CreateFileResponse implements org.apache.axis2.databinding.ADBBean {
  ...
  public static final javax.xml.namespace.QName MY_QNAME =
      new javax.xml.namespace.QName("urn:hpccsystems:ws:wsfileio", "CreateFileResponse", "ns1");
  ...
  public void serialize(
    ...
    if (serializeType) {
      ...
      if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
        writeAttribute(
            ...
            "type",
            namespacePrefix + ":CreateFileResponse",
            xmlWriter);
      } else {
        writeAttribute(
            "xsi",
    ...
    if (localExceptionsTracker) {
      ...
      localExceptions.serialize(
          new javax.xml.namespace.QName("urn:hpccsystems:ws:wsfileio", "Exceptions"), xmlWriter);
    }
  ...
  public static class Factory {
     ...
     */
    public static CreateFileResponse parse(javax.xml.stream.XMLStreamReader reader)
          ...
          if (reader.isStartElement()) {
            ...
            if (reader.isStartElement()
              ...
              object.setExceptions(
                  org.hpccsystems.ws.client.gen.axis2.wsfileio.latest.ArrayOfEspException.Factory
                      .parse(reader));
              ...
              reader.next();
                ...
                && new javax.xml.namespace.QName("urn:hpccsystems:ws:wsfileio", "Overwrite")
                    .equals(reader.getName())) {
              ...
              reader.next();
                ...
                && new javax.xml.namespace.QName("urn:hpccsystems:ws:wsfileio", "Result")
                    .equals(reader.getName())) {
