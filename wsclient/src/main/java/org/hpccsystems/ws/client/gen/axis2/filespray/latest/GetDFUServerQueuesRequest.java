...
/**
 *  GetDFUServerQueuesRequest bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class GetDFUServerQueuesRequest implements org.apache.axis2.databinding.ADBBean {
    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("urn:hpccsystems:ws:filespray",
            "GetDFUServerQueuesRequest", "ns1");
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":GetDFUServerQueuesRequest", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "GetDFUServerQueuesRequest", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static GetDFUServerQueuesRequest parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            GetDFUServerQueuesRequest object = new GetDFUServerQueuesRequest();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"GetDFUServerQueuesRequest".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (GetDFUServerQueuesRequest) org.hpccsystems.ws.client.gen.axis2.filespray.latest.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
