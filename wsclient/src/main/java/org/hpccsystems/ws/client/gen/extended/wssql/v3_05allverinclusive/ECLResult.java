...
public class ECLResult  implements java.io.Serializable {
    ...
    private org.hpccsystems.ws.client.gen.extended.wssql.v3_05allverinclusive.ECLSchemaItem[] ECLSchemas;
    ...
    public ECLResult(
           ...
           org.hpccsystems.ws.client.gen.extended.wssql.v3_05allverinclusive.ECLSchemaItem[] ECLSchemas,
     ...
     * @return ECLSchemas
     */
    public org.hpccsystems.ws.client.gen.extended.wssql.v3_05allverinclusive.ECLSchemaItem[] getECLSchemas() {
        return ECLSchemas;
    }
     ...
     * @param ECLSchemas
     */
    public void setECLSchemas(org.hpccsystems.ws.client.gen.extended.wssql.v3_05allverinclusive.ECLSchemaItem[] ECLSchemas) {
        this.ECLSchemas = ECLSchemas;
    }


    /**
     * Gets the xmlSchema value for this ECLResult.
     * 
     * @return xmlSchema
     */
    ...
    /**
     * Sets the xmlSchema value for this ECLResult.
     * 
     * @param xmlSchema
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:hpccsystems:ws:wssql", "ECLResult"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:hpccsystems:ws:wssql", "Sequence"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:hpccsystems:ws:wssql", "Value"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:hpccsystems:ws:wssql", "Link"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:hpccsystems:ws:wssql", "IsSupplied"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:hpccsystems:ws:wssql", "ShowFileContent"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "boolean"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:hpccsystems:ws:wssql", "Total"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:hpccsystems:ws:wssql", "ECLSchemas"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:hpccsystems:ws:wssql", "ECLSchemaItem"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        elemField.setItemQName(new javax.xml.namespace.QName("urn:hpccsystems:ws:wssql", "ECLSchemaItem"));
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("xmlSchema");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:hpccsystems:ws:wssql", "XmlSchema"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
