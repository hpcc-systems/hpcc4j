...
/**
 *  SavexmlResponse bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class SavexmlResponse implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":SavexmlResponse", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "SavexmlResponse", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static SavexmlResponse parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            SavexmlResponse object = new SavexmlResponse();
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"SavexmlResponse".equals(type)) {
                            ...
                            return (SavexmlResponse) org.hpccsystems.ws.client.gen.axis2.wsdfu.v1_51.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
