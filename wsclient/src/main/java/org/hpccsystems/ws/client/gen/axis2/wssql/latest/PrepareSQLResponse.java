...
public class PrepareSQLResponse implements org.apache.axis2.databinding.ADBBean {
  ...
  public static final javax.xml.namespace.QName MY_QNAME =
      new javax.xml.namespace.QName("urn:hpccsystems:ws:wssql", "PrepareSQLResponse", "ns10");
    ...
    if (serializeType) {
      ...
      if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
        writeAttribute(
            ...
            "type",
            namespacePrefix + ":PrepareSQLResponse",
            xmlWriter);
      } else {
        writeAttribute(
            "xsi",
  ...
  public static class Factory {
     ...
     */
    public static PrepareSQLResponse parse(javax.xml.stream.XMLStreamReader reader)
