...
public class Files_type1 implements org.apache.axis2.databinding.ADBBean {
  ...
  */
   ...
   * @param param File
   */
  public void setFile(org.hpccsystems.ws.client.gen.axis2.wsworkunits.v1_62.WUArchiveFile[] param) {
   ...
   */
  public void addFile(org.hpccsystems.ws.client.gen.axis2.wsworkunits.v1_62.WUArchiveFile param) {
    if (localFile == null) {
    ...
    list.add(param);
    this.localFile =
        (org.hpccsystems.ws.client.gen.axis2.wsworkunits.v1_62.WUArchiveFile[])
            list.toArray(
                new org.hpccsystems.ws.client.gen.axis2.wsworkunits.v1_62.WUArchiveFile
                    [list.size()]);
  }
    ...
    public static Files_type1 parse(javax.xml.stream.XMLStreamReader reader)
      ...
      try {
        ...
        if (reader.isStartElement()
          ...
          list1.add(
              org.hpccsystems.ws.client.gen.axis2.wsworkunits.v1_62.WUArchiveFile.Factory.parse(
                  reader));
          ...
          while (!loopDone1) {
            ...
            if (reader.isEndElement()) {
              ...
              if (new javax.xml.namespace.QName("urn:hpccsystems:ws:wsworkunits", "File")
                  .equals(reader.getName())) {
                list1.add(
                    org.hpccsystems.ws.client.gen.axis2.wsworkunits.v1_62.WUArchiveFile.Factory
                        .parse(reader));
