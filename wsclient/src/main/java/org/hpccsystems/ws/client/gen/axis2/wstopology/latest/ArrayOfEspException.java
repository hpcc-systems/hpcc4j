...
public class ArrayOfEspException implements org.apache.axis2.databinding.ADBBean {
  ...
  */
  ...
  public void addException(
    ...
    list.add(param);
    this.localException =
        (org.hpccsystems.ws.client.gen.axis2.wstopology.latest.EspException[])
            list.toArray(
                new org.hpccsystems.ws.client.gen.axis2.wstopology.latest.EspException
                    [list.size()]);
  }
        ...
        for (int i = 0; i < localException.length; i++) {
          if (localException[i] != null) {
            localException[i].serialize(
                new javax.xml.namespace.QName("urn:hpccsystems:ws:wstopology", "Exception"),
                xmlWriter);
          } else {
    ...
    public static ArrayOfEspException parse(javax.xml.stream.XMLStreamReader reader)
      ...
      try {
        ...
        if (reader.isStartElement()
            && new javax.xml.namespace.QName("urn:hpccsystems:ws:wstopology", "Source")
        ...
        if (reader.isStartElement()
          ...
          list2.add(
              org.hpccsystems.ws.client.gen.axis2.wstopology.latest.EspException.Factory.parse(
                  reader));
          ...
          while (!loopDone2) {
            ...
            if (reader.isEndElement()) {
              ...
              if (new javax.xml.namespace.QName("urn:hpccsystems:ws:wstopology", "Exception")
                  .equals(reader.getName())) {
                list2.add(
                    org.hpccsystems.ws.client.gen.axis2.wstopology.latest.EspException.Factory
                        .parse(reader));
