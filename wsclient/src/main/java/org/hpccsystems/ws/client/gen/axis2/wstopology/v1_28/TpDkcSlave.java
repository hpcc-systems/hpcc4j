...
/**
 *  TpDkcSlave bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class TpDkcSlave implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":TpDkcSlave", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "TpDkcSlave", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static TpDkcSlave parse(javax.xml.stream.XMLStreamReader reader)
            throws java.lang.Exception {
            TpDkcSlave object = new TpDkcSlave();
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"TpDkcSlave".equals(type)) {
                            ...
                            return (TpDkcSlave) org.hpccsystems.ws.client.gen.axis2.wstopology.v1_28.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
