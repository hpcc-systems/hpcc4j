 ...
 * Wraps class: org.hpccsystems.ws.client.gen.axis2.wssmc.latest.EspException
 * Output package : org.hpccsystems.ws.client.wrappers.gen.wssmc
 * TimeStamp: 2021-10-27T20:17:20.578Z
 */
public class EspExceptionWrapper
{
    ...
    public EspExceptionWrapper( org.hpccsystems.ws.client.gen.axis2.wssmc.latest.EspException espexception)
    {
        copy( espexception );
    }
    ...
    private void copy( org.hpccsystems.ws.client.gen.axis2.wssmc.latest.EspException raw )
    {
        if (raw == null)
            return;
    ...
    public org.hpccsystems.ws.client.gen.axis2.wssmc.latest.EspException getRaw()
    {
        org.hpccsystems.ws.client.gen.axis2.wssmc.latest.EspException raw = new org.hpccsystems.ws.client.gen.axis2.wssmc.latest.EspException();
