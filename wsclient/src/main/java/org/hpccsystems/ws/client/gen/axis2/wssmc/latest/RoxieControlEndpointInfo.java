...
public class RoxieControlEndpointInfo implements org.apache.axis2.databinding.ADBBean {
  ...
  */
  ...
  /** field for MemLocked */
  protected boolean localMemLocked;

  /*  This tracker boolean wil be used to detect whether the user called the set method
   *   for this attribute. It will be used to determine whether to include this field
   *   in the serialized XML
   */
  protected boolean localMemLockedTracker = false;

  public boolean isMemLockedSpecified() {
    return localMemLockedTracker;
  }
  ...
  public boolean getMemLocked() {
    return localMemLocked;
  }

  /**
   * Auto generated setter method
   *
   * @param param MemLocked
   */
  public void setMemLocked(boolean param) {

    // setting primitive attribute tracker to true
    localMemLockedTracker = true;

    this.localMemLocked = param;
  }
  ...
  public void serialize(
    ...
    if (serializeType) {
      ...
      if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
        writeAttribute(
            ...
            "type",
            namespacePrefix + ":RoxieControlEndpointInfo",
            xmlWriter);
      } else {
        writeAttribute(
            "xsi",
    ...
    if (localAttachedTracker) {
      ...
      if (false) {
        ...
        throw new org.apache.axis2.databinding.ADBException("Attached cannot be null!!");

      } else {
        xmlWriter.writeCharacters(
            org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localAttached));
      }
    ...
    if (localStateHashTracker) {
      ...
      if (localStateHash == null) {
        ...
        throw new org.apache.axis2.databinding.ADBException("StateHash cannot be null!!");
    ...
    if (localMemLockedTracker) {
      namespace = "urn:hpccsystems:ws:wssmc";
      writeStartElement(null, namespace, "MemLocked", xmlWriter);

      if (false) {

        throw new org.apache.axis2.databinding.ADBException("MemLocked cannot be null!!");

      } else {
        xmlWriter.writeCharacters(
            org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localMemLocked));
      }
  ...
  public static class Factory {
     ...
     */
    public static RoxieControlEndpointInfo parse(javax.xml.stream.XMLStreamReader reader)
      ...
      try {
        ...
        while (!reader.isEndElement()) {
          if (reader.isStartElement()) {
            ...
            if (reader.isStartElement()
                && new javax.xml.namespace.QName("urn:hpccsystems:ws:wssmc", "Address")
              ...
              reader.next();
                ...
                && new javax.xml.namespace.QName("urn:hpccsystems:ws:wssmc", "Attached")
                    .equals(reader.getName())) {
              ...
              if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
                throw new org.apache.axis2.databinding.ADBException(
                    "The element: " + "Attached" + "  cannot be null");
              }
              ...
              reader.next();
                ...
                && new javax.xml.namespace.QName("urn:hpccsystems:ws:wssmc", "StateHash")
                    .equals(reader.getName())) {
              ...
              if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
                throw new org.apache.axis2.databinding.ADBException(
                    "The element: " + "StateHash" + "  cannot be null");
              }
              ...
              reader.next();
                ...
                && new javax.xml.namespace.QName("urn:hpccsystems:ws:wssmc", "Status")
                    .equals(reader.getName())) {
              ...
              reader.next();
                ...
                && new javax.xml.namespace.QName("urn:hpccsystems:ws:wssmc", "MemLocked")
                    .equals(reader.getName())) {
              ...
              if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
                throw new org.apache.axis2.databinding.ADBException(
                    "The element: " + "MemLocked" + "  cannot be null");
              }
