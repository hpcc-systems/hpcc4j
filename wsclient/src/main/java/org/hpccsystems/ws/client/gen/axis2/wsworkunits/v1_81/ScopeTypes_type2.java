...
public class ScopeTypes_type2 implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":ScopeTypes_type2", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "ScopeTypes_type2", xmlWriter);
            }
        }
            ...
            if (localScopeType != null) {
                ...
                for (int i = 0; i < localScopeType.length; i++) {
                    if (localScopeType[i] != null) {
                        writeStartElement(null, namespace, "ScopeType",
                            xmlWriter);
    ...
    public static class Factory {
         ...
         */
        public static ScopeTypes_type2 parse(
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"ScopeTypes_type2".equals(type)) {
                            ...
                            return (ScopeTypes_type2) org.hpccsystems.ws.client.gen.axis2.wsworkunits.v1_81.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName(
                            "urn:hpccsystems:ws:wsworkunits", "ScopeType").equals(
                            reader.getName())) {
                    ...
                    object.setScopeType((java.lang.String[]) list1.toArray(
