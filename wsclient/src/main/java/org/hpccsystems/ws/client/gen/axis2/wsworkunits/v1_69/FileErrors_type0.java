...
public class FileErrors_type0 implements org.apache.axis2.databinding.ADBBean {
  ...
  */
  ...
  public void addFile(
    ...
    list.add(param);
    this.localFile =
        (org.hpccsystems.ws.client.gen.axis2.wsworkunits.v1_69.LogicalFileError[])
            list.toArray(
                new org.hpccsystems.ws.client.gen.axis2.wsworkunits.v1_69.LogicalFileError
                    [list.size()]);
  }
    ...
    public static FileErrors_type0 parse(javax.xml.stream.XMLStreamReader reader)
      ...
      try {
        ...
        if (reader.isStartElement()
          ...
          list1.add(
              org.hpccsystems.ws.client.gen.axis2.wsworkunits.v1_69.LogicalFileError.Factory.parse(
                  reader));
          ...
          while (!loopDone1) {
            ...
            if (reader.isEndElement()) {
              ...
              if (new javax.xml.namespace.QName("urn:hpccsystems:ws:wsworkunits", "File")
                  .equals(reader.getName())) {
                list1.add(
                    org.hpccsystems.ws.client.gen.axis2.wsworkunits.v1_69.LogicalFileError.Factory
                        .parse(reader));
