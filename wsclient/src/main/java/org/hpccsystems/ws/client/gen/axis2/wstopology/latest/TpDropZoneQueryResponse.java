...
public class TpDropZoneQueryResponse implements org.apache.axis2.databinding.ADBBean {
  ...
  public static final javax.xml.namespace.QName MY_QNAME =
      new javax.xml.namespace.QName(
          "urn:hpccsystems:ws:wstopology", "TpDropZoneQueryResponse", "ns12");
    ...
    if (serializeType) {
      ...
      if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
        writeAttribute(
            ...
            "type",
            namespacePrefix + ":TpDropZoneQueryResponse",
            xmlWriter);
      } else {
        writeAttribute(
            "xsi",
  ...
  public static class Factory {
     ...
     */
    public static TpDropZoneQueryResponse parse(javax.xml.stream.XMLStreamReader reader)
