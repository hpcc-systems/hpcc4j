...
/**
 *  DFUDefFileResponse bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class DFUDefFileResponse implements org.apache.axis2.databinding.ADBBean {
    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("urn:hpccsystems:ws:wsdfu",
            "DFUDefFileResponse", "ns3");
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":DFUDefFileResponse", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "DFUDefFileResponse", xmlWriter);
            }
        }
            ...
            if (localDefFile != null) {
                try {
                    org.apache.axiom.util.stax.XMLStreamWriterUtils.writeDataHandler(xmlWriter,
                        localDefFile, null, true);
                } catch (java.io.IOException ex) {
                    throw new javax.xml.stream.XMLStreamException("Unable to read data handler for defFile",
                        ex);
                }
            } else {
            }
    ...
    public static class Factory {
         ...
         */
        public static DFUDefFileResponse parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            DFUDefFileResponse object = new DFUDefFileResponse();
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"DFUDefFileResponse".equals(type)) {
                            ...
                            return (DFUDefFileResponse) org.hpccsystems.ws.client.gen.axis2.wsdfu.v1_51.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                while (!reader.isEndElement()) {
                    if (reader.isStartElement()) {
                        if (reader.isStartElement() &&
                         ...
                         if (reader.isStartElement() &&
                                new javax.xml.namespace.QName(
                                    "urn:hpccsystems:ws:wsdfu", "defFile").equals(
                                    reader.getName())) {
                            object.setDefFile(org.apache.axiom.util.stax.XMLStreamReaderUtils.getDataHandlerFromElement(
                                    reader));
