...
/**
 *  MoveJobDown bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class MoveJobDown implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":MoveJobDown", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "MoveJobDown", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static MoveJobDown parse(javax.xml.stream.XMLStreamReader reader)
            throws java.lang.Exception {
            MoveJobDown object = new MoveJobDown();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"MoveJobDown".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (MoveJobDown) org.hpccsystems.ws.client.gen.axis2.wssmc.latest.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
