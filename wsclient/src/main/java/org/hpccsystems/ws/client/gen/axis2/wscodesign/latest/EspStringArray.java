...
public class EspStringArray implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":EspStringArray", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "EspStringArray", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static EspStringArray parse(
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"EspStringArray".equals(type)) {
                            ...
                            return (EspStringArray) org.hpccsystems.ws.client.gen.axis2.wscodesign.latest.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName(
                            "urn:hpccsystems:ws:ws_codesign", "Item").equals(
                            reader.getName())) {
