 ...
 * Class name: SuperFiles_type1Wrapper
 * Wraps class: org.hpccsystems.ws.client.gen.axis2.wsworkunits.latest.SuperFiles_type1
...
public class SuperFiles_type1Wrapper
{
    ...
    public SuperFiles_type1Wrapper( org.hpccsystems.ws.client.gen.axis2.wsworkunits.latest.SuperFiles_type1 superfiles_type1)
    {
        copy( superfiles_type1 );
    }
    public SuperFiles_type1Wrapper( List<QuerySuperFileWrapper> _superFile )
    {
        this.local_superFile = _superFile;

    }

    private void copy( org.hpccsystems.ws.client.gen.axis2.wsworkunits.latest.SuperFiles_type1 raw )
    {
        if (raw == null)
            return;
    ...
    {
        return "SuperFiles_type1Wrapper [" + "superFile = " + local_superFile + "]";
    }
    public org.hpccsystems.ws.client.gen.axis2.wsworkunits.latest.SuperFiles_type1 getRaw()
    {
        org.hpccsystems.ws.client.gen.axis2.wsworkunits.latest.SuperFiles_type1 raw = new org.hpccsystems.ws.client.gen.axis2.wsworkunits.latest.SuperFiles_type1();
