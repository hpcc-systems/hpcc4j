...
/**
 *  EclRecordTypeInfoResponse bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class EclRecordTypeInfoResponse implements org.apache.axis2.databinding.ADBBean {
    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("urn:hpccsystems:ws:wsdfu",
            "EclRecordTypeInfoResponse", "ns1");
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":EclRecordTypeInfoResponse", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "EclRecordTypeInfoResponse", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static EclRecordTypeInfoResponse parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            EclRecordTypeInfoResponse object = new EclRecordTypeInfoResponse();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"EclRecordTypeInfoResponse".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (EclRecordTypeInfoResponse) org.hpccsystems.ws.client.gen.axis2.wsdfu.latest.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
