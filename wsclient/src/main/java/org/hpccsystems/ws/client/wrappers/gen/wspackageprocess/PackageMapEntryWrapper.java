 ...
 * TimeStamp: 2022-07-25T17:42:18.174Z
 */
public class PackageMapEntryWrapper
{
    ...
    public PackageMapEntryWrapper( org.hpccsystems.ws.client.gen.axis2.wspackageprocess.latest.PackageMapEntry packagemapentry)
    {
    ...
    private void copy( org.hpccsystems.ws.client.gen.axis2.wspackageprocess.latest.PackageMapEntry raw )
    {
        if (raw == null)
            return;
    ...
    public org.hpccsystems.ws.client.gen.axis2.wspackageprocess.latest.PackageMapEntry getRaw()
    {
        org.hpccsystems.ws.client.gen.axis2.wspackageprocess.latest.PackageMapEntry raw = new org.hpccsystems.ws.client.gen.axis2.wspackageprocess.latest.PackageMapEntry();
        raw.setId( local_id);
