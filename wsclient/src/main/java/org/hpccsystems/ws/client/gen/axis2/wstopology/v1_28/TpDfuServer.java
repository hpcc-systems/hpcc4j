...
/**
 *  TpDfuServer bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class TpDfuServer implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":TpDfuServer", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "TpDfuServer", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static TpDfuServer parse(javax.xml.stream.XMLStreamReader reader)
            throws java.lang.Exception {
            TpDfuServer object = new TpDfuServer();
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"TpDfuServer".equals(type)) {
                            ...
                            return (TpDfuServer) org.hpccsystems.ws.client.gen.axis2.wstopology.v1_28.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
