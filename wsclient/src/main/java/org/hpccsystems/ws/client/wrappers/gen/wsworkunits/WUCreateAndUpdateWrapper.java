 ...
 * Class name: WUCreateAndUpdateWrapper
 * Wraps class: org.hpccsystems.ws.client.gen.axis2.wsworkunits.latest.WUCreateAndUpdate
 * Output package : org.hpccsystems.ws.client.wrappers.gen.wsworkunits
 * TimeStamp: 2022-07-22T20:33:16.894Z
 */
public class WUCreateAndUpdateWrapper
{
    ...
    public WUCreateAndUpdateWrapper( org.hpccsystems.ws.client.gen.axis2.wsworkunits.latest.WUCreateAndUpdate wucreateandupdate)
    {
        copy( wucreateandupdate );
    }
    public WUCreateAndUpdateWrapper( String _wuid, int _state, int _stateOrig, String _jobname, String _jobnameOrig, String _queryText, int _action, String _description, String _descriptionOrig, boolean _addDrilldownFields, int _resultLimit, boolean _protected, boolean _protectedOrig, int _priorityClass, int _priorityLevel, String _scope, String _scopeOrig, String _clusterSelection, String _clusterOrig, String _xmlParams, String _thorSlaveIP, String _queryMainDefinition, ArrayOfDebugValueWrapper _debugValues, ArrayOfApplicationValueWrapper _applicationValues )
    {
    ...
    private void copy( org.hpccsystems.ws.client.gen.axis2.wsworkunits.latest.WUCreateAndUpdate raw )
    {
        if (raw == null)
            return;
