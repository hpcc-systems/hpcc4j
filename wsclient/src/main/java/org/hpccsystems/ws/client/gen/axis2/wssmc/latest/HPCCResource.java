...
/** HPCCResource bean class */
@SuppressWarnings({"unchecked", "unused"})
public class HPCCResource implements org.apache.axis2.databinding.ADBBean {
  ...
  */
    ...
    if (serializeType) {
      ...
      if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
        writeAttribute(
            ...
            "type",
            namespacePrefix + ":HPCCResource",
            xmlWriter);
      } else {
        writeAttribute(
            "xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "HPCCResource", xmlWriter);
      }
    }
    if (localNameTracker) {
  ...
  public static class Factory {
     ...
     */
    public static HPCCResource parse(javax.xml.stream.XMLStreamReader reader)
        throws java.lang.Exception {
      HPCCResource object = new HPCCResource();
          ...
          if (reader.isStartElement()) {
            ...
            if (reader.isStartElement()
              ...
              reader.next();
                ...
                && new javax.xml.namespace.QName("urn:hpccsystems:ws:wssmc", "Description")
                    .equals(reader.getName())) {
              ...
              reader.next();
                ...
                && new javax.xml.namespace.QName("urn:hpccsystems:ws:wssmc", "FileName")
                    .equals(reader.getName())) {
              ...
              reader.next();
                ...
                && new javax.xml.namespace.QName("urn:hpccsystems:ws:wssmc", "Version")
                    .equals(reader.getName())) {
