...
public class ListESDLBindingsResponse  implements java.io.Serializable {
    ...
    private org.hpccsystems.ws.client.gen.wsesdlconfig.v1_4.EspProcessStruct[] espProcesses;
    ...
    public ListESDLBindingsResponse(
           ...
           org.hpccsystems.ws.client.gen.wsesdlconfig.v1_4.EspProcessStruct[] espProcesses) {
           this.exceptions = exceptions;
           this.bindingsXML = bindingsXML;
           this.espProcesses = espProcesses;
    }
    ...
    /**
     * Gets the espProcesses value for this ListESDLBindingsResponse.
     * 
     * @return espProcesses
     */
    public org.hpccsystems.ws.client.gen.wsesdlconfig.v1_4.EspProcessStruct[] getEspProcesses() {
        return espProcesses;
    }


    /**
     * Sets the espProcesses value for this ListESDLBindingsResponse.
     * 
     * @param espProcesses
     */
    public void setEspProcesses(org.hpccsystems.ws.client.gen.wsesdlconfig.v1_4.EspProcessStruct[] espProcesses) {
        this.espProcesses = espProcesses;
    }
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        ...
        _equals = true && 
            ...
            ((this.espProcesses==null && other.getEspProcesses()==null) || 
             (this.espProcesses!=null &&
              java.util.Arrays.equals(this.espProcesses, other.getEspProcesses())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getEspProcesses() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getEspProcesses());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getEspProcesses(), i);
                if (obj != null &&
    ...
    static {
        ...
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("espProcesses");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:hpccsystems:ws:wsesdlconfig", "EspProcesses"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:hpccsystems:ws:wsesdlconfig", "EspProcessStruct"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        elemField.setItemQName(new javax.xml.namespace.QName("urn:hpccsystems:ws:wsesdlconfig", "EspProcess"));
        typeDesc.addFieldDesc(elemField);
    }
