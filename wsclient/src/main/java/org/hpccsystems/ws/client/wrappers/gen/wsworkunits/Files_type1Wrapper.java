 ...
 * Class name: Files_type1Wrapper
 * Wraps class: org.hpccsystems.ws.client.gen.axis2.wsworkunits.latest.Files_type1
...
public class Files_type1Wrapper
{
    ...
    public Files_type1Wrapper( org.hpccsystems.ws.client.gen.axis2.wsworkunits.latest.Files_type1 files_type1)
    {
        copy( files_type1 );
    }
    public Files_type1Wrapper( List<WUArchiveFileWrapper> _file )
    {
        this.local_file = _file;

    }

    private void copy( org.hpccsystems.ws.client.gen.axis2.wsworkunits.latest.Files_type1 raw )
    {
        if (raw == null)
            return;
    ...
    {
        return "Files_type1Wrapper [" + "file = " + local_file + "]";
    }
    public org.hpccsystems.ws.client.gen.axis2.wsworkunits.latest.Files_type1 getRaw()
    {
        org.hpccsystems.ws.client.gen.axis2.wsworkunits.latest.Files_type1 raw = new org.hpccsystems.ws.client.gen.axis2.wsworkunits.latest.Files_type1();
