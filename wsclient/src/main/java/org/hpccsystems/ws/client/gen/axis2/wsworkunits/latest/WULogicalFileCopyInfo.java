                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"WULogicalFileCopyInfo".equals(type)) {
                            ...
                            return (WULogicalFileCopyInfo) org.hpccsystems.ws.client.gen.axis2.wsworkunits.latest.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                        ...
                        if (reader.isStartElement() &&
                         ...
                         if (reader.isStartElement() &&
                                new javax.xml.namespace.QName(
                                    ...
                                    reader.getName())) {
                            object.setClusters(org.hpccsystems.ws.client.gen.axis2.wsworkunits.latest.EspStringArray.Factory.parse(
                                    reader));
