...
/**
 *  GetPartFromPackageMapRequest bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class GetPartFromPackageMapRequest implements org.apache.axis2.databinding.ADBBean {
    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("urn:hpccsystems:ws:wspackageprocess",
            "GetPartFromPackageMapRequest", "ns7");
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":GetPartFromPackageMapRequest", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "GetPartFromPackageMapRequest", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static GetPartFromPackageMapRequest parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            GetPartFromPackageMapRequest object = new GetPartFromPackageMapRequest();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"GetPartFromPackageMapRequest".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (GetPartFromPackageMapRequest) org.hpccsystems.ws.client.gen.axis2.wspackageprocess.latest.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
