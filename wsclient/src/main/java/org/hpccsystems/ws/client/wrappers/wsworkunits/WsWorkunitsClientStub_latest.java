...
@Deprecated
public class WsWorkunitsClientStub_latest implements IWsWorkunitsClientStubWrapper
{

    private Connection connection;

    /**
     * Instantiates a new ws workunits client stub.
     *
     * @param connection
     *            the connection
     */
    public WsWorkunitsClientStub_latest(final Connection connection)
    {
