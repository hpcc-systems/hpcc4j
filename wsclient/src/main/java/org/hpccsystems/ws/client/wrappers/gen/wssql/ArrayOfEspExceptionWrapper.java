 ...
 * Wraps class: org.hpccsystems.ws.client.gen.axis2.wssql.latest.ArrayOfEspException
...
public class ArrayOfEspExceptionWrapper
{
    ...
    private void copy( org.hpccsystems.ws.client.gen.axis2.wssql.latest.ArrayOfEspException raw )
    {
        if (raw == null)
            return;
    ...
    public org.hpccsystems.ws.client.gen.axis2.wssql.latest.ArrayOfEspException getRaw()
    {
        org.hpccsystems.ws.client.gen.axis2.wssql.latest.ArrayOfEspException raw = new org.hpccsystems.ws.client.gen.axis2.wssql.latest.ArrayOfEspException();
        raw.setSource( local_source);
        if (this.local_exception!= null)
        {
            org.hpccsystems.ws.client.gen.axis2.wssql.latest.EspException[] arr = new org.hpccsystems.ws.client.gen.axis2.wssql.latest.EspException[this.local_exception.size()];
