...
/** StoreInfo bean class */
@SuppressWarnings({"unchecked", "unused"})
public class StoreInfo implements org.apache.axis2.databinding.ADBBean {
  ...
  */
  ...
  /** field for MaxValSize */
  protected java.lang.String localMaxValSize;

  /*  This tracker boolean wil be used to detect whether the user called the set method
   *   for this attribute. It will be used to determine whether to include this field
   *   in the serialized XML
   */
  protected boolean localMaxValSizeTracker = false;

  public boolean isMaxValSizeSpecified() {
    return localMaxValSizeTracker;
  }
   ...
   * @return java.lang.String
   */
  public java.lang.String getMaxValSize() {
    return localMaxValSize;
  }

  /**
   * Auto generated setter method
   *
   * @param param MaxValSize
   */
  public void setMaxValSize(java.lang.String param) {
    localMaxValSizeTracker = param != null;

    this.localMaxValSize = param;
  }
  ...
  public void serialize(
    ...
    if (serializeType) {
      ...
      if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
        writeAttribute(
            ...
            "type",
            namespacePrefix + ":StoreInfo",
            xmlWriter);
      } else {
        writeAttribute(
            "xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "StoreInfo", xmlWriter);
      }
    }
    if (localNameTracker) {
    ...
    if (localMaxValSizeTracker) {
      namespace = "urn:hpccsystems:ws:wsstore";
      writeStartElement(null, namespace, "MaxValSize", xmlWriter);

      if (localMaxValSize == null) {
        // write the nil attribute

        throw new org.apache.axis2.databinding.ADBException("MaxValSize cannot be null!!");

      } else {

        xmlWriter.writeCharacters(localMaxValSize);
      }
  ...
  public static class Factory {
     ...
     */
    public static StoreInfo parse(javax.xml.stream.XMLStreamReader reader)
        throws java.lang.Exception {
      StoreInfo object = new StoreInfo();
          ...
          if (reader.isStartElement()) {
            ...
            if (reader.isStartElement()
              ...
              reader.next();
                ...
                && new javax.xml.namespace.QName("urn:hpccsystems:ws:wsstore", "Owner")
                    .equals(reader.getName())) {
              ...
              reader.next();
                ...
                && new javax.xml.namespace.QName("urn:hpccsystems:ws:wsstore", "CreateTime")
                    .equals(reader.getName())) {
              ...
              reader.next();
                ...
                && new javax.xml.namespace.QName("urn:hpccsystems:ws:wsstore", "MaxValSize")
                    .equals(reader.getName())) {
              ...
              if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
                throw new org.apache.axis2.databinding.ADBException(
                    "The element: " + "MaxValSize" + "  cannot be null");
              }

              java.lang.String content = reader.getElementText();

              object.setMaxValSize(
                  org.apache.axis2.databinding.utils.ConverterUtil.convertToString(content));
              ...
              reader.next();
                ...
                && new javax.xml.namespace.QName("urn:hpccsystems:ws:wsstore", "IsDefault")
                    .equals(reader.getName())) {
