 ...
 * Wraps class: org.hpccsystems.ws.client.gen.axis2.wssmc.latest.ArrayOfEspException
 * Output package : org.hpccsystems.ws.client.wrappers.gen.wssmc
 * TimeStamp: 2021-10-27T20:17:20.564Z
 */
public class ArrayOfEspExceptionWrapper
{
    ...
    private void copy( org.hpccsystems.ws.client.gen.axis2.wssmc.latest.ArrayOfEspException raw )
    {
        if (raw == null)
            return;
    ...
    public org.hpccsystems.ws.client.gen.axis2.wssmc.latest.ArrayOfEspException getRaw()
    {
        org.hpccsystems.ws.client.gen.axis2.wssmc.latest.ArrayOfEspException raw = new org.hpccsystems.ws.client.gen.axis2.wssmc.latest.ArrayOfEspException();
        raw.setSource( local_source);
        if (this.local_exception!= null)
        {
            org.hpccsystems.ws.client.gen.axis2.wssmc.latest.EspException[] arr = new org.hpccsystems.ws.client.gen.axis2.wssmc.latest.EspException[this.local_exception.size()];
