...
/**
 *  TpEclServer bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class TpEclServer implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":TpEclServer", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "TpEclServer", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static TpEclServer parse(javax.xml.stream.XMLStreamReader reader)
            throws java.lang.Exception {
            TpEclServer object = new TpEclServer();
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"TpEclServer".equals(type)) {
                            ...
                            return (TpEclServer) org.hpccsystems.ws.client.gen.axis2.wstopology.v1_28.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
