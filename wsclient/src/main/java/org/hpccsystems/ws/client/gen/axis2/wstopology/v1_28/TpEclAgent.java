...
/**
 *  TpEclAgent bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class TpEclAgent implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":TpEclAgent", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "TpEclAgent", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static TpEclAgent parse(javax.xml.stream.XMLStreamReader reader)
            throws java.lang.Exception {
            TpEclAgent object = new TpEclAgent();
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"TpEclAgent".equals(type)) {
                            ...
                            return (TpEclAgent) org.hpccsystems.ws.client.gen.axis2.wstopology.v1_28.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                while (!reader.isEndElement()) {
                    if (reader.isStartElement()) {
                        if (reader.isStartElement() &&
                         ...
                         if (reader.isStartElement() &&
                                new javax.xml.namespace.QName(
                                    "urn:hpccsystems:ws:wstopology", "LogDir").equals(
                                    reader.getName())) {
                            nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance",
                                    "nil");
                            ...
                            object.setLogDir(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                                    content));
