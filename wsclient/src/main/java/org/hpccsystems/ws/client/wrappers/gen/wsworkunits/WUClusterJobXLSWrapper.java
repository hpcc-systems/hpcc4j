 ...
 * Class name: WUClusterJobXLSWrapper
 * Wraps class: org.hpccsystems.ws.client.gen.axis2.wsworkunits.latest.WUClusterJobXLS
 * Output package : org.hpccsystems.ws.client.wrappers.gen.wsworkunits
 * TimeStamp: 2022-07-22T20:33:16.887Z
 */
public class WUClusterJobXLSWrapper
{
    ...
    public WUClusterJobXLSWrapper( org.hpccsystems.ws.client.gen.axis2.wsworkunits.latest.WUClusterJobXLS wuclusterjobxls)
    {
        copy( wuclusterjobxls );
    }
    public WUClusterJobXLSWrapper( String _cluster, String _startDate, String _endDate, boolean _showAll, String _businessStartTime, String _businessEndTime )
    {
    ...
    private void copy( org.hpccsystems.ws.client.gen.axis2.wsworkunits.latest.WUClusterJobXLS raw )
    {
        if (raw == null)
            return;
    ...
    {
        return "WUClusterJobXLSWrapper [" + "cluster = " + local_cluster + ", " + "startDate = " + local_startDate + ", " + "endDate = " + local_endDate + ", " + "showAll = " + local_showAll + ", " + "businessStartTime = " + local_businessStartTime + ", " + "businessEndTime = " + local_businessEndTime + "]";
    }
    public org.hpccsystems.ws.client.gen.axis2.wsworkunits.latest.WUClusterJobXLS getRaw()
    {
        org.hpccsystems.ws.client.gen.axis2.wsworkunits.latest.WUClusterJobXLS raw = new org.hpccsystems.ws.client.gen.axis2.wsworkunits.latest.WUClusterJobXLS();
