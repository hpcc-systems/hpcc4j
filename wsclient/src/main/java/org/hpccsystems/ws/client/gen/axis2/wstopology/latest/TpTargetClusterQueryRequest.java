...
/**
 *  TpTargetClusterQueryRequest bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class TpTargetClusterQueryRequest implements org.apache.axis2.databinding.ADBBean {
    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("urn:hpccsystems:ws:wstopology",
            "TpTargetClusterQueryRequest", "ns3");
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":TpTargetClusterQueryRequest", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "TpTargetClusterQueryRequest", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static TpTargetClusterQueryRequest parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            TpTargetClusterQueryRequest object = new TpTargetClusterQueryRequest();
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"TpTargetClusterQueryRequest".equals(type)) {
                            ...
                            return (TpTargetClusterQueryRequest) org.hpccsystems.ws.client.gen.axis2.wstopology.latest.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
