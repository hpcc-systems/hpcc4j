                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"GetDBSystemInfoResponse".equals(type)) {
                            ...
                            return (GetDBSystemInfoResponse) org.hpccsystems.ws.client.gen.axis2.wssql.latest.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                    ...
                    if (reader.isStartElement()) {
                        if (reader.isStartElement() &&
                                new javax.xml.namespace.QName(
                                    ...
                                    reader.getName())) {
                            object.setExceptions(org.hpccsystems.ws.client.gen.axis2.wssql.latest.ArrayOfEspException.Factory.parse(
                                    reader));
