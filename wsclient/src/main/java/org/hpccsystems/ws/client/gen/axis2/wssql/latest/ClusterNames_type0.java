...
public class ClusterNames_type0 implements org.apache.axis2.databinding.ADBBean {
  ...
  */
  ...
  /** field for ClusterName This was an Array! */
  ...
  public static class Factory {
     ...
     */
    public static ClusterNames_type0 parse(javax.xml.stream.XMLStreamReader reader)
      ...
      try {
        ...
        if (reader.isStartElement()
            && new javax.xml.namespace.QName("urn:hpccsystems:ws:wssql", "ClusterName")
          ...
          while (!loopDone1) {
            ...
            if (reader.isEndElement()) {
              ...
              if (new javax.xml.namespace.QName("urn:hpccsystems:ws:wssql", "ClusterName")
                  .equals(reader.getName())) {
                list1.add(reader.getElementText());
