...
/**
 *  Replicate bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class Replicate implements org.apache.axis2.databinding.ADBBean {
     ...
     */
    protected boolean localRepeatLast = org.apache.axis2.databinding.utils.ConverterUtil.convertToBoolean(
            "false");
     ...
     */
    protected boolean localOnlyRepeated = org.apache.axis2.databinding.utils.ConverterUtil.convertToBoolean(
            "false");
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":Replicate", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "Replicate", xmlWriter);
    ...
    public static class Factory {
         ...
         */
        public static Replicate parse(javax.xml.stream.XMLStreamReader reader)
            throws java.lang.Exception {
            Replicate object = new Replicate();
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"Replicate".equals(type)) {
                            ...
                            return (Replicate) org.hpccsystems.ws.client.gen.axis2.filespray.latest.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                while (!reader.isEndElement()) {
                    if (reader.isStartElement()) {
                        if (reader.isStartElement() &&
                         ...
                         if (reader.isStartElement() &&
                                new javax.xml.namespace.QName(
                                    "urn:hpccsystems:ws:filespray", "repeatLast").equals(
                                    reader.getName())) {
                            nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance",
                                    "nil");
                            ...
                            if ("true".equals(nillableValue) ||
                                    "1".equals(nillableValue)) {
                                throw new org.apache.axis2.databinding.ADBException(
                                    "The element: " + "repeatLast" +
                                    "  cannot be null");
                            }

                            java.lang.String content = reader.getElementText();

                            object.setRepeatLast(org.apache.axis2.databinding.utils.ConverterUtil.convertToBoolean(
                                    content));
                         ...
                         if (reader.isStartElement() &&
                                new javax.xml.namespace.QName(
                                    "urn:hpccsystems:ws:filespray",
                                    "onlyRepeated").equals(reader.getName())) {
                            nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance",
                                    "nil");
                            ...
                            if ("true".equals(nillableValue) ||
                                    "1".equals(nillableValue)) {
                                throw new org.apache.axis2.databinding.ADBException(
                                    "The element: " + "onlyRepeated" +
                                    "  cannot be null");
                            }

                            java.lang.String content = reader.getElementText();

                            object.setOnlyRepeated(org.apache.axis2.databinding.utils.ConverterUtil.convertToBoolean(
                                    content));
