...
public class ErrorMessageFormat implements org.apache.axis2.databinding.ADBBean {
    ...
    public static final java.lang.String _text = org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
            "text");
    public static final ErrorMessageFormat xml = new ErrorMessageFormat(_xml,
            true);
    public static final ErrorMessageFormat json = new ErrorMessageFormat(_json,
            true);
    public static final ErrorMessageFormat text = new ErrorMessageFormat(_text,
            true);
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":ErrorMessageFormat", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "ErrorMessageFormat", xmlWriter);
            }
        }
    ...
    public static class Factory {
        ...
        public static ErrorMessageFormat fromString(java.lang.String value,
         ...
         */
        public static ErrorMessageFormat parse(
                ...
                while (!reader.isEndElement()) {
                    if (reader.isStartElement() || reader.hasText()) {
                        ...
                        if ("true".equals(nillableValue) ||
                            ...
                            throw new org.apache.axis2.databinding.ADBException(
                                "The element: " + "ErrorMessageFormat" +
                                "  cannot be null");
                        }
                        ...
                        if (content.indexOf(":") > 0) {
                            ...
                            object = ErrorMessageFormat.Factory.fromString(content,
                                    namespaceuri);
                        } else {
