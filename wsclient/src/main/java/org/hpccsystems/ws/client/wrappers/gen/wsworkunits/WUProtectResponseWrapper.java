 ...
 * Wraps class: org.hpccsystems.ws.client.gen.axis2.wsworkunits.v1_83.WUProtectResponse
 * Output package : org.hpccsystems.ws.client.wrappers.gen.wsworkunits
 * TimeStamp: 2021-09-30T21:52:48.540Z
 */
public class WUProtectResponseWrapper
{
    ...
    public WUProtectResponseWrapper( org.hpccsystems.ws.client.gen.axis2.wsworkunits.latest.WUProtectResponse wuprotectresponse)
    {
        copy( wuprotectresponse );
    }
    public WUProtectResponseWrapper( ArrayOfEspExceptionWrapper _exceptions, ArrayOfWUActionResultWrapper _actionResults )
    {
    ...
    private void copy( org.hpccsystems.ws.client.gen.axis2.wsworkunits.latest.WUProtectResponse raw )
    {
        if (raw == null)
            return;
    ...
    {
        return "WUProtectResponseWrapper [" + "exceptions = " + local_exceptions + ", " + "actionResults = " + local_actionResults + "]";
    }
