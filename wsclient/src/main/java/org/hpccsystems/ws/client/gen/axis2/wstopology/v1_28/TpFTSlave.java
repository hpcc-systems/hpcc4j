...
/**
 *  TpFTSlave bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class TpFTSlave implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":TpFTSlave", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "TpFTSlave", xmlWriter);
    ...
    public static class Factory {
         ...
         */
        public static TpFTSlave parse(javax.xml.stream.XMLStreamReader reader)
            throws java.lang.Exception {
            TpFTSlave object = new TpFTSlave();
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"TpFTSlave".equals(type)) {
                            ...
                            return (TpFTSlave) org.hpccsystems.ws.client.gen.axis2.wstopology.v1_28.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
