...
/** ServicePorts bean class */
@SuppressWarnings({"unchecked", "unused"})
public class ServicePorts implements org.apache.axis2.databinding.ADBBean {
  ...
  */
    ...
    if (serializeType) {
      ...
      if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
        writeAttribute(
            ...
            "type",
            namespacePrefix + ":ServicePorts",
            xmlWriter);
      } else {
        writeAttribute(
            "xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "ServicePorts", xmlWriter);
      }
    }
    if (localNameTracker) {
  ...
  public static class Factory {
     ...
     */
    public static ServicePorts parse(javax.xml.stream.XMLStreamReader reader)
        throws java.lang.Exception {
      ServicePorts object = new ServicePorts();
          ...
          if (reader.isStartElement()) {
            ...
            if (reader.isStartElement()
              ...
              reader.next();
                ...
                && new javax.xml.namespace.QName("urn:hpccsystems:ws:wsresources", "Protocol")
                    .equals(reader.getName())) {
