...
/**
 *  SprayResponse bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class SprayResponse implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":SprayResponse", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "SprayResponse", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static SprayResponse parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            SprayResponse object = new SprayResponse();
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"SprayResponse".equals(type)) {
                            ...
                            return (SprayResponse) org.hpccsystems.ws.client.gen.axis2.filespray.v1_16.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
