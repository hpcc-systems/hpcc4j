...
public class ArrayOfEspException  extends org.apache.axis.AxisFault  implements java.io.Serializable {
    ...
    private org.hpccsystems.ws.client.gen.wsworkunits.v1_71allverinclusive.EspException[] exception;
    ...
    public ArrayOfEspException(
           ...
           org.hpccsystems.ws.client.gen.wsworkunits.v1_71allverinclusive.EspException[] exception) {
        this.source = source;
     ...
     * @return exception
     */
    public org.hpccsystems.ws.client.gen.wsworkunits.v1_71allverinclusive.EspException[] getException() {
        return exception;
    }
     ...
     * @param exception
     */
    public void setException(org.hpccsystems.ws.client.gen.wsworkunits.v1_71allverinclusive.EspException[] exception) {
        this.exception = exception;
    }

    public org.hpccsystems.ws.client.gen.wsworkunits.v1_71allverinclusive.EspException getException(int i) {
        return this.exception[i];
    }

    public void setException(int i, org.hpccsystems.ws.client.gen.wsworkunits.v1_71allverinclusive.EspException _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:hpccsystems:ws:wsworkunits", "ArrayOfEspException"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:hpccsystems:ws:wsworkunits", "Exception"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:hpccsystems:ws:wsworkunits", "EspException"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
