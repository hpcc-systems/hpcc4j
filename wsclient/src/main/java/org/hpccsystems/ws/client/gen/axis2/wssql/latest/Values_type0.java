...
/** Values_type0 bean class */
@SuppressWarnings({"unchecked", "unused"})
public class Values_type0 implements org.apache.axis2.databinding.ADBBean {
  ...
  */
    ...
    if (serializeType) {
      ...
      if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
        writeAttribute(
            ...
            "type",
            namespacePrefix + ":Values_type0",
            xmlWriter);
      } else {
        writeAttribute(
            "xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "Values_type0", xmlWriter);
      }
    }
  ...
  public static class Factory {
     ...
     */
    public static Values_type0 parse(javax.xml.stream.XMLStreamReader reader)
        throws java.lang.Exception {
      Values_type0 object = new Values_type0();
        ...
        if (reader.isStartElement()
          ...
          while (!loopDone1) {
            ...
            if (reader.isEndElement()) {
              ...
              if (new javax.xml.namespace.QName("urn:hpccsystems:ws:wssql", "Value")
                  .equals(reader.getName())) {
                list1.add(reader.getElementText());
          ...
          object.setValue((java.lang.String[]) list1.toArray(new java.lang.String[list1.size()]));
