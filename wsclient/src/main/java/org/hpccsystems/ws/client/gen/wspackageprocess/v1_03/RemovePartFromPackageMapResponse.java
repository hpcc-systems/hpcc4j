...
public class RemovePartFromPackageMapResponse  implements java.io.Serializable {
    ...
    public RemovePartFromPackageMapResponse() {
    }
    ...
    /**
     * Gets the exceptions value for this RemovePartFromPackageMapResponse.
     * 
     * @return exceptions
     */
    ...
    /**
     * Sets the exceptions value for this RemovePartFromPackageMapResponse.
     * 
     * @param exceptions
     */
    ...
    /**
     * Gets the status value for this RemovePartFromPackageMapResponse.
     * 
     * @return status
     */
    ...
    /**
     * Sets the status value for this RemovePartFromPackageMapResponse.
     * 
     * @param status
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof RemovePartFromPackageMapResponse)) return false;
        RemovePartFromPackageMapResponse other = (RemovePartFromPackageMapResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(RemovePartFromPackageMapResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:hpccsystems:ws:wspackageprocess", ">RemovePartFromPackageMapResponse"));
