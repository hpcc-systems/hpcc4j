 ...
 * Wraps class: org.hpccsystems.ws.client.gen.axis2.wssql.latest.DataSourceInfo
...
public class DataSourceInfoWrapper
{
    ...
    public DataSourceInfoWrapper( org.hpccsystems.ws.client.gen.axis2.wssql.latest.DataSourceInfo datasourceinfo)
    {
        copy( datasourceinfo );
    }
    ...
    private void copy( org.hpccsystems.ws.client.gen.axis2.wssql.latest.DataSourceInfo raw )
    {
        if (raw == null)
            return;
    ...
    public org.hpccsystems.ws.client.gen.axis2.wssql.latest.DataSourceInfo getRaw()
    {
        org.hpccsystems.ws.client.gen.axis2.wssql.latest.DataSourceInfo raw = new org.hpccsystems.ws.client.gen.axis2.wssql.latest.DataSourceInfo();
