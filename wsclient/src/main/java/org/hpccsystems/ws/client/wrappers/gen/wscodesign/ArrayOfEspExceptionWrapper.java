 ...
 * Wraps class: org.hpccsystems.ws.client.gen.axis2.wscodesign.v1_01.ArrayOfEspException
 * Output package : org.hpccsystems.ws.client.wrappers.gen.wscodesign
 * TimeStamp: 2021-03-26T18:27:31.380Z
 */
public class ArrayOfEspExceptionWrapper
{
	...
	private void copy( org.hpccsystems.ws.client.gen.axis2.wscodesign.v1_01.ArrayOfEspException raw )
	{
		if (raw == null)
			return;
	...
	public org.hpccsystems.ws.client.gen.axis2.wscodesign.v1_01.ArrayOfEspException getRaw()
	{
		org.hpccsystems.ws.client.gen.axis2.wscodesign.v1_01.ArrayOfEspException raw = new org.hpccsystems.ws.client.gen.axis2.wscodesign.v1_01.ArrayOfEspException();
		raw.setSource( local_source);
		if (this.local_exception!= null)
		{
			org.hpccsystems.ws.client.gen.axis2.wscodesign.v1_01.EspException[] arr = new org.hpccsystems.ws.client.gen.axis2.wscodesign.v1_01.EspException[this.local_exception.size()];
