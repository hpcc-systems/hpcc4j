 ...
 * Wraps class: org.hpccsystems.ws.client.gen.axis2.wsworkunits.latest.ArrayOfECLWUProcess
...
public class ArrayOfECLWUProcessWrapper
{
    ...
    public ArrayOfECLWUProcessWrapper( org.hpccsystems.ws.client.gen.axis2.wsworkunits.latest.ArrayOfECLWUProcess arrayofeclwuprocess)
    {
    ...
    private void copy( org.hpccsystems.ws.client.gen.axis2.wsworkunits.latest.ArrayOfECLWUProcess raw )
    {
        if (raw == null)
            return;
    ...
    public org.hpccsystems.ws.client.gen.axis2.wsworkunits.latest.ArrayOfECLWUProcess getRaw()
    {
        org.hpccsystems.ws.client.gen.axis2.wsworkunits.latest.ArrayOfECLWUProcess raw = new org.hpccsystems.ws.client.gen.axis2.wsworkunits.latest.ArrayOfECLWUProcess();
        if (this.local_eCLWUProcess!= null)
        {
            org.hpccsystems.ws.client.gen.axis2.wsworkunits.latest.ECLWUProcess[] arr = new org.hpccsystems.ws.client.gen.axis2.wsworkunits.latest.ECLWUProcess[this.local_eCLWUProcess.size()];
