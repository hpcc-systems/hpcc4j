 ...
 * Wraps class: org.hpccsystems.ws.client.gen.axis2.wsworkunits.v1_83.ArrayOfEspException
 * Output package : org.hpccsystems.ws.client.wrappers.gen.wsworkunits
 * TimeStamp: 2021-09-30T21:52:48.352Z
 */
public class ArrayOfEspExceptionWrapper
{
    ...
    private void copy( org.hpccsystems.ws.client.gen.axis2.wsworkunits.latest.ArrayOfEspException raw )
    {
        if (raw == null)
            return;
    ...
    {
        org.hpccsystems.ws.client.gen.axis2.wsworkunits.latest.ArrayOfEspException raw = new org.hpccsystems.ws.client.gen.axis2.wsworkunits.latest.ArrayOfEspException();
        raw.setSource( local_source);
        if (this.local_exception!= null)
        {
            org.hpccsystems.ws.client.gen.axis2.wsworkunits.latest.EspException[] arr = new org.hpccsystems.ws.client.gen.axis2.wsworkunits.latest.EspException[this.local_exception.size()];
