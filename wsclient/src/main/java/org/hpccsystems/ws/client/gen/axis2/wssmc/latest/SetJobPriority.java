...
/**
 *  SetJobPriority bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class SetJobPriority implements org.apache.axis2.databinding.ADBBean {
     ...
     * field for SMCJobs
     */
    protected org.hpccsystems.ws.client.gen.axis2.wssmc.latest.ArrayOfSMCJob localSMCJobs;

    /*  This tracker boolean wil be used to detect whether the user called the set method
     *   for this attribute. It will be used to determine whether to include this field
     *   in the serialized XML
     */
    protected boolean localSMCJobsTracker = false;
    ...
    public boolean isSMCJobsSpecified() {
        return localSMCJobsTracker;
    }

    /**
     * Auto generated getter method
     * @return org.hpccsystems.ws.client.gen.axis2.wssmc.latest.ArrayOfSMCJob
     */
    public org.hpccsystems.ws.client.gen.axis2.wssmc.latest.ArrayOfSMCJob getSMCJobs() {
        return localSMCJobs;
    }
     ...
     * @param param SMCJobs
     */
    public void setSMCJobs(
        org.hpccsystems.ws.client.gen.axis2.wssmc.latest.ArrayOfSMCJob param) {
        localSMCJobsTracker = param != null;

        this.localSMCJobs = param;
    }
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":SetJobPriority", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "SetJobPriority", xmlWriter);
            }
        }
        ...
        if (localSMCJobsTracker) {
            if (localSMCJobs == null) {
                throw new org.apache.axis2.databinding.ADBException(
                    "SMCJobs cannot be null!!");
            }

            localSMCJobs.serialize(new javax.xml.namespace.QName(
                    "urn:hpccsystems:ws:wssmc", "SMCJobs"), xmlWriter);
        }
    ...
    public static class Factory {
         ...
         */
        public static SetJobPriority parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            SetJobPriority object = new SetJobPriority();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"SetJobPriority".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (SetJobPriority) org.hpccsystems.ws.client.gen.axis2.wssmc.latest.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                while (!reader.isEndElement()) {
                    if (reader.isStartElement()) {
                        if (reader.isStartElement() &&
                         ...
                         if (reader.isStartElement() &&
                                new javax.xml.namespace.QName(
                                    "urn:hpccsystems:ws:wssmc", "SMCJobs").equals(
                                    reader.getName())) {
                            object.setSMCJobs(org.hpccsystems.ws.client.gen.axis2.wssmc.latest.ArrayOfSMCJob.Factory.parse(
                                    reader));
