 ...
 * Wraps class: org.hpccsystems.ws.client.gen.axis2.wssql.latest.ECLTimingData
...
public class ECLTimingDataWrapper
{
    ...
    public ECLTimingDataWrapper( org.hpccsystems.ws.client.gen.axis2.wssql.latest.ECLTimingData ecltimingdata)
    {
        copy( ecltimingdata );
    }
    ...
    private void copy( org.hpccsystems.ws.client.gen.axis2.wssql.latest.ECLTimingData raw )
    {
        if (raw == null)
            return;
    ...
    public org.hpccsystems.ws.client.gen.axis2.wssql.latest.ECLTimingData getRaw()
    {
        org.hpccsystems.ws.client.gen.axis2.wssql.latest.ECLTimingData raw = new org.hpccsystems.ws.client.gen.axis2.wssql.latest.ECLTimingData();
