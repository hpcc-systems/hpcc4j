...
public class TpQueue implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":TpQueue", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "TpQueue", xmlWriter);
    ...
    public static class Factory {
         ...
         */
        public static TpQueue parse(javax.xml.stream.XMLStreamReader reader)
            throws java.lang.Exception {
            TpQueue object = new TpQueue();
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"TpQueue".equals(type)) {
                            ...
                            return (TpQueue) org.hpccsystems.ws.client.gen.axis2.wstopology.latest.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
