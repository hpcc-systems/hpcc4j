    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":WUJobList", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "WUJobList", xmlWriter);
        ...
        if (localBusinessStartHourTracker) {
            ...
            if (localBusinessStartHour == java.lang.Integer.MIN_VALUE) {
                throw new org.apache.axis2.databinding.ADBException(
                    "BusinessStartHour cannot be null!!");
            } else {
                xmlWriter.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
        ...
        if (localBusinessEndHourTracker) {
            ...
            if (localBusinessEndHour == java.lang.Integer.MIN_VALUE) {
                throw new org.apache.axis2.databinding.ADBException(
                    "BusinessEndHour cannot be null!!");
            } else {
                xmlWriter.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                        localBusinessEndHour));
            }
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"WUJobList".equals(type)) {
                            ...
                            return (WUJobList) org.hpccsystems.ws.client.gen.axis2.wsworkunits.v1_81.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                        ...
                        if (reader.isStartElement() &&
                         ...
                         if (reader.isStartElement() &&
                            ...
                            if ("true".equals(nillableValue) ||
                                    "1".equals(nillableValue)) {
                                throw new org.apache.axis2.databinding.ADBException(
                                    "The element: " + "BusinessStartHour" +
                                    "  cannot be null");
                            }

                            java.lang.String content = reader.getElementText();

                            object.setBusinessStartHour(org.apache.axis2.databinding.utils.ConverterUtil.convertToInt(
                                    content));
                         ...
                         if (reader.isStartElement() &&
                                new javax.xml.namespace.QName(
                                    "urn:hpccsystems:ws:wsworkunits",
                                    "BusinessEndHour").equals(reader.getName())) {
                            nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance",
                                    "nil");
                            ...
                            if ("true".equals(nillableValue) ||
                                    "1".equals(nillableValue)) {
                                throw new org.apache.axis2.databinding.ADBException(
                                    "The element: " + "BusinessEndHour" +
                                    "  cannot be null");
                            }

                            java.lang.String content = reader.getElementText();

                            object.setBusinessEndHour(org.apache.axis2.databinding.utils.ConverterUtil.convertToInt(
                                    content));
