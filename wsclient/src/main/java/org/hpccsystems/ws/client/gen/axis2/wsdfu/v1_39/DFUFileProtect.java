...
/**
 *  DFUFileProtect bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class DFUFileProtect implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":DFUFileProtect", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "DFUFileProtect", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static DFUFileProtect parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            DFUFileProtect object = new DFUFileProtect();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"DFUFileProtect".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (DFUFileProtect) org.hpccsystems.ws.client.gen.axis2.wsdfu.v1_39.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
