...
public class Endpoints_type0 implements org.apache.axis2.databinding.ADBBean {
  ...
  */
  ...
  protected org.hpccsystems.ws.client.gen.axis2.wssmc.latest.RoxieControlEndpointInfo[]
      localEndpoint;
  ...
  public void addEndpoint(
    ...
    if (localEndpoint == null) {
      localEndpoint =
          new org.hpccsystems.ws.client.gen.axis2.wssmc.latest.RoxieControlEndpointInfo[] {};
    }
    ...
    list.add(param);
    this.localEndpoint =
        (org.hpccsystems.ws.client.gen.axis2.wssmc.latest.RoxieControlEndpointInfo[])
            list.toArray(
                new org.hpccsystems.ws.client.gen.axis2.wssmc.latest.RoxieControlEndpointInfo
                    [list.size()]);
  }
        ...
        for (int i = 0; i < localEndpoint.length; i++) {
          if (localEndpoint[i] != null) {
            localEndpoint[i].serialize(
                new javax.xml.namespace.QName("urn:hpccsystems:ws:wssmc", "Endpoint"), xmlWriter);
          } else {
    ...
    public static Endpoints_type0 parse(javax.xml.stream.XMLStreamReader reader)
      ...
      try {
        ...
        if (reader.isStartElement()
            && new javax.xml.namespace.QName("urn:hpccsystems:ws:wssmc", "Endpoint")
                .equals(reader.getName())) {

          // Process the array and step past its final element's end.

          list1.add(
              org.hpccsystems.ws.client.gen.axis2.wssmc.latest.RoxieControlEndpointInfo.Factory
                  .parse(reader));
          ...
          while (!loopDone1) {
            ...
            if (reader.isEndElement()) {
              ...
              if (new javax.xml.namespace.QName("urn:hpccsystems:ws:wssmc", "Endpoint")
                  .equals(reader.getName())) {
                list1.add(
                    org.hpccsystems.ws.client.gen.axis2.wssmc.latest.RoxieControlEndpointInfo
