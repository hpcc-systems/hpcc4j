...
/**
 *  DFURecordTypeInfoRequest bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class DFURecordTypeInfoRequest implements org.apache.axis2.databinding.ADBBean {
    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("urn:hpccsystems:ws:wsdfu",
            "DFURecordTypeInfoRequest", "ns1");
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":DFURecordTypeInfoRequest", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "DFURecordTypeInfoRequest", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static DFURecordTypeInfoRequest parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            DFURecordTypeInfoRequest object = new DFURecordTypeInfoRequest();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"DFURecordTypeInfoRequest".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (DFURecordTypeInfoRequest) org.hpccsystems.ws.client.gen.axis2.wsdfu.latest.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
