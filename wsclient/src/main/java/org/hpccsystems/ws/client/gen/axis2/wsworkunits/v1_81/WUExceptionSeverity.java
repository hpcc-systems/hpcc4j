...
public class WUExceptionSeverity implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":WUExceptionSeverity", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "WUExceptionSeverity", xmlWriter);
            }
        }

        if (localWUExceptionSeverity == null) {
            throw new org.apache.axis2.databinding.ADBException(
                "WUExceptionSeverity cannot be null !!");
        } else {
    ...
    public static class Factory {
         ...
         */
        public static WUExceptionSeverity parse(
                ...
                while (!reader.isEndElement()) {
                    if (reader.isStartElement() || reader.hasText()) {
                        ...
                        if ("true".equals(nillableValue) ||
                            ...
                            throw new org.apache.axis2.databinding.ADBException(
                                "The element: " + "WUExceptionSeverity" +
                                "  cannot be null");
                        }
                        ...
                        if (content.indexOf(":") > 0) {
                            ...
                            object = WUExceptionSeverity.Factory.fromString(content,
                                    namespaceuri);
                        } else {
