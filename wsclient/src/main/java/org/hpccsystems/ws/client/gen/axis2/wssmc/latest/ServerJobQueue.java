...
public class ServerJobQueue implements org.apache.axis2.databinding.ADBBean {
  ...
  */
  ...
  public void serialize(
    ...
    if (serializeType) {
      ...
      if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
        writeAttribute(
            ...
            "type",
            namespacePrefix + ":ServerJobQueue",
            xmlWriter);
      } else {
        writeAttribute(
            "xsi",
    ...
    if (localQueuesTracker) {
      ...
      localQueues.serialize(
          new javax.xml.namespace.QName("urn:hpccsystems:ws:wssmc", "Queues"), xmlWriter);
    }
  ...
  public static class Factory {
     ...
     */
    public static ServerJobQueue parse(javax.xml.stream.XMLStreamReader reader)
          ...
          if (reader.isStartElement()) {
            ...
            if (reader.isStartElement()
              ...
              reader.next();
                ...
                && new javax.xml.namespace.QName("urn:hpccsystems:ws:wssmc", "Queues")
                    .equals(reader.getName())) {
              ...
              reader.next();
                ...
                && new javax.xml.namespace.QName("urn:hpccsystems:ws:wssmc", "ServerName")
                    .equals(reader.getName())) {
              ...
              if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
                throw new org.apache.axis2.databinding.ADBException(
                    "The element: " + "ServerName" + "  cannot be null");
              }
              ...
              reader.next();
                ...
                && new javax.xml.namespace.QName("urn:hpccsystems:ws:wssmc", "StatusDetails")
                    .equals(reader.getName())) {
