...
/**
 *  MoveJobUp bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class MoveJobUp implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":MoveJobUp", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "MoveJobUp", xmlWriter);
    ...
    public static class Factory {
         ...
         */
        public static MoveJobUp parse(javax.xml.stream.XMLStreamReader reader)
            throws java.lang.Exception {
            MoveJobUp object = new MoveJobUp();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"MoveJobUp".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (MoveJobUp) org.hpccsystems.ws.client.gen.axis2.wssmc.latest.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
