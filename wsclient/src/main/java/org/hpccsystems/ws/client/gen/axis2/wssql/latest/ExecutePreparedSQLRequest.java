                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"ExecutePreparedSQLRequest".equals(type)) {
                            ...
                            return (ExecutePreparedSQLRequest) org.hpccsystems.ws.client.gen.axis2.wssql.latest.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                        ...
                        if (reader.isStartElement() &&
                         ...
                         if (reader.isStartElement() &&
                                new javax.xml.namespace.QName(
                                    ...
                                    reader.getName())) {
                            object.setVariables(org.hpccsystems.ws.client.gen.axis2.wssql.latest.ArrayOfNamedValue.Factory.parse(
                                    reader));
