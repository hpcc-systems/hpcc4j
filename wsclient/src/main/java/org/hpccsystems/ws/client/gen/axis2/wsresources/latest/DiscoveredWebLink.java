...
/** DiscoveredWebLink bean class */
@SuppressWarnings({"unchecked", "unused"})
public class DiscoveredWebLink implements org.apache.axis2.databinding.ADBBean {
  /* This type was generated from the piece of schema that had
  name = DiscoveredWebLink
  ...
  */
  ...
  protected org.hpccsystems.ws.client.gen.axis2.wsresources.latest.ArrayOfNamedValue
      localAnnotations;
   ...
   *   in the serialized XML
   */
  protected boolean localAnnotationsTracker = false;

  public boolean isAnnotationsSpecified() {
    return localAnnotationsTracker;
  }

  /**
   * Auto generated getter method
   *
   * @return org.hpccsystems.ws.client.gen.axis2.wsresources.latest.ArrayOfNamedValue
   */
  public org.hpccsystems.ws.client.gen.axis2.wsresources.latest.ArrayOfNamedValue getAnnotations() {
  ...
  public void setAnnotations(
      org.hpccsystems.ws.client.gen.axis2.wsresources.latest.ArrayOfNamedValue param) {
    localAnnotationsTracker = param != null;
  ...
  public void serialize(
    ...
    if (serializeType) {
      ...
      if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
        writeAttribute(
            ...
            "type",
            namespacePrefix + ":DiscoveredWebLink",
            xmlWriter);
      } else {
        writeAttribute(
            "xsi",
    ...
    if (localAnnotationsTracker) {
      if (localAnnotations == null) {
        throw new org.apache.axis2.databinding.ADBException("Annotations cannot be null!!");
      }
  ...
  public static class Factory {
     ...
     */
    public static DiscoveredWebLink parse(javax.xml.stream.XMLStreamReader reader)
        throws java.lang.Exception {
      DiscoveredWebLink object = new DiscoveredWebLink();
      ...
      try {
        ...
        if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
          ...
          if (fullTypeName != null) {
            ...
            if (!"DiscoveredWebLink".equals(type)) {
        ...
        while (!reader.isEndElement()) {
          if (reader.isStartElement()) {
            ...
            if (reader.isStartElement()
                && new javax.xml.namespace.QName("urn:hpccsystems:ws:wsresources", "ServiceName")
              ...
              if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
                throw new org.apache.axis2.databinding.ADBException(
                    "The element: " + "ServiceName" + "  cannot be null");
              }
              ...
              reader.next();
                ...
                && new javax.xml.namespace.QName("urn:hpccsystems:ws:wsresources", "NameSpace")
                    .equals(reader.getName())) {
