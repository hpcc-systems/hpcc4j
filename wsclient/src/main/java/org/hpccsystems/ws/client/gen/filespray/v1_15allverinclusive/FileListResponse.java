...
public class FileListResponse  implements java.io.Serializable {
    ...
    /**
     * Gets the acceptLanguage value for this FileListResponse.
     * 
    ...
    /**
     * Sets the acceptLanguage value for this FileListResponse.
     * 
    ...
    static {
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:hpccsystems:ws:filespray", "AcceptLanguage"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
