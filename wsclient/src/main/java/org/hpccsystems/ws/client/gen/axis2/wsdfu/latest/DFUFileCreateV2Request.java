...
/** DFUFileCreateV2Request bean class */
@SuppressWarnings({"unchecked", "unused"})
public class DFUFileCreateV2Request implements org.apache.axis2.databinding.ADBBean {

  public static final javax.xml.namespace.QName MY_QNAME =
      new javax.xml.namespace.QName("urn:hpccsystems:ws:wsdfu", "DFUFileCreateV2Request", "ns1");
  ...
  /** field for Type */
  protected org.hpccsystems.ws.client.gen.axis2.wsdfu.latest.DFUFileType localType;
   ...
   * Auto generated getter method
   *
   * @return org.hpccsystems.ws.client.gen.axis2.wsdfu.latest.DFUFileType
   */
  public org.hpccsystems.ws.client.gen.axis2.wsdfu.latest.DFUFileType getType() {
    return localType;
  }
   ...
   * @param param Type
   */
  public void setType(org.hpccsystems.ws.client.gen.axis2.wsdfu.latest.DFUFileType param) {
  ...
  protected boolean localReturnTextResponse =
  ...
  public void serialize(
    ...
    if (serializeType) {
      ...
      if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
        writeAttribute(
            ...
            "type",
            namespacePrefix + ":DFUFileCreateV2Request",
            xmlWriter);
      } else {
        writeAttribute(
            "xsi",
    ...
    if (localReturnTextResponseTracker) {
      ...
      if (false) {
        ...
        throw new org.apache.axis2.databinding.ADBException("ReturnTextResponse cannot be null!!");
  ...
  public static class Factory {
     ...
     */
    public static DFUFileCreateV2Request parse(javax.xml.stream.XMLStreamReader reader)
        throws java.lang.Exception {
      DFUFileCreateV2Request object = new DFUFileCreateV2Request();
      ...
      try {
        ...
        if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
          ...
          if (fullTypeName != null) {
            ...
            if (!"DFUFileCreateV2Request".equals(type)) {
        ...
        while (!reader.isEndElement()) {
          if (reader.isStartElement()) {
            ...
            if (reader.isStartElement()
              ...
              object.setType(
                  org.hpccsystems.ws.client.gen.axis2.wsdfu.latest.DFUFileType.Factory.parse(
                      reader));
              ...
              reader.next();
                ...
                && new javax.xml.namespace.QName("urn:hpccsystems:ws:wsdfu", "RequestId")
                    .equals(reader.getName())) {
              ...
              reader.next();
                ...
                && new javax.xml.namespace.QName("urn:hpccsystems:ws:wsdfu", "ReturnTextResponse")
                    .equals(reader.getName())) {
              ...
              if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
                throw new org.apache.axis2.databinding.ADBException(
                    "The element: " + "ReturnTextResponse" + "  cannot be null");
              }

              java.lang.String content = reader.getElementText();

              object.setReturnTextResponse(
              ...
              reader.next();
                ...
                && new javax.xml.namespace.QName("urn:hpccsystems:ws:wsdfu", "Compressed")
                    .equals(reader.getName())) {
