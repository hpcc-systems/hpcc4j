...
public class TargetQueriesUsingFile implements org.apache.axis2.databinding.ADBBean {
     ...
     * field for Queries
     */
    protected org.hpccsystems.ws.client.gen.axis2.wsworkunits.latest.ArrayOfQueryUsingFile localQueries;
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"TargetQueriesUsingFile".equals(type)) {
                            ...
                            return (TargetQueriesUsingFile) org.hpccsystems.ws.client.gen.axis2.wsworkunits.latest.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                        ...
                        if (reader.isStartElement() &&
                         ...
                         if (reader.isStartElement() &&
                                new javax.xml.namespace.QName(
                                    ...
                                    reader.getName())) {
                            object.setQueries(org.hpccsystems.ws.client.gen.axis2.wsworkunits.latest.ArrayOfQueryUsingFile.Factory.parse(
                                    reader));
