...
/**
 *  RemovePartFromPackageMapRequest bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class RemovePartFromPackageMapRequest implements org.apache.axis2.databinding.ADBBean {
    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("urn:hpccsystems:ws:wspackageprocess",
            "RemovePartFromPackageMapRequest", "ns7");
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":RemovePartFromPackageMapRequest",
                    xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "RemovePartFromPackageMapRequest", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static RemovePartFromPackageMapRequest parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            RemovePartFromPackageMapRequest object = new RemovePartFromPackageMapRequest();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"RemovePartFromPackageMapRequest".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (RemovePartFromPackageMapRequest) org.hpccsystems.ws.client.gen.axis2.wspackageprocess.latest.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
