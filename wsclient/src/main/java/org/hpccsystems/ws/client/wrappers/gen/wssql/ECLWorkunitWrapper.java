...
protected int local_helpersCount;
	...
	private void copy( org.hpccsystems.ws.client.gen.axis2.wssql.v1_05.ECLWorkunit raw )
	{
		if (raw == null)
			return;
