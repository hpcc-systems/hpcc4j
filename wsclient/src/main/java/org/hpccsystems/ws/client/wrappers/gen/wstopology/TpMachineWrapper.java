 ...
 * Wraps class: org.hpccsystems.ws.client.gen.axis2.wstopology.latest.TpMachine
...
public class TpMachineWrapper
{
    ...
    public TpMachineWrapper( org.hpccsystems.ws.client.gen.axis2.wstopology.latest.TpMachine tpmachine)
    {
        copy( tpmachine );
    }
    ...
    private void copy( org.hpccsystems.ws.client.gen.axis2.wstopology.latest.TpMachine raw )
    {
        if (raw == null)
            return;
    ...
    public org.hpccsystems.ws.client.gen.axis2.wstopology.latest.TpMachine getRaw()
    {
        org.hpccsystems.ws.client.gen.axis2.wstopology.latest.TpMachine raw = new org.hpccsystems.ws.client.gen.axis2.wstopology.latest.TpMachine();
