...
public class DFUFileAccessInfo implements org.apache.axis2.databinding.ADBBean {
  ...
  */
  ...
  protected org.hpccsystems.ws.client.gen.axis2.wsdfu.v1_39.ArrayOfDFUPartLocation
      localFileLocations;
  ...
  protected jakarta.activation.DataHandler localRecordTypeInfoBin;
   ...
   */
  public jakarta.activation.DataHandler getRecordTypeInfoBin() {
   ...
   */
  public void setRecordTypeInfoBin(jakarta.activation.DataHandler param) {
      ...
      if (localRecordTypeInfoBin != null) {
        try {
          org.apache.axiom.util.stax.XMLStreamWriterUtils.writeBlob(
              xmlWriter,
              org.apache.axiom.util.activation.DataHandlerUtils.toBlob(localRecordTypeInfoBin),
              null,
              true);
        } catch (java.io.IOException ex) {
          throw new javax.xml.stream.XMLStreamException(
              "Unable to read data handler for RecordTypeInfoBin", ex);
        }
      } else {
          ...
          if (reader.isStartElement()) {
            ...
            if (reader.isStartElement()
              ...
              object.setFileLocations(
                  org.hpccsystems.ws.client.gen.axis2.wsdfu.v1_39.ArrayOfDFUPartLocation.Factory
                      .parse(reader));
              ...
              object.setFileParts(
                  org.hpccsystems.ws.client.gen.axis2.wsdfu.v1_39.ArrayOfDFUFilePart.Factory.parse(
                      reader));
              ...
              reader.next();
                ...
                && new javax.xml.namespace.QName("urn:hpccsystems:ws:wsdfu", "RecordTypeInfoBin")
                    .equals(reader.getName())) {

              object.setRecordTypeInfoBin(
