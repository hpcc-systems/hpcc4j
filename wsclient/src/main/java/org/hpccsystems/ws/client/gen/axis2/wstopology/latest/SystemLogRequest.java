...
/**
 *  SystemLogRequest bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class SystemLogRequest implements org.apache.axis2.databinding.ADBBean {
    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("urn:hpccsystems:ws:wstopology",
            "SystemLogRequest", "ns3");
    ...
    public void setZip(int param) {
        ...
        localZipTracker = param != java.lang.Integer.MIN_VALUE;
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":SystemLogRequest", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "SystemLogRequest", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static SystemLogRequest parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            SystemLogRequest object = new SystemLogRequest();
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"SystemLogRequest".equals(type)) {
                            ...
                            return (SystemLogRequest) org.hpccsystems.ws.client.gen.axis2.wstopology.latest.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                    ...
                    if (reader.isStartElement()) {
                        if (reader.isStartElement() &&
                         ...
                         if (reader.isStartElement() &&
                            ...
                            object.setZip(org.apache.axis2.databinding.utils.ConverterUtil.convertToInt(
                                    content));
