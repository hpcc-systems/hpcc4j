...
public class WUGetThorJobQueue implements org.apache.axis2.databinding.ADBBean {
     ...
     */
    public void setMaxJobQueueItemsToReturn(
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":WUGetThorJobQueue", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "WUGetThorJobQueue", xmlWriter);
            }
        }
        ...
        if (localMaxJobQueueItemsToReturnTracker) {
            namespace = "urn:hpccsystems:ws:wsworkunits";
            writeStartElement(null, namespace, "MaxJobQueueItemsToReturn",
                xmlWriter);
    ...
    public static class Factory {
         ...
         */
        public static WUGetThorJobQueue parse(
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"WUGetThorJobQueue".equals(type)) {
                            ...
                            return (WUGetThorJobQueue) org.hpccsystems.ws.client.gen.axis2.wsworkunits.v1_81.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                    ...
                    if (reader.isStartElement()) {
                        if (reader.isStartElement() &&
                         ...
                         if (reader.isStartElement() &&
                                new javax.xml.namespace.QName(
                                    "urn:hpccsystems:ws:wsworkunits",
                                    "MaxJobQueueItemsToReturn").equals(
                                    reader.getName())) {
                            nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance",
                                    "nil");
                            ...
                            if ("true".equals(nillableValue) ||
                                ...
                                throw new org.apache.axis2.databinding.ADBException(
                                    "The element: " +
                                    "MaxJobQueueItemsToReturn" +
                                    "  cannot be null");
                            }

                            java.lang.String content = reader.getElementText();

                            object.setMaxJobQueueItemsToReturn(org.apache.axis2.databinding.utils.ConverterUtil.convertToUnsignedInt(
                                    content));
