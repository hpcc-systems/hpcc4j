...
/**
 *  CreateDFUWorkunit bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class CreateDFUWorkunit implements org.apache.axis2.databinding.ADBBean {
    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("urn:hpccsystems:ws:filespray",
            "CreateDFUWorkunit", "ns1");
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":CreateDFUWorkunit", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "CreateDFUWorkunit", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static CreateDFUWorkunit parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            CreateDFUWorkunit object = new CreateDFUWorkunit();
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"CreateDFUWorkunit".equals(type)) {
                            ...
                            return (CreateDFUWorkunit) org.hpccsystems.ws.client.gen.axis2.filespray.latest.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
