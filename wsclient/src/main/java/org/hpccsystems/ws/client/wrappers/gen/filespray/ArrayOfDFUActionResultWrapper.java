 ...
 * Wraps class: org.hpccsystems.ws.client.gen.axis2.filespray.latest.ArrayOfDFUActionResult
 * Output package : org.hpccsystems.ws.client.wrappers.gen.filespray
 * TimeStamp: 2021-10-27T18:52:06.408Z
 */
public class ArrayOfDFUActionResultWrapper
{
    ...
    public ArrayOfDFUActionResultWrapper( org.hpccsystems.ws.client.gen.axis2.filespray.latest.ArrayOfDFUActionResult arrayofdfuactionresult)
    {
    ...
    private void copy( org.hpccsystems.ws.client.gen.axis2.filespray.latest.ArrayOfDFUActionResult raw )
    {
        if (raw == null)
            return;
    ...
    public org.hpccsystems.ws.client.gen.axis2.filespray.latest.ArrayOfDFUActionResult getRaw()
    {
        org.hpccsystems.ws.client.gen.axis2.filespray.latest.ArrayOfDFUActionResult raw = new org.hpccsystems.ws.client.gen.axis2.filespray.latest.ArrayOfDFUActionResult();
        if (this.local_dFUActionResult!= null)
        {
            org.hpccsystems.ws.client.gen.axis2.filespray.latest.DFUActionResult[] arr = new org.hpccsystems.ws.client.gen.axis2.filespray.latest.DFUActionResult[this.local_dFUActionResult.size()];
