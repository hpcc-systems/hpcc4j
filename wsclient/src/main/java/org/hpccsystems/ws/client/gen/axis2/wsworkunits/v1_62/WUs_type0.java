...
public class WUs_type0 implements org.apache.axis2.databinding.ADBBean {
  ...
  */
   ...
   * @param param WU
   */
  public void setWU(org.hpccsystems.ws.client.gen.axis2.wsworkunits.v1_62.ResubmittedWU[] param) {
   ...
   */
  public void addWU(org.hpccsystems.ws.client.gen.axis2.wsworkunits.v1_62.ResubmittedWU param) {
    if (localWU == null) {
    ...
    list.add(param);
    this.localWU =
        (org.hpccsystems.ws.client.gen.axis2.wsworkunits.v1_62.ResubmittedWU[])
            list.toArray(
                new org.hpccsystems.ws.client.gen.axis2.wsworkunits.v1_62.ResubmittedWU
                    [list.size()]);
  }
    ...
    public static WUs_type0 parse(javax.xml.stream.XMLStreamReader reader)
      ...
      try {
        ...
        if (reader.isStartElement()
          ...
          list1.add(
              org.hpccsystems.ws.client.gen.axis2.wsworkunits.v1_62.ResubmittedWU.Factory.parse(
                  reader));
          ...
          while (!loopDone1) {
            ...
            if (reader.isEndElement()) {
              ...
              if (new javax.xml.namespace.QName("urn:hpccsystems:ws:wsworkunits", "WU")
                  .equals(reader.getName())) {
                list1.add(
                    org.hpccsystems.ws.client.gen.axis2.wsworkunits.v1_62.ResubmittedWU.Factory
                        .parse(reader));
