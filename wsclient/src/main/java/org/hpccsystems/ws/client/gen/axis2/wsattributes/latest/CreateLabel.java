...
/** CreateLabel bean class */
@SuppressWarnings({"unchecked", "unused"})
public class CreateLabel implements org.apache.axis2.databinding.ADBBean {

  public static final javax.xml.namespace.QName MY_QNAME =
      new javax.xml.namespace.QName("urn:hpccsystems:ws:wsattributes", "CreateLabel", "ns2");
    ...
    if (serializeType) {
      ...
      if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
        writeAttribute(
            ...
            "type",
            namespacePrefix + ":CreateLabel",
            xmlWriter);
      } else {
        writeAttribute(
            "xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "CreateLabel", xmlWriter);
      }
    }
    if (localNameTracker) {
  ...
  public static class Factory {
     ...
     */
    public static CreateLabel parse(javax.xml.stream.XMLStreamReader reader)
        throws java.lang.Exception {
      CreateLabel object = new CreateLabel();
