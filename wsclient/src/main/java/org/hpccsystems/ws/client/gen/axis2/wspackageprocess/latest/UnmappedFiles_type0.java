...
/**
 *  UnmappedFiles_type0 bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class UnmappedFiles_type0 implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":UnmappedFiles_type0", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "UnmappedFiles_type0", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static UnmappedFiles_type0 parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            UnmappedFiles_type0 object = new UnmappedFiles_type0();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"UnmappedFiles_type0".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (UnmappedFiles_type0) org.hpccsystems.ws.client.gen.axis2.wspackageprocess.latest.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
