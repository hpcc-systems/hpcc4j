...
public class GetAttributes implements org.apache.axis2.databinding.ADBBean {
  ...
  public static final javax.xml.namespace.QName MY_QNAME =
      new javax.xml.namespace.QName("urn:hpccsystems:ws:wsattributes", "GetAttributes", "ns2");
    ...
    if (serializeType) {
      ...
      if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
        writeAttribute(
            ...
            "type",
            namespacePrefix + ":GetAttributes",
            xmlWriter);
      } else {
        writeAttribute(
            "xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "GetAttributes", xmlWriter);
      }
    }
  ...
  public static class Factory {
     ...
     */
    public static GetAttributes parse(javax.xml.stream.XMLStreamReader reader)
