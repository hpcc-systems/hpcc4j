                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"UpdateDFUWorkunit".equals(type)) {
                            ...
                            return (UpdateDFUWorkunit) org.hpccsystems.ws.client.gen.axis2.filespray.latest.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                    ...
                    if (reader.isStartElement()) {
                        if (reader.isStartElement() &&
                                new javax.xml.namespace.QName(
                                    ...
                                    reader.getName())) {
                            object.setWu(org.hpccsystems.ws.client.gen.axis2.filespray.latest.DFUWorkunit.Factory.parse(
                                    reader));
