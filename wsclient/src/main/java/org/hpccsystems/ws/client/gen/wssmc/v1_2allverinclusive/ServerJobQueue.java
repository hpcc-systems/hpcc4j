...
public class ServerJobQueue  implements java.io.Serializable {
    ...
    private java.lang.String[] queueNames;
    ...
    /**
     * Gets the queueNames value for this ServerJobQueue.
     * 
     * @return queueNames
     */
    ...
    /**
     * Sets the queueNames value for this ServerJobQueue.
     * 
     * @param queueNames
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        ...
        _equals = true && 
            ...
            ((this.queueNames==null && other.getQueueNames()==null) || 
             (this.queueNames!=null &&
              java.util.Arrays.equals(this.queueNames, other.getQueueNames()))) &&
    ...
    public synchronized int hashCode() {
        ...
        if (getQueueNames() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getQueueNames());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getQueueNames(), i);
                if (obj != null &&
    ...
    static {
        ...
        elemField.setFieldName("queueNames");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:hpccsystems:ws:wssmc", "QueueNames"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        elemField.setItemQName(new javax.xml.namespace.QName("urn:hpccsystems:ws:wssmc", "QueueName"));
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
