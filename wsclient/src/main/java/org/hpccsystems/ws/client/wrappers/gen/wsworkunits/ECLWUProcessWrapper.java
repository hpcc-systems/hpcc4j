 ...
 * Wraps class: org.hpccsystems.ws.client.gen.axis2.wsworkunits.latest.ECLWUProcess
...
public class ECLWUProcessWrapper
{
    ...
    public ECLWUProcessWrapper( org.hpccsystems.ws.client.gen.axis2.wsworkunits.latest.ECLWUProcess eclwuprocess)
    {
        copy( eclwuprocess );
    }
    ...
    private void copy( org.hpccsystems.ws.client.gen.axis2.wsworkunits.latest.ECLWUProcess raw )
    {
        if (raw == null)
            return;
    ...
    public org.hpccsystems.ws.client.gen.axis2.wsworkunits.latest.ECLWUProcess getRaw()
    {
        org.hpccsystems.ws.client.gen.axis2.wsworkunits.latest.ECLWUProcess raw = new org.hpccsystems.ws.client.gen.axis2.wsworkunits.latest.ECLWUProcess();
