...
public class DFUGetDataColumnsRequest implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":DFUGetDataColumnsRequest", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "DFUGetDataColumnsRequest", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static DFUGetDataColumnsRequest parse(
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"DFUGetDataColumnsRequest".equals(type)) {
                            ...
                            return (DFUGetDataColumnsRequest) org.hpccsystems.ws.client.gen.axis2.wsdfu.latest.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
