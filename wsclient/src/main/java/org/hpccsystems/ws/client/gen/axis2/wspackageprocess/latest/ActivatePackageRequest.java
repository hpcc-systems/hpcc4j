...
/**
 *  ActivatePackageRequest bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class ActivatePackageRequest implements org.apache.axis2.databinding.ADBBean {
    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("urn:hpccsystems:ws:wspackageprocess",
            "ActivatePackageRequest", "ns7");
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":ActivatePackageRequest", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "ActivatePackageRequest", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static ActivatePackageRequest parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            ActivatePackageRequest object = new ActivatePackageRequest();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"ActivatePackageRequest".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (ActivatePackageRequest) org.hpccsystems.ws.client.gen.axis2.wspackageprocess.latest.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
