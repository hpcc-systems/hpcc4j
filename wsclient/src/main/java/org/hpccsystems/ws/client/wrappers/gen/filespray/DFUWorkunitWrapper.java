...
public class DFUWorkunitWrapper
{
    ...
    private void copy( org.hpccsystems.ws.client.gen.axis2.filespray.latest.DFUWorkunit raw )
    {
        if (raw == null)
            return;
    ...
    public void setPreserveFileParts( boolean _preserveFileParts )
    {
        this.local_preserveFileParts = _preserveFileParts;
    }
