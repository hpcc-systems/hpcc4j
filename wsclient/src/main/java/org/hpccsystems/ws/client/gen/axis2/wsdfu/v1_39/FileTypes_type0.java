...
public class FileTypes_type0 implements org.apache.axis2.databinding.ADBBean {
  ...
  */
  ...
  /** field for FileType This was an Array! */
  ...
  public static class Factory {
     ...
     */
    public static FileTypes_type0 parse(javax.xml.stream.XMLStreamReader reader)
        ...
        if (reader.isStartElement()
          ...
          while (!loopDone1) {
            ...
            if (reader.isEndElement()) {
              ...
              if (new javax.xml.namespace.QName("urn:hpccsystems:ws:wsdfu", "FileType")
                  .equals(reader.getName())) {
                list1.add(reader.getElementText());
