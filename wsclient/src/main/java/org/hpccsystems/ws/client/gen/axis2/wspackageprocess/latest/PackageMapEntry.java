...
/**
 *  PackageMapEntry bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class PackageMapEntry implements org.apache.axis2.databinding.ADBBean {
    /* This type was generated from the piece of schema that had
       name = PackageMapEntry
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":PackageMapEntry", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "PackageMapEntry", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static PackageMapEntry parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            PackageMapEntry object = new PackageMapEntry();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"PackageMapEntry".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (PackageMapEntry) org.hpccsystems.ws.client.gen.axis2.wspackageprocess.latest.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
