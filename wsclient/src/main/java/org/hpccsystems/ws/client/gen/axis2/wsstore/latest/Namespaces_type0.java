...
public class Namespaces_type0 implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":Namespaces_type0", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "Namespaces_type0", xmlWriter);
            }
        }
            ...
            if (localNamespace != null) {
                ...
                for (int i = 0; i < localNamespace.length; i++) {
                    if (localNamespace[i] != null) {
                        writeStartElement(null, namespace, "Namespace",
                            xmlWriter);
    ...
    public static class Factory {
         ...
         */
        public static Namespaces_type0 parse(
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"Namespaces_type0".equals(type)) {
                            ...
                            return (Namespaces_type0) org.hpccsystems.ws.client.gen.axis2.wsstore.latest.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if (reader.isStartElement() &&
                    ...
                    object.setNamespace((java.lang.String[]) list1.toArray(
