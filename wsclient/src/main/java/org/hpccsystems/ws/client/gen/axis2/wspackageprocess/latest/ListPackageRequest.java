...
/**
 *  ListPackageRequest bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class ListPackageRequest implements org.apache.axis2.databinding.ADBBean {
    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("urn:hpccsystems:ws:wspackageprocess",
            "ListPackageRequest", "ns7");
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":ListPackageRequest", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "ListPackageRequest", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static ListPackageRequest parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            ListPackageRequest object = new ListPackageRequest();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"ListPackageRequest".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (ListPackageRequest) org.hpccsystems.ws.client.gen.axis2.wspackageprocess.latest.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
