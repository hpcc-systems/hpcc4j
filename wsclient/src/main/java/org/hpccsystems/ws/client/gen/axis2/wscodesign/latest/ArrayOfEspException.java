...
public class ArrayOfEspException implements org.apache.axis2.databinding.ADBBean {
  ...
  */
   ...
   * Auto generated getter method
   *
   * @return org.hpccsystems.ws.client.gen.axis2.wscodesign.latest.EspException[]
   */
   ...
   *
   * @param param org.hpccsystems.ws.client.gen.axis2.wscodesign.latest.EspException
   */
  public void addException(
    ...
    list.add(param);
    this.localException =
        (org.hpccsystems.ws.client.gen.axis2.wscodesign.latest.EspException[])
            list.toArray(
                new org.hpccsystems.ws.client.gen.axis2.wscodesign.latest.EspException
                    [list.size()]);
  }
        ...
        for (int i = 0; i < localException.length; i++) {
          if (localException[i] != null) {
            localException[i].serialize(
                new javax.xml.namespace.QName("urn:hpccsystems:ws:ws_codesign", "Exception"),
                xmlWriter);
          } else {
    ...
    public static ArrayOfEspException parse(javax.xml.stream.XMLStreamReader reader)
      ...
      try {
        ...
        if (reader.isStartElement()
            && new javax.xml.namespace.QName("urn:hpccsystems:ws:ws_codesign", "Source")
        ...
        if (reader.isStartElement()
          ...
          list2.add(
              org.hpccsystems.ws.client.gen.axis2.wscodesign.latest.EspException.Factory.parse(
                  reader));
          ...
          while (!loopDone2) {
            ...
            if (reader.isEndElement()) {
              ...
              if (new javax.xml.namespace.QName("urn:hpccsystems:ws:ws_codesign", "Exception")
                  .equals(reader.getName())) {
                list2.add(
                    org.hpccsystems.ws.client.gen.axis2.wscodesign.latest.EspException.Factory
                        .parse(reader));
