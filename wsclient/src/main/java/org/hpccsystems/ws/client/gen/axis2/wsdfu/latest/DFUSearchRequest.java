...
/**
 *  DFUSearchRequest bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class DFUSearchRequest implements org.apache.axis2.databinding.ADBBean {
    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("urn:hpccsystems:ws:wsdfu",
            "DFUSearchRequest", "ns1");
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":DFUSearchRequest", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "DFUSearchRequest", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static DFUSearchRequest parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            DFUSearchRequest object = new DFUSearchRequest();
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"DFUSearchRequest".equals(type)) {
                            ...
                            return (DFUSearchRequest) org.hpccsystems.ws.client.gen.axis2.wsdfu.latest.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
