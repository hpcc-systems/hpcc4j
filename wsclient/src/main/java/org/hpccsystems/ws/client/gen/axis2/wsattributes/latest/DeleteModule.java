...
/** DeleteModule bean class */
@SuppressWarnings({"unchecked", "unused"})
public class DeleteModule implements org.apache.axis2.databinding.ADBBean {

  public static final javax.xml.namespace.QName MY_QNAME =
      new javax.xml.namespace.QName("urn:hpccsystems:ws:wsattributes", "DeleteModule", "ns2");
  ...
  public void serialize(
    ...
    if (serializeType) {
      ...
      if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
        ...
        writeAttribute(
            "xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "DeleteModule", xmlWriter);
      }
    }
  ...
  public static class Factory {
     ...
     */
    public static DeleteModule parse(javax.xml.stream.XMLStreamReader reader)
        throws java.lang.Exception {
      DeleteModule object = new DeleteModule();
