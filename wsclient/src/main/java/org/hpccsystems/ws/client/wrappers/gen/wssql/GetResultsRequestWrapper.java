 ...
 * Wraps class: org.hpccsystems.ws.client.gen.axis2.wssql.latest.GetResultsRequest
...
public class GetResultsRequestWrapper
{
    ...
    public GetResultsRequestWrapper( org.hpccsystems.ws.client.gen.axis2.wssql.latest.GetResultsRequest getresultsrequest)
    {
    ...
    private void copy( org.hpccsystems.ws.client.gen.axis2.wssql.latest.GetResultsRequest raw )
    {
        if (raw == null)
            return;
    ...
    public org.hpccsystems.ws.client.gen.axis2.wssql.latest.GetResultsRequest getRaw()
    {
        org.hpccsystems.ws.client.gen.axis2.wssql.latest.GetResultsRequest raw = new org.hpccsystems.ws.client.gen.axis2.wssql.latest.GetResultsRequest();
