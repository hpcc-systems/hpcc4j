...
public class EspSoapFaultWrapper
{
    ...
    public EspSoapFaultWrapper( org.hpccsystems.ws.client.gen.axis2.wssql.latest.EspSoapFault espsoapfault)
    {
        copy( espsoapfault );
    }
    ...
    private void copy( org.hpccsystems.ws.client.gen.axis2.wssql.latest.EspSoapFault raw )
    {
        if (raw == null)
            return;
