...
public class Dependencies_type0 implements org.apache.axis2.databinding.ADBBean {
  ...
  */
  ...
  protected org.hpccsystems.ws.client.gen.axis2.wsworkunits.v1_69.WUECLAttribute[]
      localECLAttribute;
  ...
  public void addECLAttribute(
    ...
    if (localECLAttribute == null) {
      localECLAttribute =
          new org.hpccsystems.ws.client.gen.axis2.wsworkunits.v1_69.WUECLAttribute[] {};
    }
    ...
    this.localECLAttribute =
        (org.hpccsystems.ws.client.gen.axis2.wsworkunits.v1_69.WUECLAttribute[])
            list.toArray(
                new org.hpccsystems.ws.client.gen.axis2.wsworkunits.v1_69.WUECLAttribute
                    [list.size()]);
  }
    ...
    if (serializeType) {
      ...
      if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
        writeAttribute(
            ...
            "type",
            namespacePrefix + ":Dependencies_type0",
            xmlWriter);
      } else {
        writeAttribute(
            "xsi",
  ...
  public static class Factory {
     ...
     */
    public static Dependencies_type0 parse(javax.xml.stream.XMLStreamReader reader)
      ...
      try {
        ...
        if (reader.isStartElement()
          ...
          list1.add(
              org.hpccsystems.ws.client.gen.axis2.wsworkunits.v1_69.WUECLAttribute.Factory.parse(
                  reader));
          ...
          while (!loopDone1) {
            ...
            if (reader.isEndElement()) {
              ...
              if (new javax.xml.namespace.QName("urn:hpccsystems:ws:wsworkunits", "ECLAttribute")
                  .equals(reader.getName())) {
                list1.add(
                    org.hpccsystems.ws.client.gen.axis2.wsworkunits.v1_69.WUECLAttribute.Factory
                        .parse(reader));
