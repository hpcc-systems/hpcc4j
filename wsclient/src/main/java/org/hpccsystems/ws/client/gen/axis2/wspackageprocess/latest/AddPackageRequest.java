...
/** AddPackageRequest bean class */
@SuppressWarnings({"unchecked", "unused"})
public class AddPackageRequest implements org.apache.axis2.databinding.ADBBean {
    ...
    if (serializeType) {
      ...
      if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
        writeAttribute(
            ...
            "type",
            namespacePrefix + ":AddPackageRequest",
            xmlWriter);
      } else {
        writeAttribute(
            "xsi",
  ...
  public static class Factory {
     ...
     */
    public static AddPackageRequest parse(javax.xml.stream.XMLStreamReader reader)
        throws java.lang.Exception {
      AddPackageRequest object = new AddPackageRequest();
      ...
      try {
        ...
        if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
          ...
          if (fullTypeName != null) {
            ...
            if (!"AddPackageRequest".equals(type)) {
          ...
          if (reader.isStartElement()) {
            ...
            if (reader.isStartElement()
              ...
              reader.next();
                ...
                && new javax.xml.namespace.QName("urn:hpccsystems:ws:wspackageprocess", "OverWrite")
                    .equals(reader.getName())) {
