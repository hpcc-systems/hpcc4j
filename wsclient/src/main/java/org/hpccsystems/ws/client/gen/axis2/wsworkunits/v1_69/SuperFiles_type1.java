  ...
  */
  ...
  public void addSuperFile(
    ...
    if (localSuperFile == null) {
      localSuperFile =
          new org.hpccsystems.ws.client.gen.axis2.wsworkunits.v1_69.QuerySuperFile[] {};
    }
    ...
    list.add(param);
    this.localSuperFile =
        (org.hpccsystems.ws.client.gen.axis2.wsworkunits.v1_69.QuerySuperFile[])
            list.toArray(
                new org.hpccsystems.ws.client.gen.axis2.wsworkunits.v1_69.QuerySuperFile
                    [list.size()]);
  }
    ...
    public static SuperFiles_type1 parse(javax.xml.stream.XMLStreamReader reader)
      ...
      try {
        ...
        if (reader.isStartElement()
          ...
          list1.add(
              org.hpccsystems.ws.client.gen.axis2.wsworkunits.v1_69.QuerySuperFile.Factory.parse(
                  reader));
          ...
          while (!loopDone1) {
            ...
            if (reader.isEndElement()) {
              ...
              if (new javax.xml.namespace.QName("urn:hpccsystems:ws:wsworkunits", "SuperFile")
                  .equals(reader.getName())) {
                list1.add(
                    org.hpccsystems.ws.client.gen.axis2.wsworkunits.v1_69.QuerySuperFile.Factory
                        .parse(reader));
