...
public class LogAccessFilterWrapper
{
    ...
    protected OMElement local_format;
    ...
    public LogAccessFilterWrapper( String _wildcardFilter, TimeRangeWrapper _absoluteTimeRange, UnsignedInt _relativeTimeRangeBuffer, UnsignedInt _lineLimit, long _lineStartFrom, LogSelectColumnModeWrapper _selectColumnMode, List<String> _customColumns, List<String> _componentsFilter, OMElement _format, SortDirectionWrapper _sortByTimeDirection, LogEventClassWrapper _logEventType )
    {
    ...
    public void setFormat( OMElement _format )
    {
        this.local_format = _format;
    }
    public OMElement getFormat( )
    {
