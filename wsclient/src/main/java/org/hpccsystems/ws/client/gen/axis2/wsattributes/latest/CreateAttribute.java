...
/**
 *  CreateAttribute bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class CreateAttribute implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":CreateAttribute", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "CreateAttribute", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static CreateAttribute parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            CreateAttribute object = new CreateAttribute();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"CreateAttribute".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (CreateAttribute) org.hpccsystems.ws.client.gen.axis2.wsattributes.latest.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
