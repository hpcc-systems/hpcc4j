...
public class ArrayOfSMCJobWrapper
{
    ...
    public ArrayOfSMCJobWrapper( org.hpccsystems.ws.client.gen.axis2.wssmc.latest.ArrayOfSMCJob arrayofsmcjob)
    {
        copy( arrayofsmcjob );
    }
    ...
    private void copy( org.hpccsystems.ws.client.gen.axis2.wssmc.latest.ArrayOfSMCJob raw )
    {
        if (raw == null)
            return;
    ...
    public org.hpccsystems.ws.client.gen.axis2.wssmc.latest.ArrayOfSMCJob getRaw()
    {
        org.hpccsystems.ws.client.gen.axis2.wssmc.latest.ArrayOfSMCJob raw = new org.hpccsystems.ws.client.gen.axis2.wssmc.latest.ArrayOfSMCJob();
        if (this.local_sMCJob!= null)
        {
            org.hpccsystems.ws.client.gen.axis2.wssmc.latest.SMCJob[] arr = new org.hpccsystems.ws.client.gen.axis2.wssmc.latest.SMCJob[this.local_sMCJob.size()];
