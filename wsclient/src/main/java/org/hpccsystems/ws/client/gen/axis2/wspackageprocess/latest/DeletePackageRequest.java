...
public class DeletePackageRequest implements org.apache.axis2.databinding.ADBBean {
  ...
  public static final javax.xml.namespace.QName MY_QNAME =
      new javax.xml.namespace.QName(
          "urn:hpccsystems:ws:wspackageprocess", "DeletePackageRequest", "ns1");
  ...
  protected org.hpccsystems.ws.client.gen.axis2.wspackageprocess.latest.PackageMaps_type0
      localPackageMaps;
   ...
   * Auto generated getter method
   *
   * @return org.hpccsystems.ws.client.gen.axis2.wspackageprocess.latest.PackageMaps_type0
   */
  public org.hpccsystems.ws.client.gen.axis2.wspackageprocess.latest.PackageMaps_type0
      getPackageMaps() {
  ...
  public void serialize(
    ...
    if (serializeType) {
      ...
      if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
        writeAttribute(
            ...
            "type",
            namespacePrefix + ":DeletePackageRequest",
            xmlWriter);
      } else {
        writeAttribute(
            "xsi",
    ...
    if (localPackageMapsTracker) {
      if (localPackageMaps == null) {
        throw new org.apache.axis2.databinding.ADBException("PackageMaps cannot be null!!");
      }
      localPackageMaps.serialize(
          new javax.xml.namespace.QName("urn:hpccsystems:ws:wspackageprocess", "PackageMaps"),
          xmlWriter);
    }
    xmlWriter.writeEndElement();
  }
  ...
  public static class Factory {
     ...
     */
    public static DeletePackageRequest parse(javax.xml.stream.XMLStreamReader reader)
        ...
        while (!reader.isEndElement()) {
          if (reader.isStartElement()) {
            ...
            if (reader.isStartElement()
              ...
              object.setPackageMaps(
                  org.hpccsystems.ws.client.gen.axis2.wspackageprocess.latest.PackageMaps_type0
