 ...
 * Wraps class: org.hpccsystems.ws.client.gen.axis2.wssql.v3_06.ECLGraph
...
public class ECLGraphWrapper
{
    ...
    public ECLGraphWrapper( org.hpccsystems.ws.client.gen.axis2.wssql.latest.ECLGraph eclgraph)
    {
        copy( eclgraph );
    }
    ...
    private void copy( org.hpccsystems.ws.client.gen.axis2.wssql.latest.ECLGraph raw )
    {
        if (raw == null)
            return;
    ...
    public org.hpccsystems.ws.client.gen.axis2.wssql.latest.ECLGraph getRaw()
    {
        org.hpccsystems.ws.client.gen.axis2.wssql.latest.ECLGraph raw = new org.hpccsystems.ws.client.gen.axis2.wssql.latest.ECLGraph();
