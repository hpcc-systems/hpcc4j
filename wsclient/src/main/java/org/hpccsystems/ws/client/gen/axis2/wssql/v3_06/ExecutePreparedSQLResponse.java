...
/**
 *  ExecutePreparedSQLResponse bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class ExecutePreparedSQLResponse implements org.apache.axis2.databinding.ADBBean {
    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("urn:hpccsystems:ws:wssql",
            "ExecutePreparedSQLResponse", "ns12");
     ...
     */
    protected org.apache.axis2.databinding.types.UnsignedInt localResultWindowStart;
     ...
     */
    protected org.apache.axis2.databinding.types.UnsignedInt localResultWindowCount;
     ...
     * field for Workunit
     */
    protected org.hpccsystems.ws.client.gen.axis2.wssql.v3_06.ECLWorkunit localWorkunit;
     ...
     */
    public void setResultWindowStart(
        org.apache.axis2.databinding.types.UnsignedInt param) {
        localResultWindowStartTracker = param != null;
     ...
     */
    public void setResultWindowCount(
        org.apache.axis2.databinding.types.UnsignedInt param) {
        localResultWindowCountTracker = param != null;
    ...
    /**
     * Auto generated getter method
     * @return org.hpccsystems.ws.client.gen.axis2.wssql.v3_06.ECLWorkunit
     */
    public org.hpccsystems.ws.client.gen.axis2.wssql.v3_06.ECLWorkunit getWorkunit() {
    ...
    public void setWorkunit(
        org.hpccsystems.ws.client.gen.axis2.wssql.v3_06.ECLWorkunit param) {
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":ExecutePreparedSQLResponse", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "ExecutePreparedSQLResponse", xmlWriter);
            }
        }
        ...
        if (localResultWindowStartTracker) {
            ...
            if (localResultWindowStart == null) {
                // write the nil attribute
                throw new org.apache.axis2.databinding.ADBException(
        ...
        if (localResultWindowCountTracker) {
            ...
            if (localResultWindowCount == null) {
                // write the nil attribute
                throw new org.apache.axis2.databinding.ADBException(
        ...
        if (localWorkunitTracker) {
            ...
            localWorkunit.serialize(new javax.xml.namespace.QName(
                    "urn:hpccsystems:ws:wssql", "Workunit"), xmlWriter);
        }
    ...
    public static class Factory {
         ...
         */
        public static ExecutePreparedSQLResponse parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            ExecutePreparedSQLResponse object = new ExecutePreparedSQLResponse();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"ExecutePreparedSQLResponse".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (ExecutePreparedSQLResponse) org.hpccsystems.ws.client.gen.axis2.wssql.v3_06.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                while (!reader.isEndElement()) {
                    if (reader.isStartElement()) {
                        if (reader.isStartElement() &&
                         ...
                         if (reader.isStartElement() &&
                                new javax.xml.namespace.QName(
                                    "urn:hpccsystems:ws:wssql", "ParentWuId").equals(
                                    reader.getName())) {
                            ...
                            if ("true".equals(nillableValue) ||
                                ...
                                throw new org.apache.axis2.databinding.ADBException(
                                    "The element: " + "ParentWuId" +
                                    "  cannot be null");
                            }

                            java.lang.String content = reader.getElementText();

                            object.setParentWuId(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                                    content));
                         ...
                         if (reader.isStartElement() &&
                                new javax.xml.namespace.QName(
                                    "urn:hpccsystems:ws:wssql", "Result").equals(
                                    reader.getName())) {
                            nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance",
                                    "nil");
                         ...
                         if (reader.isStartElement() &&
                            ...
                            object.setResultWindowStart(org.apache.axis2.databinding.utils.ConverterUtil.convertToUnsignedInt(
                                    content));
                         ...
                         if (reader.isStartElement() &&
                            ...
                            object.setResultWindowCount(org.apache.axis2.databinding.utils.ConverterUtil.convertToUnsignedInt(
                                    content));
                         ...
                         if (reader.isStartElement() &&
                                new javax.xml.namespace.QName(
                                    "urn:hpccsystems:ws:wssql", "Workunit").equals(
                                    reader.getName())) {
                            object.setWorkunit(org.hpccsystems.ws.client.gen.axis2.wssql.v3_06.ECLWorkunit.Factory.parse(
                                    reader));
