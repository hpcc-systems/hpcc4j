...
/**
 *  GetResultsResponse bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class GetResultsResponse implements org.apache.axis2.databinding.ADBBean {
    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("urn:hpccsystems:ws:wssql",
            "GetResultsResponse", "ns12");
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":GetResultsResponse", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "GetResultsResponse", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static GetResultsResponse parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            GetResultsResponse object = new GetResultsResponse();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"GetResultsResponse".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (GetResultsResponse) org.hpccsystems.ws.client.gen.axis2.wssql.v3_06.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
