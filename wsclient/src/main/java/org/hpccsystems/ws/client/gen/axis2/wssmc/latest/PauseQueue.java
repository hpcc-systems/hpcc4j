...
/**
 *  PauseQueue bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class PauseQueue implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":PauseQueue", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "PauseQueue", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static PauseQueue parse(javax.xml.stream.XMLStreamReader reader)
            throws java.lang.Exception {
            PauseQueue object = new PauseQueue();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"PauseQueue".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (PauseQueue) org.hpccsystems.ws.client.gen.axis2.wssmc.latest.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
