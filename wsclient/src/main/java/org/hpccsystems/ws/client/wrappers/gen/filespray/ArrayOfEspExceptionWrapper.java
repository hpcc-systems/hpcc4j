 ...
 * Wraps class: org.hpccsystems.ws.client.gen.axis2.filespray.latest.ArrayOfEspException
 * Output package : org.hpccsystems.ws.client.wrappers.gen.filespray
 * TimeStamp: 2021-10-27T18:52:06.411Z
 */
public class ArrayOfEspExceptionWrapper
{
    ...
    private void copy( org.hpccsystems.ws.client.gen.axis2.filespray.latest.ArrayOfEspException raw )
    {
        if (raw == null)
            return;
    ...
    public org.hpccsystems.ws.client.gen.axis2.filespray.latest.ArrayOfEspException getRaw()
    {
        org.hpccsystems.ws.client.gen.axis2.filespray.latest.ArrayOfEspException raw = new org.hpccsystems.ws.client.gen.axis2.filespray.latest.ArrayOfEspException();
        raw.setSource( local_source);
        if (this.local_exception!= null)
        {
            org.hpccsystems.ws.client.gen.axis2.filespray.latest.EspException[] arr = new org.hpccsystems.ws.client.gen.axis2.filespray.latest.EspException[this.local_exception.size()];
