 ...
 * Wraps class: org.hpccsystems.ws.client.gen.axis2.wsdfu.latest.EspException
...
public class EspExceptionWrapper
{
    ...
    public EspExceptionWrapper( org.hpccsystems.ws.client.gen.axis2.wsdfu.latest.EspException espexception)
    {
        copy( espexception );
    }
    ...
    private void copy( org.hpccsystems.ws.client.gen.axis2.wsdfu.latest.EspException raw )
    {
        if (raw == null)
            return;
    ...
    public org.hpccsystems.ws.client.gen.axis2.wsdfu.latest.EspException getRaw()
    {
        org.hpccsystems.ws.client.gen.axis2.wsdfu.latest.EspException raw = new org.hpccsystems.ws.client.gen.axis2.wsdfu.latest.EspException();
