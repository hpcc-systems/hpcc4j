...
/** RoxieXrefCmd bean class */
@SuppressWarnings({"unchecked", "unused"})
public class RoxieXrefCmd implements org.apache.axis2.databinding.ADBBean {

  public static final javax.xml.namespace.QName MY_QNAME =
      new javax.xml.namespace.QName("urn:hpccsystems:ws:wssmc", "RoxieXrefCmd", "ns1");
  ...
  /** field for QueryIds */
  protected org.hpccsystems.ws.client.gen.axis2.wssmc.latest.EspStringArray localQueryIds;

  /*  This tracker boolean wil be used to detect whether the user called the set method
   *   for this attribute. It will be used to determine whether to include this field
   *   in the serialized XML
   */
  protected boolean localQueryIdsTracker = false;

  public boolean isQueryIdsSpecified() {
    return localQueryIdsTracker;
  }
   ...
   */
  public org.hpccsystems.ws.client.gen.axis2.wssmc.latest.EspStringArray getQueryIds() {
    return localQueryIds;
  }

  /**
   * Auto generated setter method
   *
   * @param param QueryIds
   */
  public void setQueryIds(org.hpccsystems.ws.client.gen.axis2.wssmc.latest.EspStringArray param) {
    localQueryIdsTracker = param != null;

    this.localQueryIds = param;
  }
  ...
  public void serialize(
    ...
    if (serializeType) {
      ...
      if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
        writeAttribute(
            ...
            "type",
            namespacePrefix + ":RoxieXrefCmd",
            xmlWriter);
      } else {
        writeAttribute(
            "xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "RoxieXrefCmd", xmlWriter);
      }
    }
    ...
    if (localQueryIdsTracker) {
      if (localQueryIds == null) {
        throw new org.apache.axis2.databinding.ADBException("QueryIds cannot be null!!");
      }
      localQueryIds.serialize(
          new javax.xml.namespace.QName("urn:hpccsystems:ws:wssmc", "QueryIds"), xmlWriter);
    }
  ...
  public static class Factory {
     ...
     */
    public static RoxieXrefCmd parse(javax.xml.stream.XMLStreamReader reader)
        throws java.lang.Exception {
      RoxieXrefCmd object = new RoxieXrefCmd();
      ...
      try {
        ...
        while (!reader.isEndElement()) {
          if (reader.isStartElement()) {
            ...
            if (reader.isStartElement()
                && new javax.xml.namespace.QName("urn:hpccsystems:ws:wssmc", "RoxieCluster")
              ...
              reader.next();
                ...
                && new javax.xml.namespace.QName("urn:hpccsystems:ws:wssmc", "QueryIds")
                    .equals(reader.getName())) {
              ...
              reader.next();
                ...
                && new javax.xml.namespace.QName("urn:hpccsystems:ws:wssmc", "CheckAllNodes")
                    .equals(reader.getName())) {
              ...
              reader.next();
                ...
                && new javax.xml.namespace.QName("urn:hpccsystems:ws:wssmc", "Wait")
                    .equals(reader.getName())) {
