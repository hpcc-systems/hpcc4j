...
/**
 *  DFUXRefBuildRequest bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class DFUXRefBuildRequest implements org.apache.axis2.databinding.ADBBean {
    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("urn:hpccsystems:ws:wsdfuxref",
            "DFUXRefBuildRequest", "ns1");
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":DFUXRefBuildRequest", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "DFUXRefBuildRequest", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static DFUXRefBuildRequest parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            DFUXRefBuildRequest object = new DFUXRefBuildRequest();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"DFUXRefBuildRequest".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (DFUXRefBuildRequest) org.hpccsystems.ws.client.gen.axis2.wsdfuxref.latest.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
