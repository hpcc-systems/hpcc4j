...
public class ExceptionsWrapper
{
    ...
    public ExceptionsWrapper( org.hpccsystems.ws.client.gen.axis2.wssql.latest.Exceptions exceptions)
    {
        copy( exceptions );
    }
    ...
    private void copy( org.hpccsystems.ws.client.gen.axis2.wssql.latest.Exceptions raw )
    {
        if (raw == null)
            return;
