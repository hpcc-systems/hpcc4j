...
/**
 *  DeleteDFUWorkunit bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class DeleteDFUWorkunit implements org.apache.axis2.databinding.ADBBean {
    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("urn:hpccsystems:ws:filespray",
            "DeleteDFUWorkunit", "ns1");
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":DeleteDFUWorkunit", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "DeleteDFUWorkunit", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static DeleteDFUWorkunit parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            DeleteDFUWorkunit object = new DeleteDFUWorkunit();
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"DeleteDFUWorkunit".equals(type)) {
                            ...
                            return (DeleteDFUWorkunit) org.hpccsystems.ws.client.gen.axis2.filespray.latest.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
