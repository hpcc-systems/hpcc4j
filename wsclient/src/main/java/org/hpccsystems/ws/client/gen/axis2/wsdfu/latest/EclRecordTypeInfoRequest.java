...
/**
 *  EclRecordTypeInfoRequest bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class EclRecordTypeInfoRequest implements org.apache.axis2.databinding.ADBBean {
    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("urn:hpccsystems:ws:wsdfu",
            "EclRecordTypeInfoRequest", "ns1");
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":EclRecordTypeInfoRequest", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "EclRecordTypeInfoRequest", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static EclRecordTypeInfoRequest parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            EclRecordTypeInfoRequest object = new EclRecordTypeInfoRequest();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"EclRecordTypeInfoRequest".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (EclRecordTypeInfoRequest) org.hpccsystems.ws.client.gen.axis2.wsdfu.latest.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
