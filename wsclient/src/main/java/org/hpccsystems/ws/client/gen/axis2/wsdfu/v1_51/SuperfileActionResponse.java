...
/**
 *  SuperfileActionResponse bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class SuperfileActionResponse implements org.apache.axis2.databinding.ADBBean {
    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("urn:hpccsystems:ws:wsdfu",
            "SuperfileActionResponse", "ns3");
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":SuperfileActionResponse", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "SuperfileActionResponse", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static SuperfileActionResponse parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            SuperfileActionResponse object = new SuperfileActionResponse();
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"SuperfileActionResponse".equals(type)) {
                            ...
                            return (SuperfileActionResponse) org.hpccsystems.ws.client.gen.axis2.wsdfu.v1_51.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                while (!reader.isEndElement()) {
                    if (reader.isStartElement()) {
                        if (reader.isStartElement() &&
                         ...
                         if (reader.isStartElement() &&
                                new javax.xml.namespace.QName(
                                    "urn:hpccsystems:ws:wsdfu", "retcode").equals(
                                    reader.getName())) {
                            nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance",
                                    "nil");
