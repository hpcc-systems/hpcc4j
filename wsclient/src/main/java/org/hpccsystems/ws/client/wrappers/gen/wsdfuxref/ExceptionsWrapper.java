...
public class ExceptionsWrapper
{
    ...
    public ExceptionsWrapper( org.hpccsystems.ws.client.gen.axis2.wsdfuxref.latest.Exceptions exceptions)
    {
        copy( exceptions );
    }
    ...
    private void copy( org.hpccsystems.ws.client.gen.axis2.wsdfuxref.latest.Exceptions raw )
    {
        if (raw == null)
            return;
