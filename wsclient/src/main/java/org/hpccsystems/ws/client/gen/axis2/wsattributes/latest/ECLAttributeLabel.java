...
public class ECLAttributeLabel implements org.apache.axis2.databinding.ADBBean {
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":ECLAttributeLabel", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
        ...
        if (localAttributeVersionTracker) {
            ...
            if (localAttributeVersion == java.lang.Integer.MIN_VALUE) {
                throw new org.apache.axis2.databinding.ADBException(
                    "AttributeVersion cannot be null!!");
            } else {
    ...
    public static class Factory {
         ...
         */
        public static ECLAttributeLabel parse(
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"ECLAttributeLabel".equals(type)) {
                            ...
                            return (ECLAttributeLabel) org.hpccsystems.ws.client.gen.axis2.wsattributes.latest.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                    ...
                    if (reader.isStartElement()) {
                        if (reader.isStartElement() &&
                         ...
                         if (reader.isStartElement() &&
                                new javax.xml.namespace.QName(
                                    "urn:hpccsystems:ws:wsattributes",
                                    "AttributeVersion").equals(reader.getName())) {
                            nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance",
                                    "nil");
                            ...
                            if ("true".equals(nillableValue) ||
                                    "1".equals(nillableValue)) {
                                throw new org.apache.axis2.databinding.ADBException(
                                    "The element: " + "AttributeVersion" +
                                    "  cannot be null");
                            }

                            java.lang.String content = reader.getElementText();

                            object.setAttributeVersion(org.apache.axis2.databinding.utils.ConverterUtil.convertToInt(
                                    content));
                         ...
                         if (reader.isStartElement() &&
                            ...
                            if ("true".equals(nillableValue) ||
                                    "1".equals(nillableValue)) {
                                throw new org.apache.axis2.databinding.ADBException(
                                    "The element: " + "LabelName" +
                                    "  cannot be null");
                            }

                            java.lang.String content = reader.getElementText();

                            object.setLabelName(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                                    content));
