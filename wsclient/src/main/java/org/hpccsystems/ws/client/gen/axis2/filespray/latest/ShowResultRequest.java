...
/**
 *  ShowResultRequest bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class ShowResultRequest implements org.apache.axis2.databinding.ADBBean {
    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("urn:hpccsystems:ws:filespray",
            "ShowResultRequest", "ns1");
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":ShowResultRequest", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "ShowResultRequest", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static ShowResultRequest parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            ShowResultRequest object = new ShowResultRequest();
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"ShowResultRequest".equals(type)) {
                            ...
                            return (ShowResultRequest) org.hpccsystems.ws.client.gen.axis2.filespray.latest.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
