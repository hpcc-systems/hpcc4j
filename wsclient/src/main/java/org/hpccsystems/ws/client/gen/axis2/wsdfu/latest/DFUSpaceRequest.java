...
/**
 *  DFUSpaceRequest bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class DFUSpaceRequest implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":DFUSpaceRequest", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "DFUSpaceRequest", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static DFUSpaceRequest parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            DFUSpaceRequest object = new DFUSpaceRequest();
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"DFUSpaceRequest".equals(type)) {
                            ...
                            return (DFUSpaceRequest) org.hpccsystems.ws.client.gen.axis2.wsdfu.latest.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
