...
public class ArrayOfEspException implements org.apache.axis2.databinding.ADBBean {
  ...
  */
   ...
   */
  public void setException(org.hpccsystems.ws.client.gen.axis2.wsdfu.latest.EspException[] param) {
   ...
   */
  public void addException(org.hpccsystems.ws.client.gen.axis2.wsdfu.latest.EspException param) {
    ...
    list.add(param);
    this.localException =
        (org.hpccsystems.ws.client.gen.axis2.wsdfu.latest.EspException[])
            list.toArray(
                new org.hpccsystems.ws.client.gen.axis2.wsdfu.latest.EspException[list.size()]);
  }
        ...
        for (int i = 0; i < localException.length; i++) {
          if (localException[i] != null) {
            localException[i].serialize(
                new javax.xml.namespace.QName("urn:hpccsystems:ws:wsdfu", "Exception"), xmlWriter);
          } else {
    ...
    public static ArrayOfEspException parse(javax.xml.stream.XMLStreamReader reader)
      ...
      try {
        ...
        if (reader.isStartElement()
            && new javax.xml.namespace.QName("urn:hpccsystems:ws:wsdfu", "Source")
        ...
        if (reader.isStartElement()
            && new javax.xml.namespace.QName("urn:hpccsystems:ws:wsdfu", "Exception")
                .equals(reader.getName())) {

          // Process the array and step past its final element's end.

          list2.add(
              org.hpccsystems.ws.client.gen.axis2.wsdfu.latest.EspException.Factory.parse(reader));
          ...
          while (!loopDone2) {
            ...
            if (reader.isEndElement()) {
              ...
              if (new javax.xml.namespace.QName("urn:hpccsystems:ws:wsdfu", "Exception")
                  .equals(reader.getName())) {
                list2.add(
                    org.hpccsystems.ws.client.gen.axis2.wsdfu.latest.EspException.Factory.parse(
                        reader));
          ...
          object.setException(
              (org.hpccsystems.ws.client.gen.axis2.wsdfu.latest.EspException[])
                  org.apache.axis2.databinding.utils.ConverterUtil.convertToArray(
                      org.hpccsystems.ws.client.gen.axis2.wsdfu.latest.EspException.class, list2));
