...
public class ArrayOfTpEspServer implements org.apache.axis2.databinding.ADBBean {
  ...
  */
  ...
  /** field for TpEspServer This was an Array! */
  ...
  public void addTpEspServer(
    ...
    this.localTpEspServer =
        (org.hpccsystems.ws.client.gen.axis2.wstopology.latest.TpEspServer[])
            list.toArray(
                new org.hpccsystems.ws.client.gen.axis2.wstopology.latest.TpEspServer[list.size()]);
  }
      ...
      if (localTpEspServer != null) {
        for (int i = 0; i < localTpEspServer.length; i++) {
          if (localTpEspServer[i] != null) {
            localTpEspServer[i].serialize(
                new javax.xml.namespace.QName("urn:hpccsystems:ws:wstopology", "TpEspServer"),
                xmlWriter);
          } else {
  ...
  public static class Factory {
     ...
     */
    public static ArrayOfTpEspServer parse(javax.xml.stream.XMLStreamReader reader)
      ...
      try {
        ...
        if (reader.isStartElement()
          ...
          list1.add(
              org.hpccsystems.ws.client.gen.axis2.wstopology.latest.TpEspServer.Factory.parse(
                  reader));
          ...
          while (!loopDone1) {
            ...
            if (reader.isEndElement()) {
              ...
              if (new javax.xml.namespace.QName("urn:hpccsystems:ws:wstopology", "TpEspServer")
                  .equals(reader.getName())) {
                list1.add(
                    org.hpccsystems.ws.client.gen.axis2.wstopology.latest.TpEspServer.Factory.parse(
                        reader));
