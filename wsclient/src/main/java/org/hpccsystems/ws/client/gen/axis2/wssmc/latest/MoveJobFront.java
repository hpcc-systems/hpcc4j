...
/**
 *  MoveJobFront bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class MoveJobFront implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":MoveJobFront", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "MoveJobFront", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static MoveJobFront parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            MoveJobFront object = new MoveJobFront();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"MoveJobFront".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (MoveJobFront) org.hpccsystems.ws.client.gen.axis2.wssmc.latest.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
