...
/**
 *  DFUFileViewRequest bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class DFUFileViewRequest implements org.apache.axis2.databinding.ADBBean {
    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("urn:hpccsystems:ws:wsdfu",
            "DFUFileViewRequest", "ns1");
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":DFUFileViewRequest", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "DFUFileViewRequest", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static DFUFileViewRequest parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            DFUFileViewRequest object = new DFUFileViewRequest();
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"DFUFileViewRequest".equals(type)) {
                            ...
                            return (DFUFileViewRequest) org.hpccsystems.ws.client.gen.axis2.wsdfu.latest.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
