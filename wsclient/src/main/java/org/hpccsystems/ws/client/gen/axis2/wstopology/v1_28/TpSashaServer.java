...
/**
 *  TpSashaServer bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class TpSashaServer implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":TpSashaServer", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "TpSashaServer", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static TpSashaServer parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            TpSashaServer object = new TpSashaServer();
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"TpSashaServer".equals(type)) {
                            ...
                            return (TpSashaServer) org.hpccsystems.ws.client.gen.axis2.wstopology.v1_28.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
