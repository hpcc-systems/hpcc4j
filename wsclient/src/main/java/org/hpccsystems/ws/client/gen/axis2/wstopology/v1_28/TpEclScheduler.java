...
/**
 *  TpEclScheduler bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class TpEclScheduler implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":TpEclScheduler", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
    ...
    public static class Factory {
         ...
         */
        public static TpEclScheduler parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            TpEclScheduler object = new TpEclScheduler();
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"TpEclScheduler".equals(type)) {
                            ...
                            return (TpEclScheduler) org.hpccsystems.ws.client.gen.axis2.wstopology.v1_28.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
