 ...
 * Wraps class: org.hpccsystems.ws.client.gen.axis2.wsresources.latest.ArrayOfNamedValue
 * Output package : org.hpccsystems.ws.client.wrappers.gen.wsresources
 * TimeStamp: 2022-07-25T18:03:51.510Z
 */
public class ArrayOfNamedValueWrapper
{
    ...
    public ArrayOfNamedValueWrapper( org.hpccsystems.ws.client.gen.axis2.wsresources.latest.ArrayOfNamedValue arrayofnamedvalue)
    {
    ...
    private void copy( org.hpccsystems.ws.client.gen.axis2.wsresources.latest.ArrayOfNamedValue raw )
    {
        if (raw == null)
            return;
    ...
    public org.hpccsystems.ws.client.gen.axis2.wsresources.latest.ArrayOfNamedValue getRaw()
    {
        org.hpccsystems.ws.client.gen.axis2.wsresources.latest.ArrayOfNamedValue raw = new org.hpccsystems.ws.client.gen.axis2.wsresources.latest.ArrayOfNamedValue();
        if (this.local_namedValue!= null)
        {
            org.hpccsystems.ws.client.gen.axis2.wsresources.latest.NamedValue[] arr = new org.hpccsystems.ws.client.gen.axis2.wsresources.latest.NamedValue[this.local_namedValue.size()];
