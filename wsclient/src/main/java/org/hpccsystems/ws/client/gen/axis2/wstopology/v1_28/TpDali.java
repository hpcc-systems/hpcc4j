...
public class TpDali implements org.apache.axis2.databinding.ADBBean {
    ...
    /**
     * field for AuditLogDirectory
     */
    protected java.lang.String localAuditLogDirectory;

    /*  This tracker boolean wil be used to detect whether the user called the set method
     *   for this attribute. It will be used to determine whether to include this field
     *   in the serialized XML
     */
    protected boolean localAuditLogDirectoryTracker = false;

    /**
     * field for TpMachines
     */
    protected org.hpccsystems.ws.client.gen.axis2.wstopology.v1_28.ArrayOfTpMachine localTpMachines;
    ...
    public boolean isAuditLogDirectorySpecified() {
        return localAuditLogDirectoryTracker;
    }
     ...
     * @return java.lang.String
     */
    public java.lang.String getAuditLogDirectory() {
        return localAuditLogDirectory;
    }

    /**
     * Auto generated setter method
     * @param param AuditLogDirectory
     */
    public void setAuditLogDirectory(java.lang.String param) {
        localAuditLogDirectoryTracker = param != null;

        this.localAuditLogDirectory = param;
    }
    ...
    /**
     * Auto generated getter method
     * @return org.hpccsystems.ws.client.gen.axis2.wstopology.v1_28.ArrayOfTpMachine
     */
    public org.hpccsystems.ws.client.gen.axis2.wstopology.v1_28.ArrayOfTpMachine getTpMachines() {
    ...
    public void setTpMachines(
        org.hpccsystems.ws.client.gen.axis2.wstopology.v1_28.ArrayOfTpMachine param) {
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":TpDali", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "TpDali", xmlWriter);
        ...
        if (localBackupDirectoryTracker) {
            ...
            if (localBackupDirectory == null) {
                // write the nil attribute
                throw new org.apache.axis2.databinding.ADBException(
                    "BackupDirectory cannot be null!!");
            } else {
        ...
        if (localAuditLogDirectoryTracker) {
            namespace = "urn:hpccsystems:ws:wstopology";
            writeStartElement(null, namespace, "AuditLogDirectory", xmlWriter);

            if (localAuditLogDirectory == null) {
                // write the nil attribute
                throw new org.apache.axis2.databinding.ADBException(
                    "AuditLogDirectory cannot be null!!");
            } else {
                xmlWriter.writeCharacters(localAuditLogDirectory);
            }
    ...
    public static class Factory {
         ...
         */
        public static TpDali parse(javax.xml.stream.XMLStreamReader reader)
            throws java.lang.Exception {
            TpDali object = new TpDali();
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"TpDali".equals(type)) {
                            ...
                            return (TpDali) org.hpccsystems.ws.client.gen.axis2.wstopology.v1_28.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                    ...
                    if (reader.isStartElement()) {
                        if (reader.isStartElement() &&
                         ...
                         if (reader.isStartElement() &&
                                new javax.xml.namespace.QName(
                                    "urn:hpccsystems:ws:wstopology",
                                    "BackupComputer").equals(reader.getName())) {
                            nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance",
                                    "nil");
                            ...
                            if ("true".equals(nillableValue) ||
                                    "1".equals(nillableValue)) {
                                throw new org.apache.axis2.databinding.ADBException(
                                    "The element: " + "BackupComputer" +
                                    "  cannot be null");
                            }

                            java.lang.String content = reader.getElementText();

                            object.setBackupComputer(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                                    content));
                         ...
                         if (reader.isStartElement() &&
                                new javax.xml.namespace.QName(
                                    "urn:hpccsystems:ws:wstopology",
                                    "BackupDirectory").equals(reader.getName())) {
                            nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance",
                                    "nil");
                            ...
                            if ("true".equals(nillableValue) ||
                                    "1".equals(nillableValue)) {
                                throw new org.apache.axis2.databinding.ADBException(
                                    "The element: " + "BackupDirectory" +
                                    "  cannot be null");
                            }

                            java.lang.String content = reader.getElementText();

                            object.setBackupDirectory(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                                    content));
                         ...
                         if (reader.isStartElement() &&
                            ...
                            if ("true".equals(nillableValue) ||
                                    "1".equals(nillableValue)) {
                                throw new org.apache.axis2.databinding.ADBException(
                                    "The element: " + "AuditLogDirectory" +
                                    "  cannot be null");
                            }

                            java.lang.String content = reader.getElementText();

                            object.setAuditLogDirectory(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                                    content));
                         ...
                         if (reader.isStartElement() &&
                            ...
                            object.setTpMachines(org.hpccsystems.ws.client.gen.axis2.wstopology.v1_28.ArrayOfTpMachine.Factory.parse(
                                    reader));
