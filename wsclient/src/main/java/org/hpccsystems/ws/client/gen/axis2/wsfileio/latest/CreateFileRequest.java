...
/**
 *  CreateFileRequest bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class CreateFileRequest implements org.apache.axis2.databinding.ADBBean {
    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("urn:hpccsystems:ws:wsfileio",
            "CreateFileRequest", "ns2");
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":CreateFileRequest", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "CreateFileRequest", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static CreateFileRequest parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            CreateFileRequest object = new CreateFileRequest();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"CreateFileRequest".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (CreateFileRequest) org.hpccsystems.ws.client.gen.axis2.wsfileio.latest.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
