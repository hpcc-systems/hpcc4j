 ...
 * Wraps class: org.hpccsystems.ws.client.gen.axis2.wssql.v3_06.EspException
 * Output package : org.hpccsystems.ws.client.wrappers.gen.wssql
 * TimeStamp: 2021-05-14T01:46:09.090Z
 */
public class EspExceptionWrapper
{
    ...
    public EspExceptionWrapper( org.hpccsystems.ws.client.gen.axis2.wssql.latest.EspException espexception)
    {
        copy( espexception );
    }
    ...
    private void copy( org.hpccsystems.ws.client.gen.axis2.wssql.latest.EspException raw )
    {
        if (raw == null)
            return;
    ...
    public org.hpccsystems.ws.client.gen.axis2.wssql.latest.EspException getRaw()
    {
        org.hpccsystems.ws.client.gen.axis2.wssql.latest.EspException raw = new org.hpccsystems.ws.client.gen.axis2.wssql.latest.EspException();
