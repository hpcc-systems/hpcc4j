 ...
 * TimeStamp: 2022-10-31T03:44:01.366Z
 */
public class ECLResultWrapper
{
    ...
    public ECLResultWrapper( org.hpccsystems.ws.client.gen.axis2.wssql.latest.ECLResult eclresult)
    {
        copy( eclresult );
    }
    ...
    private void copy( org.hpccsystems.ws.client.gen.axis2.wssql.latest.ECLResult raw )
    {
        if (raw == null)
            return;
    ...
    public org.hpccsystems.ws.client.gen.axis2.wssql.latest.ECLResult getRaw()
    {
        org.hpccsystems.ws.client.gen.axis2.wssql.latest.ECLResult raw = new org.hpccsystems.ws.client.gen.axis2.wssql.latest.ECLResult();
