...
/**
 *  GetAttributeLabels bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class GetAttributeLabels implements org.apache.axis2.databinding.ADBBean {
    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("urn:hpccsystems:ws:wsattributes",
            "GetAttributeLabels", "ns1");
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":GetAttributeLabels", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "GetAttributeLabels", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static GetAttributeLabels parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            GetAttributeLabels object = new GetAttributeLabels();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"GetAttributeLabels".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (GetAttributeLabels) org.hpccsystems.ws.client.gen.axis2.wsattributes.latest.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
