...
/**
 *  TpDropZoneQueryRequest bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class TpDropZoneQueryRequest implements org.apache.axis2.databinding.ADBBean {
    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("urn:hpccsystems:ws:wstopology",
            "TpDropZoneQueryRequest", "ns3");
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":TpDropZoneQueryRequest", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "TpDropZoneQueryRequest", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static TpDropZoneQueryRequest parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            TpDropZoneQueryRequest object = new TpDropZoneQueryRequest();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"TpDropZoneQueryRequest".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (TpDropZoneQueryRequest) org.hpccsystems.ws.client.gen.axis2.wstopology.latest.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
