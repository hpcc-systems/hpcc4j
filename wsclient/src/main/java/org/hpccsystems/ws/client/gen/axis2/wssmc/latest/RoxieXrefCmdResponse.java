...
/** RoxieXrefCmdResponse bean class */
@SuppressWarnings({"unchecked", "unused"})
public class RoxieXrefCmdResponse implements org.apache.axis2.databinding.ADBBean {

  public static final javax.xml.namespace.QName MY_QNAME =
      new javax.xml.namespace.QName("urn:hpccsystems:ws:wssmc", "RoxieXrefCmdResponse", "ns1");
    ...
    if (serializeType) {
      ...
      if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
        writeAttribute(
            ...
            "type",
            namespacePrefix + ":RoxieXrefCmdResponse",
            xmlWriter);
      } else {
        writeAttribute(
            "xsi",
  ...
  public static class Factory {
     ...
     */
    public static RoxieXrefCmdResponse parse(javax.xml.stream.XMLStreamReader reader)
        throws java.lang.Exception {
      RoxieXrefCmdResponse object = new RoxieXrefCmdResponse();
      ...
      try {
        ...
        if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
          ...
          if (fullTypeName != null) {
            ...
            if (!"RoxieXrefCmdResponse".equals(type)) {
          ...
          if (reader.isStartElement()) {
            ...
            if (reader.isStartElement()
              ...
              reader.next();
                ...
                && new javax.xml.namespace.QName("urn:hpccsystems:ws:wssmc", "Result")
                    .equals(reader.getName())) {
