...
public class RoxieControlCmdResponse implements org.apache.axis2.databinding.ADBBean {
  ...
  public static final javax.xml.namespace.QName MY_QNAME =
      new javax.xml.namespace.QName("urn:hpccsystems:ws:wssmc", "RoxieControlCmdResponse", "ns9");
   ...
   */
  public void setEndpoints(org.hpccsystems.ws.client.gen.axis2.wssmc.latest.Endpoints_type0 param) {
  ...
  public void serialize(
    ...
    if (serializeType) {
      ...
      if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
        writeAttribute(
            ...
            "type",
            namespacePrefix + ":RoxieControlCmdResponse",
            xmlWriter);
      } else {
        writeAttribute(
            "xsi",
    ...
    if (localEndpointsTracker) {
      ...
      localEndpoints.serialize(
          new javax.xml.namespace.QName("urn:hpccsystems:ws:wssmc", "Endpoints"), xmlWriter);
    }
  ...
  public static class Factory {
     ...
     */
    public static RoxieControlCmdResponse parse(javax.xml.stream.XMLStreamReader reader)
          ...
          if (reader.isStartElement()) {
            ...
            if (reader.isStartElement()
              ...
              reader.next();
                ...
                && new javax.xml.namespace.QName("urn:hpccsystems:ws:wssmc", "Endpoints")
                    .equals(reader.getName())) {

              object.setEndpoints(
                  org.hpccsystems.ws.client.gen.axis2.wssmc.latest.Endpoints_type0.Factory.parse(
                      reader));
