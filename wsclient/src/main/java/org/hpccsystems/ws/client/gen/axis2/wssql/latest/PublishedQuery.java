...
/**
 *  PublishedQuery bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class PublishedQuery implements org.apache.axis2.databinding.ADBBean {
     ...
     * field for Signature
     */
    protected org.hpccsystems.ws.client.gen.axis2.wssql.latest.QuerySignature localSignature;
    ...
    /**
     * Auto generated getter method
     * @return org.hpccsystems.ws.client.gen.axis2.wssql.v3_06.QuerySignature
     */
    public org.hpccsystems.ws.client.gen.axis2.wssql.latest.QuerySignature getSignature() {
    ...
    public void setSignature(
        org.hpccsystems.ws.client.gen.axis2.wssql.latest.QuerySignature param) {
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":PublishedQuery", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "PublishedQuery", xmlWriter);
            }
        }
        ...
        if (localSignatureTracker) {
            ...
            localSignature.serialize(new javax.xml.namespace.QName(
                    "urn:hpccsystems:ws:wssql", "Signature"), xmlWriter);
        }
    ...
    public static class Factory {
         ...
         */
        public static PublishedQuery parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            PublishedQuery object = new PublishedQuery();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"PublishedQuery".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (PublishedQuery) org.hpccsystems.ws.client.gen.axis2.wssql.latest.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                while (!reader.isEndElement()) {
                    if (reader.isStartElement()) {
                        if (reader.isStartElement() &&
                         ...
                         if (reader.isStartElement() &&
                                new javax.xml.namespace.QName(
                                    "urn:hpccsystems:ws:wssql", "Id").equals(
                                    reader.getName())) {
                            nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance",
                                    "nil");
                         ...
                         if (reader.isStartElement() &&
                                new javax.xml.namespace.QName(
                                    "urn:hpccsystems:ws:wssql", "Suspended").equals(
                                    reader.getName())) {
                            nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance",
                                    "nil");
                         ...
                         if (reader.isStartElement() &&
                                new javax.xml.namespace.QName(
                                    "urn:hpccsystems:ws:wssql", "Signature").equals(
                                    reader.getName())) {
                            object.setSignature(org.hpccsystems.ws.client.gen.axis2.wssql.latest.QuerySignature.Factory.parse(
                                    reader));
