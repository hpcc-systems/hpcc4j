...
public class DFUArrayActionResponse implements org.apache.axis2.databinding.ADBBean {
     ...
     */
    protected org.hpccsystems.ws.client.gen.axis2.wsdfu.latest.ArrayOfDFUActionInfo localActionResults;
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"DFUArrayActionResponse".equals(type)) {
                            ...
                            return (DFUArrayActionResponse) org.hpccsystems.ws.client.gen.axis2.wsdfu.latest.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                        ...
                        if (reader.isStartElement() &&
                         ...
                         if (reader.isStartElement() &&
                                new javax.xml.namespace.QName(
                                    ...
                                    reader.getName())) {
                            object.setActionResults(org.hpccsystems.ws.client.gen.axis2.wsdfu.latest.ArrayOfDFUActionInfo.Factory.parse(
                                    reader));
