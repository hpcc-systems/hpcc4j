 ...
 * Class name: ImportAttributeRequestWrapper
 * Wraps class: org.hpccsystems.ws.client.gen.axis2.wsattributes.latest.ImportAttributeRequest
 * Output package : org.hpccsystems.ws.client.wrappers.gen.wsattributes
 */
public class ImportAttributeRequestWrapper
{
    ...
    public ImportAttributeRequestWrapper() {}

    public ImportAttributeRequestWrapper( org.hpccsystems.ws.client.gen.axis2.wsattributes.latest.ImportAttributeRequest importattributerequest)
    {
        copy( importattributerequest );
    }
    public ImportAttributeRequestWrapper( String _moduleName, String _attributeName, String _type, int _flags, int _resultType, String _description, String _text )
    {
    ...
    private void copy( org.hpccsystems.ws.client.gen.axis2.wsattributes.latest.ImportAttributeRequest raw )
    {
        if (raw == null)
            return;
    ...
    {
        return "ImportAttributeRequestWrapper [" + "moduleName = " + local_moduleName + ", " + "attributeName = " + local_attributeName + ", " + "type = " + local_type + ", " + "flags = " + local_flags + ", " + "resultType = " + local_resultType + ", " + "description = " + local_description + ", " + "text = " + local_text + "]";
    }
    public org.hpccsystems.ws.client.gen.axis2.wsattributes.latest.ImportAttributeRequest getRaw()
    {
        org.hpccsystems.ws.client.gen.axis2.wsattributes.latest.ImportAttributeRequest raw = new org.hpccsystems.ws.client.gen.axis2.wsattributes.latest.ImportAttributeRequest();
