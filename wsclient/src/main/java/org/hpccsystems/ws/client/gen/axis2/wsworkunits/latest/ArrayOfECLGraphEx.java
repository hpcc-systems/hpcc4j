  ...
  */
  ...
  public void addECLGraphEx(
    ...
    this.localECLGraphEx =
        (org.hpccsystems.ws.client.gen.axis2.wsworkunits.latest.ECLGraphEx[])
            list.toArray(
                new org.hpccsystems.ws.client.gen.axis2.wsworkunits.latest.ECLGraphEx[list.size()]);
  }
    ...
    public static ArrayOfECLGraphEx parse(javax.xml.stream.XMLStreamReader reader)
      ...
      try {
        ...
        if (reader.isStartElement()
          ...
          list1.add(
              org.hpccsystems.ws.client.gen.axis2.wsworkunits.latest.ECLGraphEx.Factory.parse(
                  reader));
