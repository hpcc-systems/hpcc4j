...
public class LogAccessLogFormat implements org.apache.axis2.databinding.ADBBean {
  ...
  public static final javax.xml.namespace.QName MY_QNAME =
      new javax.xml.namespace.QName("urn:hpccsystems:ws:wsworkunits", "LogAccessLogFormat", "ns13");
          ...
          if (reader.isStartElement() || reader.hasText()) {
            ...
            if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
              throw new org.apache.axis2.databinding.ADBException(
                  "The element: " + "LogAccessLogFormat" + "  cannot be null");
            }
            ...
            if (content.indexOf(":") > 0) {
              ...
              object = LogAccessLogFormat.Factory.fromString(content, namespaceuri);
            } else {
              // this seems to be not a qname send and empty namespace incase of it is
              // check is done in fromString method
              object = LogAccessLogFormat.Factory.fromString(content, "");
            }
