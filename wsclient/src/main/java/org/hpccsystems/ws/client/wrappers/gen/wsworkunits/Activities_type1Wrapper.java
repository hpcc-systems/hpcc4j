 ...
 * Class name: Activities_type1Wrapper
 * Wraps class: org.hpccsystems.ws.client.gen.axis2.wsworkunits.latest.Activities_type1
...
public class Activities_type1Wrapper
{
    ...
    public Activities_type1Wrapper( org.hpccsystems.ws.client.gen.axis2.wsworkunits.latest.Activities_type1 activities_type1)
    {
        copy( activities_type1 );
    }
    public Activities_type1Wrapper( List<WUDetailsActivityInfoWrapper> _activity )
    {
        this.local_activity = _activity;

    }

    private void copy( org.hpccsystems.ws.client.gen.axis2.wsworkunits.latest.Activities_type1 raw )
    {
        if (raw == null)
            return;
    ...
    {
        return "Activities_type1Wrapper [" + "activity = " + local_activity + "]";
    }
    public org.hpccsystems.ws.client.gen.axis2.wsworkunits.latest.Activities_type1 getRaw()
    {
        org.hpccsystems.ws.client.gen.axis2.wsworkunits.latest.Activities_type1 raw = new org.hpccsystems.ws.client.gen.axis2.wsworkunits.latest.Activities_type1();
