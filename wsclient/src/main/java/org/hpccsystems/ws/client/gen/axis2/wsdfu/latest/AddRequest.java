...
public class AddRequest implements org.apache.axis2.databinding.ADBBean {
  ...
  public static final javax.xml.namespace.QName MY_QNAME =
      new javax.xml.namespace.QName("urn:hpccsystems:ws:wsdfu", "AddRequest", "ns1");
  ...
  /** field for Xmlmap */
  protected jakarta.activation.DataHandler localXmlmap;
   ...
   */
  public jakarta.activation.DataHandler getXmlmap() {
    return localXmlmap;
  }
   ...
   * @param param Xmlmap
   */
  public void setXmlmap(jakarta.activation.DataHandler param) {
    localXmlmapTracker = param != null;

    this.localXmlmap = param;
  }

  /** field for Dstcluster */
  protected java.lang.String localDstcluster;

  /*  This tracker boolean wil be used to detect whether the user called the set method
   *   for this attribute. It will be used to determine whether to include this field
   *   in the serialized XML
   */
  protected boolean localDstclusterTracker = false;

  public boolean isDstclusterSpecified() {
    return localDstclusterTracker;
  }
  ...
  public java.lang.String getDstcluster() {
    return localDstcluster;
  }

  /**
   * Auto generated setter method
   *
   * @param param Dstcluster
   */
  public void setDstcluster(java.lang.String param) {
    localDstclusterTracker = param != null;

    this.localDstcluster = param;
  }
  ...
  public void serialize(
    ...
    if (serializeType) {
      ...
      if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
        ...
        writeAttribute(
            "xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "AddRequest", xmlWriter);
      }
    }
      ...
      if (localXmlmap != null) {
        try {
          org.apache.axiom.util.stax.XMLStreamWriterUtils.writeBlob(
              xmlWriter,
              org.apache.axiom.util.activation.DataHandlerUtils.toBlob(localXmlmap),
              null,
              true);
        } catch (java.io.IOException ex) {
          throw new javax.xml.stream.XMLStreamException(
              "Unable to read data handler for xmlmap", ex);
        }
      } else {
    ...
    if (localDstclusterTracker) {
      namespace = "urn:hpccsystems:ws:wsdfu";
      writeStartElement(null, namespace, "dstcluster", xmlWriter);

      if (localDstcluster == null) {
        // write the nil attribute

        throw new org.apache.axis2.databinding.ADBException("dstcluster cannot be null!!");

      } else {

        xmlWriter.writeCharacters(localDstcluster);
      }
      ...
      try {
        ...
        while (!reader.isEndElement()) {
          if (reader.isStartElement()) {
            ...
            if (reader.isStartElement()
                && new javax.xml.namespace.QName("urn:hpccsystems:ws:wsdfu", "dstname")
              ...
              if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
                throw new org.apache.axis2.databinding.ADBException(
                    "The element: " + "dstname" + "  cannot be null");
              }
              ...
              reader.next();
                ...
                && new javax.xml.namespace.QName("urn:hpccsystems:ws:wsdfu", "xmlmap")
                    .equals(reader.getName())) {
              ...
              reader.next();
                ...
                && new javax.xml.namespace.QName("urn:hpccsystems:ws:wsdfu", "dstcluster")
                    .equals(reader.getName())) {
              ...
              if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
                throw new org.apache.axis2.databinding.ADBException(
                    "The element: " + "dstcluster" + "  cannot be null");
              }

              java.lang.String content = reader.getElementText();

              object.setDstcluster(
                  org.apache.axis2.databinding.utils.ConverterUtil.convertToString(content));
