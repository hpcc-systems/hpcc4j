...
public class EclFieldType implements org.apache.axis2.databinding.ADBBean {
     ...
     */
    public void setType(
        org.hpccsystems.ws.client.gen.axis2.wssql.latest.HPCCFieldType param) {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"EclFieldType".equals(type)) {
                            ...
                            return (EclFieldType) org.hpccsystems.ws.client.gen.axis2.wssql.latest.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                    ...
                    if (reader.isStartElement()) {
                        if (reader.isStartElement() &&
                                new javax.xml.namespace.QName(
                                    ...
                                    reader.getName())) {
                            object.setType(org.hpccsystems.ws.client.gen.axis2.wssql.latest.HPCCFieldType.Factory.parse(
                                    reader));
