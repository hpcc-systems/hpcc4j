...
/**
 *  EchoDateTimeResponse bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class EchoDateTimeResponse implements org.apache.axis2.databinding.ADBBean {
    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("urn:hpccsystems:ws:filespray",
            "EchoDateTimeResponse", "ns1");
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":EchoDateTimeResponse", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "EchoDateTimeResponse", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static EchoDateTimeResponse parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            EchoDateTimeResponse object = new EchoDateTimeResponse();
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"EchoDateTimeResponse".equals(type)) {
                            ...
                            return (EchoDateTimeResponse) org.hpccsystems.ws.client.gen.axis2.filespray.latest.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                while (!reader.isEndElement()) {
                    if (reader.isStartElement()) {
                        if (reader.isStartElement() &&
                            ...
                            object.setResult(org.apache.axis2.databinding.utils.ConverterUtil.convertToDateTime(
                                    content));
