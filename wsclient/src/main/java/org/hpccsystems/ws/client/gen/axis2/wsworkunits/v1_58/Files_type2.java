...
public class Files_type2 implements org.apache.axis2.databinding.ADBBean {
  ...
  */
   ...
   */
  public void addFile(org.hpccsystems.ws.client.gen.axis2.wsworkunits.v1_58.FileUsedByQuery param) {
    if (localFile == null) {
    ...
    list.add(param);
    this.localFile =
        (org.hpccsystems.ws.client.gen.axis2.wsworkunits.v1_58.FileUsedByQuery[])
            list.toArray(
                new org.hpccsystems.ws.client.gen.axis2.wsworkunits.v1_58.FileUsedByQuery
                    [list.size()]);
  }
    ...
    public static Files_type2 parse(javax.xml.stream.XMLStreamReader reader)
      ...
      try {
        ...
        if (reader.isStartElement()
          ...
          list1.add(
              org.hpccsystems.ws.client.gen.axis2.wsworkunits.v1_58.FileUsedByQuery.Factory.parse(
                  reader));
          ...
          while (!loopDone1) {
            ...
            if (reader.isEndElement()) {
              ...
              if (new javax.xml.namespace.QName("urn:hpccsystems:ws:wsworkunits", "File")
                  .equals(reader.getName())) {
                list1.add(
                    org.hpccsystems.ws.client.gen.axis2.wsworkunits.v1_58.FileUsedByQuery.Factory
                        .parse(reader));
