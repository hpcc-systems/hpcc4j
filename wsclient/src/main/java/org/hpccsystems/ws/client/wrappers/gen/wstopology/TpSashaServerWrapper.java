...
public class TpSashaServerWrapper
{
    ...
    public TpSashaServerWrapper( org.hpccsystems.ws.client.gen.axis2.wstopology.latest.TpSashaServer tpsashaserver)
    {
        copy( tpsashaserver );
    }
    ...
    private void copy( org.hpccsystems.ws.client.gen.axis2.wstopology.latest.TpSashaServer raw )
    {
        if (raw == null)
            return;
    ...
    public org.hpccsystems.ws.client.gen.axis2.wstopology.latest.TpSashaServer getRaw()
    {
        org.hpccsystems.ws.client.gen.axis2.wstopology.latest.TpSashaServer raw = new org.hpccsystems.ws.client.gen.axis2.wstopology.latest.TpSashaServer();
