...
/**
 *  TpMySqlServer bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class TpMySqlServer implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":TpMySqlServer", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "TpMySqlServer", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static TpMySqlServer parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            TpMySqlServer object = new TpMySqlServer();
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"TpMySqlServer".equals(type)) {
                            ...
                            return (TpMySqlServer) org.hpccsystems.ws.client.gen.axis2.wstopology.v1_28.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
