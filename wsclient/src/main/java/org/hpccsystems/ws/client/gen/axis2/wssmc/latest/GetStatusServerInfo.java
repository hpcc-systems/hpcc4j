...
/**
 *  GetStatusServerInfo bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class GetStatusServerInfo implements org.apache.axis2.databinding.ADBBean {
    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("urn:hpccsystems:ws:wssmc",
            "GetStatusServerInfo", "ns4");
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":GetStatusServerInfo", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "GetStatusServerInfo", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static GetStatusServerInfo parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            GetStatusServerInfo object = new GetStatusServerInfo();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"GetStatusServerInfo".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (GetStatusServerInfo) org.hpccsystems.ws.client.gen.axis2.wssmc.latest.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
