...
public class ArrayOfEspException implements org.apache.axis2.databinding.ADBBean {
     ...
     * This was an Array!
     */
    protected org.hpccsystems.ws.client.gen.axis2.wssmc.latest.EspException[] localException;
    ...
    /**
     * Auto generated getter method
     * @return org.hpccsystems.ws.client.gen.axis2.wssmc.latest.EspException[]
     */
    public org.hpccsystems.ws.client.gen.axis2.wssmc.latest.EspException[] getException() {
    ...
    protected void validateException(
        org.hpccsystems.ws.client.gen.axis2.wssmc.latest.EspException[] param) {
    }
     ...
     * @param param org.hpccsystems.ws.client.gen.axis2.wssmc.latest.EspException
     */
    public void addException(
        org.hpccsystems.ws.client.gen.axis2.wssmc.latest.EspException param) {
        if (localException == null) {
            localException = new org.hpccsystems.ws.client.gen.axis2.wssmc.latest.EspException[] {
        ...
        list.add(param);
        this.localException = (org.hpccsystems.ws.client.gen.axis2.wssmc.latest.EspException[]) list.toArray(new org.hpccsystems.ws.client.gen.axis2.wssmc.latest.EspException[list.size()]);
    }
                ...
                for (int i = 0; i < localException.length; i++) {
                    if (localException[i] != null) {
                        localException[i].serialize(new javax.xml.namespace.QName(
                                "urn:hpccsystems:ws:wssmc", "Exception"),
                            xmlWriter);
                    } else {
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"ArrayOfEspException".equals(type)) {
                            ...
                            return (ArrayOfEspException) org.hpccsystems.ws.client.gen.axis2.wssmc.latest.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName(
                            "urn:hpccsystems:ws:wssmc", "Source").equals(
                            reader.getName())) {
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName(
                            "urn:hpccsystems:ws:wssmc", "Exception").equals(
                            reader.getName())) {
                    // Process the array and step past its final element's end.
                    list2.add(org.hpccsystems.ws.client.gen.axis2.wssmc.latest.EspException.Factory.parse(
                            reader));
                    ...
                    object.setException((org.hpccsystems.ws.client.gen.axis2.wssmc.latest.EspException[]) org.apache.axis2.databinding.utils.ConverterUtil.convertToArray(
                            org.hpccsystems.ws.client.gen.axis2.wssmc.latest.EspException.class,
                            list2));
                } // End of if for expected property start element
