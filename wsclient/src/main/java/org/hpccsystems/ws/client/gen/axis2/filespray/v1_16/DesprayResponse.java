...
/**
 *  DesprayResponse bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class DesprayResponse implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":DesprayResponse", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "DesprayResponse", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static DesprayResponse parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            DesprayResponse object = new DesprayResponse();
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"DesprayResponse".equals(type)) {
                            ...
                            return (DesprayResponse) org.hpccsystems.ws.client.gen.axis2.filespray.v1_16.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
