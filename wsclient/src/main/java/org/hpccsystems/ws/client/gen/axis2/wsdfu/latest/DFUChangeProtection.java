...
public class DFUChangeProtection implements org.apache.axis2.databinding.ADBBean {
  ...
  public static final DFUChangeProtection value1 = new DFUChangeProtection(_value1, true);

  public static final DFUChangeProtection value2 = new DFUChangeProtection(_value2, true);

  public static final DFUChangeProtection value3 = new DFUChangeProtection(_value3, true);

  public static final DFUChangeProtection value4 = new DFUChangeProtection(_value4, true);
    ...
    if (serializeType) {
      ...
      if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
        writeAttribute(
            ...
            "type",
            namespacePrefix + ":DFUChangeProtection",
            xmlWriter);
      } else {
        writeAttribute(
            "xsi",
  ...
  public static class Factory {
    ...
    public static DFUChangeProtection fromString(
      ...
      if (content.indexOf(":") > -1) {
        ...
        return DFUChangeProtection.Factory.fromString(content, namespaceUri);
      } else {
     ...
     */
    public static DFUChangeProtection parse(javax.xml.stream.XMLStreamReader reader)
          ...
          if (reader.isStartElement() || reader.hasText()) {
            ...
            if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
              throw new org.apache.axis2.databinding.ADBException(
                  "The element: " + "DFUChangeProtection" + "  cannot be null");
            }
            ...
            if (content.indexOf(":") > 0) {
              ...
              object = DFUChangeProtection.Factory.fromString(content, namespaceuri);
            } else {
