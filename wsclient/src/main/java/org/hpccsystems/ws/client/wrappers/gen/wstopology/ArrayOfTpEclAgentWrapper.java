 ...
 * Wraps class: org.hpccsystems.ws.client.gen.axis2.wstopology.latest.ArrayOfTpEclAgent
 * Output package : org.hpccsystems.ws.client.wrappers.gen.wstopology
 * TimeStamp: 2021-10-27T23:40:06.310Z
 */
public class ArrayOfTpEclAgentWrapper
{
    ...
    public ArrayOfTpEclAgentWrapper( org.hpccsystems.ws.client.gen.axis2.wstopology.latest.ArrayOfTpEclAgent arrayoftpeclagent)
    {
    ...
    private void copy( org.hpccsystems.ws.client.gen.axis2.wstopology.latest.ArrayOfTpEclAgent raw )
    {
        if (raw == null)
            return;
    ...
    public org.hpccsystems.ws.client.gen.axis2.wstopology.latest.ArrayOfTpEclAgent getRaw()
    {
        org.hpccsystems.ws.client.gen.axis2.wstopology.latest.ArrayOfTpEclAgent raw = new org.hpccsystems.ws.client.gen.axis2.wstopology.latest.ArrayOfTpEclAgent();
        if (this.local_tpEclAgent!= null)
        {
            org.hpccsystems.ws.client.gen.axis2.wstopology.latest.TpEclAgent[] arr = new org.hpccsystems.ws.client.gen.axis2.wstopology.latest.TpEclAgent[this.local_tpEclAgent.size()];
