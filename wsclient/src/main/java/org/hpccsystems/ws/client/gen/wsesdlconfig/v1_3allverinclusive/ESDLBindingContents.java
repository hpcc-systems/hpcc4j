...
public class ESDLBindingContents  implements java.io.Serializable {
    private org.hpccsystems.ws.client.gen.wsesdlconfig.v1_3allverinclusive.ESDLDefinition definition;

    private org.hpccsystems.ws.client.gen.wsesdlconfig.v1_3allverinclusive.ESDLConfiguration configuration;

    public ESDLBindingContents() {
    }

    public ESDLBindingContents(
           org.hpccsystems.ws.client.gen.wsesdlconfig.v1_3allverinclusive.ESDLDefinition definition,
           org.hpccsystems.ws.client.gen.wsesdlconfig.v1_3allverinclusive.ESDLConfiguration configuration) {
     ...
     * @return definition
     */
    public org.hpccsystems.ws.client.gen.wsesdlconfig.v1_3allverinclusive.ESDLDefinition getDefinition() {
        return definition;
    }
     ...
     * @param definition
     */
    public void setDefinition(org.hpccsystems.ws.client.gen.wsesdlconfig.v1_3allverinclusive.ESDLDefinition definition) {
        this.definition = definition;
    }
     ...
     */
    public org.hpccsystems.ws.client.gen.wsesdlconfig.v1_3allverinclusive.ESDLConfiguration getConfiguration() {
        return configuration;
    }
     ...
     * @param configuration
     */
    public void setConfiguration(org.hpccsystems.ws.client.gen.wsesdlconfig.v1_3allverinclusive.ESDLConfiguration configuration) {
        this.configuration = configuration;
    }
