...
/** CreateModule bean class */
@SuppressWarnings({"unchecked", "unused"})
public class CreateModule implements org.apache.axis2.databinding.ADBBean {

  public static final javax.xml.namespace.QName MY_QNAME =
      new javax.xml.namespace.QName("urn:hpccsystems:ws:wsattributes", "CreateModule", "ns2");
    ...
    if (serializeType) {
      ...
      if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
        writeAttribute(
            ...
            "type",
            namespacePrefix + ":CreateModule",
            xmlWriter);
      } else {
        writeAttribute(
            "xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "CreateModule", xmlWriter);
      }
    }
  ...
  public static class Factory {
     ...
     */
    public static CreateModule parse(javax.xml.stream.XMLStreamReader reader)
        throws java.lang.Exception {
      CreateModule object = new CreateModule();
