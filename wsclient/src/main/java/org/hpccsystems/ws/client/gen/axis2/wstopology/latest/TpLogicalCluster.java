...
/**
 *  TpLogicalCluster bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class TpLogicalCluster implements org.apache.axis2.databinding.ADBBean {
    ...
    /**
     * field for QueriesOnly
     */
    protected boolean localQueriesOnly;

    /*  This tracker boolean wil be used to detect whether the user called the set method
     *   for this attribute. It will be used to determine whether to include this field
     *   in the serialized XML
     */
    protected boolean localQueriesOnlyTracker = false;
    ...
    public boolean isQueriesOnlySpecified() {
        return localQueriesOnlyTracker;
    }
    ...
    public boolean getQueriesOnly() {
        return localQueriesOnly;
    }

    /**
     * Auto generated setter method
     * @param param QueriesOnly
     */
    public void setQueriesOnly(boolean param) {
        // setting primitive attribute tracker to true
        localQueriesOnlyTracker = true;

        this.localQueriesOnly = param;
    }
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":TpLogicalCluster", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
        ...
        if (localLanguageVersionTracker) {
            ...
            if (localLanguageVersion == null) {
                // write the nil attribute
                throw new org.apache.axis2.databinding.ADBException(
                    "LanguageVersion cannot be null!!");
            } else {
        ...
        if (localQueriesOnlyTracker) {
            namespace = "urn:hpccsystems:ws:wstopology";
            writeStartElement(null, namespace, "QueriesOnly", xmlWriter);

            if (false) {
                throw new org.apache.axis2.databinding.ADBException(
                    "QueriesOnly cannot be null!!");
            } else {
    ...
    public static class Factory {
         ...
         */
        public static TpLogicalCluster parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            TpLogicalCluster object = new TpLogicalCluster();
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"TpLogicalCluster".equals(type)) {
                            ...
                            return (TpLogicalCluster) org.hpccsystems.ws.client.gen.axis2.wstopology.latest.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                    ...
                    if (reader.isStartElement()) {
                        if (reader.isStartElement() &&
                         ...
                         if (reader.isStartElement() &&
                                new javax.xml.namespace.QName(
                                    "urn:hpccsystems:ws:wstopology",
                                    "LanguageVersion").equals(reader.getName())) {
                            nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance",
                                    "nil");
                            ...
                            if ("true".equals(nillableValue) ||
                                    "1".equals(nillableValue)) {
                                throw new org.apache.axis2.databinding.ADBException(
                                    "The element: " + "LanguageVersion" +
                                    "  cannot be null");
                            }

                            java.lang.String content = reader.getElementText();

                            object.setLanguageVersion(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                                    content));
                         ...
                         if (reader.isStartElement() &&
                                new javax.xml.namespace.QName(
                                    "urn:hpccsystems:ws:wstopology", "Process").equals(
                                    reader.getName())) {
                            nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance",
                                    "nil");
                         ...
                         if (reader.isStartElement() &&
                                new javax.xml.namespace.QName(
                                    "urn:hpccsystems:ws:wstopology",
                                    "QueriesOnly").equals(reader.getName())) {
                            nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance",
                                    "nil");
                            ...
                            if ("true".equals(nillableValue) ||
                                    "1".equals(nillableValue)) {
                                throw new org.apache.axis2.databinding.ADBException(
                                    "The element: " + "QueriesOnly" +
                                    "  cannot be null");
                            }

                            java.lang.String content = reader.getElementText();

                            object.setQueriesOnly(org.apache.axis2.databinding.utils.ConverterUtil.convertToBoolean(
                                    content));
