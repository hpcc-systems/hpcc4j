...
public class WUPublishWorkunit implements org.apache.axis2.databinding.ADBBean {
     ...
     */
    protected boolean localUpdateWorkUnitName = org.apache.axis2.databinding.utils.ConverterUtil.convertToBoolean(
            "false");
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":WUPublishWorkunit", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
        ...
        if (localWorkUnitJobNameTracker) {
            ...
            if (localWorkUnitJobName == null) {
                // write the nil attribute
                throw new org.apache.axis2.databinding.ADBException(
                    "WorkUnitJobName cannot be null!!");
            } else {
        ...
        if (localUpdateWorkUnitNameTracker) {
            ...
            if (false) {
                throw new org.apache.axis2.databinding.ADBException(
                    "UpdateWorkUnitName cannot be null!!");
            } else {
                xmlWriter.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
    ...
    public static class Factory {
         ...
         */
        public static WUPublishWorkunit parse(
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"WUPublishWorkunit".equals(type)) {
                            ...
                            return (WUPublishWorkunit) org.hpccsystems.ws.client.gen.axis2.wsworkunits.latest.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                    ...
                    if (reader.isStartElement()) {
                        if (reader.isStartElement() &&
                         ...
                         if (reader.isStartElement() &&
                                new javax.xml.namespace.QName(
                                    "urn:hpccsystems:ws:wsworkunits",
                                    "WorkUnitJobName").equals(reader.getName())) {
                            nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance",
                                    "nil");
                            ...
                            if ("true".equals(nillableValue) ||
                                    "1".equals(nillableValue)) {
                                throw new org.apache.axis2.databinding.ADBException(
                                    "The element: " + "WorkUnitJobName" +
                                    "  cannot be null");
                            }

                            java.lang.String content = reader.getElementText();

                            object.setWorkUnitJobName(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                                    content));
                         ...
                         if (reader.isStartElement() &&
                            ...
                            if ("true".equals(nillableValue) ||
                                    "1".equals(nillableValue)) {
                                throw new org.apache.axis2.databinding.ADBException(
                                    "The element: " + "UpdateWorkUnitName" +
                                    "  cannot be null");
                            }

                            java.lang.String content = reader.getElementText();

                            object.setUpdateWorkUnitName(org.apache.axis2.databinding.utils.ConverterUtil.convertToBoolean(
                                    content));
