...
public class GetDFUWorkunits implements org.apache.axis2.databinding.ADBBean {
     ...
     * field for CacheHint
     */
    protected long localCacheHint = org.apache.axis2.databinding.utils.ConverterUtil.convertToLong(
            "-1");
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":GetDFUWorkunits", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "GetDFUWorkunits", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static GetDFUWorkunits parse(
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"GetDFUWorkunits".equals(type)) {
                            ...
                            return (GetDFUWorkunits) org.hpccsystems.ws.client.gen.axis2.filespray.latest.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                    ...
                    if (reader.isStartElement()) {
                        if (reader.isStartElement() &&
                         ...
                         if (reader.isStartElement() &&
                            ...
                            object.setCurrentPage(org.apache.axis2.databinding.utils.ConverterUtil.convertToInt(
                                    content));
