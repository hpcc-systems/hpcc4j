...
import org.hpccsystems.ws.client.gen.extended.wsattributes.v1_21.GetAttributeLabels;
...
public class GetAttributeLabels  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:hpccsystems:ws:wsattributes", ">GetAttributeLabels"));
