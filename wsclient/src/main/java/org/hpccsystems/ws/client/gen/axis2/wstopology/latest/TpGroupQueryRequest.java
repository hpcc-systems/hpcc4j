...
/**
 *  TpGroupQueryRequest bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class TpGroupQueryRequest implements org.apache.axis2.databinding.ADBBean {
    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("urn:hpccsystems:ws:wstopology",
            "TpGroupQueryRequest", "ns3");
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":TpGroupQueryRequest", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "TpGroupQueryRequest", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static TpGroupQueryRequest parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            TpGroupQueryRequest object = new TpGroupQueryRequest();
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"TpGroupQueryRequest".equals(type)) {
                            ...
                            return (TpGroupQueryRequest) org.hpccsystems.ws.client.gen.axis2.wstopology.latest.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                    ...
                    if (reader.isStartElement()) {
                        if (reader.isStartElement() &&
                                new javax.xml.namespace.QName(
                                    "urn:hpccsystems:ws:wstopology", "Kind").equals(
                                    reader.getName())) {
