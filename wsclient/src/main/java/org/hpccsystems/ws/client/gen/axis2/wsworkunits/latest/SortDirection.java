...
public class SortDirection implements org.apache.axis2.databinding.ADBBean {
  ...
  public static final javax.xml.namespace.QName MY_QNAME =
      new javax.xml.namespace.QName("urn:hpccsystems:ws:wsworkunits", "SortDirection", "ns13");
          ...
          if (reader.isStartElement() || reader.hasText()) {
            ...
            if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
              throw new org.apache.axis2.databinding.ADBException(
                  "The element: " + "SortDirection" + "  cannot be null");
            }
            ...
            if (content.indexOf(":") > 0) {
              ...
              object = SortDirection.Factory.fromString(content, namespaceuri);
            } else {
              // this seems to be not a qname send and empty namespace incase of it is
              // check is done in fromString method
              object = SortDirection.Factory.fromString(content, "");
            }
