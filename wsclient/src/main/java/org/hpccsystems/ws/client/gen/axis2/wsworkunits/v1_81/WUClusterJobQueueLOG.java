...
public class WUClusterJobQueueLOG implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":WUClusterJobQueueLOG", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "WUClusterJobQueueLOG", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static WUClusterJobQueueLOG parse(
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"WUClusterJobQueueLOG".equals(type)) {
                            ...
                            return (WUClusterJobQueueLOG) org.hpccsystems.ws.client.gen.axis2.wsworkunits.v1_81.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
