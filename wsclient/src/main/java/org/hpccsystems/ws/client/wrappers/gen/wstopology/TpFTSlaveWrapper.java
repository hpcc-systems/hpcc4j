 ...
 * Wraps class: org.hpccsystems.ws.client.gen.axis2.wstopology.latest.TpFTSlave
...
public class TpFTSlaveWrapper
{
    ...
    public TpFTSlaveWrapper( org.hpccsystems.ws.client.gen.axis2.wstopology.latest.TpFTSlave tpftslave)
    {
        copy( tpftslave );
    }
    ...
    private void copy( org.hpccsystems.ws.client.gen.axis2.wstopology.latest.TpFTSlave raw )
    {
        if (raw == null)
            return;
    ...
    public org.hpccsystems.ws.client.gen.axis2.wstopology.latest.TpFTSlave getRaw()
    {
        org.hpccsystems.ws.client.gen.axis2.wstopology.latest.TpFTSlave raw = new org.hpccsystems.ws.client.gen.axis2.wstopology.latest.TpFTSlave();
