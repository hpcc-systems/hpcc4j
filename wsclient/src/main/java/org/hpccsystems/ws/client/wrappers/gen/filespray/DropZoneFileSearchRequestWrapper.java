...
public class DropZoneFileSearchRequestWrapper
{
    ...
    public DropZoneFileSearchRequestWrapper( org.hpccsystems.ws.client.gen.axis2.filespray.latest.DropZoneFileSearchRequest dropzonefilesearchrequest)
    {
    ...
    private void copy( org.hpccsystems.ws.client.gen.axis2.filespray.latest.DropZoneFileSearchRequest raw )
    {
        if (raw == null)
            return;
    ...
    public org.hpccsystems.ws.client.gen.axis2.filespray.latest.DropZoneFileSearchRequest getRaw()
    {
        org.hpccsystems.ws.client.gen.axis2.filespray.latest.DropZoneFileSearchRequest raw = new org.hpccsystems.ws.client.gen.axis2.filespray.latest.DropZoneFileSearchRequest();
