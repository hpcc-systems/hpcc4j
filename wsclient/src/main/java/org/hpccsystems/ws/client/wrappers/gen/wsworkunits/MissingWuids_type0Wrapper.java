...
public class MissingWuids_type0Wrapper
{
    ...
    public MissingWuids_type0Wrapper() {}

    public MissingWuids_type0Wrapper( org.hpccsystems.ws.client.gen.axis2.wsworkunits.latest.MissingWuids_type0 missingwuids_type0)
    {
        copy( missingwuids_type0 );
    }
    public MissingWuids_type0Wrapper( List<String> _queryId )
    {
        this.local_queryId = _queryId;

    }

    private void copy( org.hpccsystems.ws.client.gen.axis2.wsworkunits.latest.MissingWuids_type0 raw )
    {
        if (raw == null)
            return;
    ...
    {
        return "MissingWuids_type0Wrapper [" + "queryId = " + local_queryId + "]";
    }
    public org.hpccsystems.ws.client.gen.axis2.wsworkunits.latest.MissingWuids_type0 getRaw()
    {
        org.hpccsystems.ws.client.gen.axis2.wsworkunits.latest.MissingWuids_type0 raw = new org.hpccsystems.ws.client.gen.axis2.wsworkunits.latest.MissingWuids_type0();
