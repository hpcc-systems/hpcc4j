...
/**
 *  ReplicateResponse bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class ReplicateResponse implements org.apache.axis2.databinding.ADBBean {
    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("urn:hpccsystems:ws:filespray",
            "ReplicateResponse", "ns2");
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":ReplicateResponse", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "ReplicateResponse", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static ReplicateResponse parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            ReplicateResponse object = new ReplicateResponse();
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"ReplicateResponse".equals(type)) {
                            ...
                            return (ReplicateResponse) org.hpccsystems.ws.client.gen.axis2.filespray.v1_17.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
