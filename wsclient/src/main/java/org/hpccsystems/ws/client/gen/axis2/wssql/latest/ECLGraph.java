  ...
  public void serialize(
    ...
    if (serializeType) {
      ...
      if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
        writeAttribute(
            ...
            "type",
            namespacePrefix + ":ECLGraph",
            xmlWriter);
      } else {
        writeAttribute(
            "xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "ECLGraph", xmlWriter);
      }
    }
    if (localNameTracker) {
    ...
    if (localRunningIdTracker) {
      ...
      if (localRunningId == java.lang.Long.MIN_VALUE) {
        ...
        throw new org.apache.axis2.databinding.ADBException("RunningId cannot be null!!");

      } else {
        xmlWriter.writeCharacters(
            org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localRunningId));
      }
    ...
    if (localWhenStartedTracker) {
      ...
      if (localWhenStarted == null) {
        ...
        throw new org.apache.axis2.databinding.ADBException("WhenStarted cannot be null!!");
    ...
    if (localWhenFinishedTracker) {
      ...
      if (localWhenFinished == null) {
        ...
        throw new org.apache.axis2.databinding.ADBException("WhenFinished cannot be null!!");
          ...
          if (reader.isStartElement()) {
            ...
            if (reader.isStartElement()
              ...
              reader.next();
                ...
                && new javax.xml.namespace.QName("urn:hpccsystems:ws:wssql", "Label")
                    .equals(reader.getName())) {
              ...
              reader.next();
                ...
                && new javax.xml.namespace.QName("urn:hpccsystems:ws:wssql", "Running")
                    .equals(reader.getName())) {
              ...
              reader.next();
                ...
                && new javax.xml.namespace.QName("urn:hpccsystems:ws:wssql", "Complete")
                    .equals(reader.getName())) {
              ...
              reader.next();
                ...
                && new javax.xml.namespace.QName("urn:hpccsystems:ws:wssql", "Failed")
                    .equals(reader.getName())) {
              ...
              reader.next();
                ...
                && new javax.xml.namespace.QName("urn:hpccsystems:ws:wssql", "RunningId")
                    .equals(reader.getName())) {
              ...
              if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
                throw new org.apache.axis2.databinding.ADBException(
                    "The element: " + "RunningId" + "  cannot be null");
              }
              ...
              reader.next();
                ...
                && new javax.xml.namespace.QName("urn:hpccsystems:ws:wssql", "WhenStarted")
                    .equals(reader.getName())) {
              ...
              if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
                throw new org.apache.axis2.databinding.ADBException(
                    "The element: " + "WhenStarted" + "  cannot be null");
              }

              java.lang.String content = reader.getElementText();

              object.setWhenStarted(
                  org.apache.axis2.databinding.utils.ConverterUtil.convertToString(content));
              ...
              reader.next();
                ...
                && new javax.xml.namespace.QName("urn:hpccsystems:ws:wssql", "WhenFinished")
                    .equals(reader.getName())) {
              ...
              if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
                throw new org.apache.axis2.databinding.ADBException(
                    "The element: " + "WhenFinished" + "  cannot be null");
              }

              java.lang.String content = reader.getElementText();

              object.setWhenFinished(
                  org.apache.axis2.databinding.utils.ConverterUtil.convertToString(content));
