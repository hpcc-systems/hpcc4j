...
/**
 *  GroupNode bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class GroupNode implements org.apache.axis2.databinding.ADBBean {
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":GroupNode", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "GroupNode", xmlWriter);
        ...
        if (localReplicateOutputsTracker) {
            ...
            if (false) {
                throw new org.apache.axis2.databinding.ADBException(
                    "ReplicateOutputs cannot be null!!");
            } else {
    ...
    public static class Factory {
         ...
         */
        public static GroupNode parse(javax.xml.stream.XMLStreamReader reader)
            throws java.lang.Exception {
            GroupNode object = new GroupNode();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"GroupNode".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (GroupNode) org.hpccsystems.ws.client.gen.axis2.filespray.latest.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                    ...
                    if (reader.isStartElement()) {
                        if (reader.isStartElement() &&
                         ...
                         if (reader.isStartElement() &&
                                new javax.xml.namespace.QName(
                                    "urn:hpccsystems:ws:filespray",
                                    "ClusterType").equals(reader.getName())) {
                            nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance",
                                    "nil");
                         ...
                         if (reader.isStartElement() &&
                                new javax.xml.namespace.QName(
                                    "urn:hpccsystems:ws:filespray",
                                    "ReplicateOutputs").equals(reader.getName())) {
                            nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance",
                                    "nil");
                            ...
                            if ("true".equals(nillableValue) ||
                                    "1".equals(nillableValue)) {
                                throw new org.apache.axis2.databinding.ADBException(
                                    "The element: " + "ReplicateOutputs" +
                                    "  cannot be null");
                            }

                            java.lang.String content = reader.getElementText();

                            object.setReplicateOutputs(org.apache.axis2.databinding.utils.ConverterUtil.convertToBoolean(
                                    content));
