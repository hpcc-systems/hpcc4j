...
public class Graphs_type0 implements org.apache.axis2.databinding.ADBBean {
  ...
  */
  ...
  public void serialize(
    ...
    if (serializeType) {
      ...
      if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
        ...
        writeAttribute(
            "xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "Graphs_type0", xmlWriter);
      }
    }
  ...
  public static class Factory {
     ...
     */
    public static Graphs_type0 parse(javax.xml.stream.XMLStreamReader reader)
      ...
      try {
        ...
        if (reader.isStartElement()
            && new javax.xml.namespace.QName("urn:hpccsystems:ws:wsdfu", "ECLGraph")
          ...
          while (!loopDone1) {
            ...
            if (reader.isEndElement()) {
              ...
              if (new javax.xml.namespace.QName("urn:hpccsystems:ws:wsdfu", "ECLGraph")
                  .equals(reader.getName())) {
                list1.add(reader.getElementText());
