 ...
 * TimeStamp: 2022-10-28T23:07:50.838Z
 */
public class AddResponseWrapper
{
    ...
    public AddResponseWrapper( org.hpccsystems.ws.client.gen.axis2.wsdfu.latest.AddResponse addresponse)
    {
        copy( addresponse );
    }
    ...
    private void copy( org.hpccsystems.ws.client.gen.axis2.wsdfu.latest.AddResponse raw )
    {
        if (raw == null)
            return;
