...
public class DFUException implements org.apache.axis2.databinding.ADBBean {
  ...
  */
  ...
  public void serialize(
    ...
    if (serializeType) {
      ...
      if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
        ...
        writeAttribute(
            "xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "DFUException", xmlWriter);
      }
    }
    if (localCodeTracker) {
  ...
  public static class Factory {
     ...
     */
    public static DFUException parse(javax.xml.stream.XMLStreamReader reader)
      ...
      try {
        ...
        while (!reader.isEndElement()) {
          if (reader.isStartElement()) {
            ...
            if (reader.isStartElement()
                && new javax.xml.namespace.QName("urn:hpccsystems:ws:filespray", "Code")
              ...
              reader.next();
                ...
                && new javax.xml.namespace.QName("urn:hpccsystems:ws:filespray", "Message")
                    .equals(reader.getName())) {
