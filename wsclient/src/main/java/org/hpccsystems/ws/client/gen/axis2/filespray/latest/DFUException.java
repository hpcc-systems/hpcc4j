...
/**
 *  DFUException bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class DFUException implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":DFUException", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "DFUException", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static DFUException parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            DFUException object = new DFUException();
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"DFUException".equals(type)) {
                            ...
                            return (DFUException) org.hpccsystems.ws.client.gen.axis2.filespray.latest.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
