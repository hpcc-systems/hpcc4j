...
/**
 *  GetDFUWorkunit bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class GetDFUWorkunit implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":GetDFUWorkunit", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "GetDFUWorkunit", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static GetDFUWorkunit parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            GetDFUWorkunit object = new GetDFUWorkunit();
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"GetDFUWorkunit".equals(type)) {
                            ...
                            return (GetDFUWorkunit) org.hpccsystems.ws.client.gen.axis2.filespray.latest.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
