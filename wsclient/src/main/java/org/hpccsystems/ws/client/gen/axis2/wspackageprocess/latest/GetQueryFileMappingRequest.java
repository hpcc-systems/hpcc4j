...
/**
 *  GetQueryFileMappingRequest bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class GetQueryFileMappingRequest implements org.apache.axis2.databinding.ADBBean {
    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("urn:hpccsystems:ws:wspackageprocess",
            "GetQueryFileMappingRequest", "ns7");
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":GetQueryFileMappingRequest", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "GetQueryFileMappingRequest", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static GetQueryFileMappingRequest parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            GetQueryFileMappingRequest object = new GetQueryFileMappingRequest();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"GetQueryFileMappingRequest".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (GetQueryFileMappingRequest) org.hpccsystems.ws.client.gen.axis2.wspackageprocess.latest.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
