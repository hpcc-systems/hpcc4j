...
public class ECLHelpFileWrapper
{
    ...
    public ECLHelpFileWrapper( org.hpccsystems.ws.client.gen.axis2.wssql.latest.ECLHelpFile eclhelpfile)
    {
        copy( eclhelpfile );
    }
    ...
    private void copy( org.hpccsystems.ws.client.gen.axis2.wssql.latest.ECLHelpFile raw )
    {
        if (raw == null)
            return;
    ...
    {
        org.hpccsystems.ws.client.gen.axis2.wssql.latest.ECLHelpFile raw = new org.hpccsystems.ws.client.gen.axis2.wssql.latest.ECLHelpFile();
