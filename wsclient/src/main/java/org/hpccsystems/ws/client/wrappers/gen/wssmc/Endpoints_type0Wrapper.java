 ...
 * Wraps class: org.hpccsystems.ws.client.gen.axis2.wssmc.latest.Endpoints_type0
 * Output package : org.hpccsystems.ws.client.wrappers.gen.wssmc
 * TimeStamp: 2022-07-25T18:14:46.532Z
 */
public class Endpoints_type0Wrapper
{
    ...
    public Endpoints_type0Wrapper( org.hpccsystems.ws.client.gen.axis2.wssmc.latest.Endpoints_type0 endpoints_type0)
    {
    ...
    private void copy( org.hpccsystems.ws.client.gen.axis2.wssmc.latest.Endpoints_type0 raw )
    {
        if (raw == null)
            return;
    ...
    public org.hpccsystems.ws.client.gen.axis2.wssmc.latest.Endpoints_type0 getRaw()
    {
        org.hpccsystems.ws.client.gen.axis2.wssmc.latest.Endpoints_type0 raw = new org.hpccsystems.ws.client.gen.axis2.wssmc.latest.Endpoints_type0();
        if (this.local_endpoint!= null)
        {
            org.hpccsystems.ws.client.gen.axis2.wssmc.latest.RoxieControlEndpointInfo[] arr = new org.hpccsystems.ws.client.gen.axis2.wssmc.latest.RoxieControlEndpointInfo[this.local_endpoint.size()];
