...
/**
 *  TpXMLFileResponse bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class TpXMLFileResponse implements org.apache.axis2.databinding.ADBBean {
    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("urn:hpccsystems:ws:wstopology",
            "TpXMLFileResponse", "ns5");
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":TpXMLFileResponse", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "TpXMLFileResponse", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static TpXMLFileResponse parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            TpXMLFileResponse object = new TpXMLFileResponse();
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"TpXMLFileResponse".equals(type)) {
                            ...
                            return (TpXMLFileResponse) org.hpccsystems.ws.client.gen.axis2.wstopology.v1_30.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                while (!reader.isEndElement()) {
                    if (reader.isStartElement()) {
                        if (reader.isStartElement() &&
                         ...
                         if (reader.isStartElement() &&
                                new javax.xml.namespace.QName(
                                    "urn:hpccsystems:ws:wstopology", "thefile").equals(
                                    reader.getName())) {
