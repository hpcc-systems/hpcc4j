 ...
 * Wraps class: org.hpccsystems.ws.client.gen.axis2.wsdfuxref.v1_02.EspException
 * Output package : org.hpccsystems.ws.client.wrappers.gen.wsdfuxref
 * TimeStamp: 2021-03-24T23:14:30.249Z
 */
public class EspExceptionWrapper
{
    ...
    public EspExceptionWrapper( org.hpccsystems.ws.client.gen.axis2.wsdfuxref.latest.EspException espexception)
    {
        copy( espexception );
    }
    ...
    private void copy( org.hpccsystems.ws.client.gen.axis2.wsdfuxref.latest.EspException raw )
    {
        if (raw == null)
            return;
    ...
    public org.hpccsystems.ws.client.gen.axis2.wsdfuxref.latest.EspException getRaw()
    {
        org.hpccsystems.ws.client.gen.axis2.wsdfuxref.latest.EspException raw = new org.hpccsystems.ws.client.gen.axis2.wsdfuxref.latest.EspException();
