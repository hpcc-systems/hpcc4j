...
public class EclRecordLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"T__9", "T__10", "T__11", "T__12", "T__13", "T__14", "T__15", "OSQUARE", 
			"CSQUARE", "OPAREN", "CPAREN", "OCURLY", "CCURLY", "COMMA", "SEMI", "EQ", 
			"ASSING_SYM", "REC_SYM", "END_SYM", "DATASET_SYM", "WS", "INT", "ESCAPED_QUOTE", 
			"SETSTRING", "STRING", "ATOKEN", "TOKEN", "UTOKEN", "ECL_NUMBERED_TYPE", 
			"SETTOKEN"
		};
	}
