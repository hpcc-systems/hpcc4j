...
/**
 *  StopQueue bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class StopQueue implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":StopQueue", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "StopQueue", xmlWriter);
    ...
    public static class Factory {
         ...
         */
        public static StopQueue parse(javax.xml.stream.XMLStreamReader reader)
            throws java.lang.Exception {
            StopQueue object = new StopQueue();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"StopQueue".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (StopQueue) org.hpccsystems.ws.client.gen.axis2.wssmc.latest.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
