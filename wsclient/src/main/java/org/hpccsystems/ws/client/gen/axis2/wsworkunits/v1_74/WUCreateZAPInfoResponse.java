...
public class WUCreateZAPInfoResponse implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":WUCreateZAPInfoResponse", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "WUCreateZAPInfoResponse", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static WUCreateZAPInfoResponse parse(
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"WUCreateZAPInfoResponse".equals(type)) {
                            ...
                            return (WUCreateZAPInfoResponse) org.hpccsystems.ws.client.gen.axis2.wsworkunits.v1_74.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
