...
public class SMCJob implements org.apache.axis2.databinding.ADBBean {
  ...
  */
    ...
    if (serializeType) {
      ...
      if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
        writeAttribute(
            ...
            "type",
            namespacePrefix + ":SMCJob",
            xmlWriter);
      } else {
        writeAttribute(
            "xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "SMCJob", xmlWriter);
      }
    }
    if (localWuidTracker) {
  ...
  public static class Factory {
     ...
     */
    public static SMCJob parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
