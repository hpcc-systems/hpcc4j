...
/**
 *  SubmitDFUWorkunit bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class SubmitDFUWorkunit implements org.apache.axis2.databinding.ADBBean {
    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("urn:hpccsystems:ws:filespray",
            "SubmitDFUWorkunit", "ns1");
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":SubmitDFUWorkunit", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "SubmitDFUWorkunit", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static SubmitDFUWorkunit parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            SubmitDFUWorkunit object = new SubmitDFUWorkunit();
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"SubmitDFUWorkunit".equals(type)) {
                            ...
                            return (SubmitDFUWorkunit) org.hpccsystems.ws.client.gen.axis2.filespray.latest.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
