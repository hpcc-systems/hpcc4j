...
public class TpEspServerWrapper
{
    ...
    public TpEspServerWrapper( org.hpccsystems.ws.client.gen.axis2.wstopology.latest.TpEspServer tpespserver)
    {
        copy( tpespserver );
    }
    ...
    private void copy( org.hpccsystems.ws.client.gen.axis2.wstopology.latest.TpEspServer raw )
    {
        if (raw == null)
            return;
    ...
    public org.hpccsystems.ws.client.gen.axis2.wstopology.latest.TpEspServer getRaw()
    {
        org.hpccsystems.ws.client.gen.axis2.wstopology.latest.TpEspServer raw = new org.hpccsystems.ws.client.gen.axis2.wstopology.latest.TpEspServer();
