...
/** Dependencies_type1 bean class */
@SuppressWarnings({"unchecked", "unused"})
public class Dependencies_type1 implements org.apache.axis2.databinding.ADBBean {
  /* This type was generated from the piece of schema that had
  name = Dependencies_type1
  ...
  */
    ...
    if (serializeType) {
      ...
      if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
        writeAttribute(
            ...
            "type",
            namespacePrefix + ":Dependencies_type1",
            xmlWriter);
      } else {
        writeAttribute(
            "xsi",
  ...
  public static class Factory {
     ...
     */
    public static Dependencies_type1 parse(javax.xml.stream.XMLStreamReader reader)
        throws java.lang.Exception {
      Dependencies_type1 object = new Dependencies_type1();
      ...
      try {
        ...
        if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
          ...
          if (fullTypeName != null) {
            ...
            if (!"Dependencies_type1".equals(type)) {
