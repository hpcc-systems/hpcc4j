      ...
      try {
        ...
        while (!reader.isEndElement()) {
          if (reader.isStartElement()) {
            ...
            if (reader.isStartElement()
                && new javax.xml.namespace.QName("urn:hpccsystems:ws:wscloud", "Code")
              ...
              reader.next();
                ...
                && new javax.xml.namespace.QName("urn:hpccsystems:ws:wscloud", "Audience")
                    .equals(reader.getName())) {
              ...
              reader.next();
                ...
                && new javax.xml.namespace.QName("urn:hpccsystems:ws:wscloud", "Message")
                    .equals(reader.getName())) {
