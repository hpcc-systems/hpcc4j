...
/**
 *  TpLdapServer bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class TpLdapServer implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":TpLdapServer", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "TpLdapServer", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static TpLdapServer parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            TpLdapServer object = new TpLdapServer();
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"TpLdapServer".equals(type)) {
                            ...
                            return (TpLdapServer) org.hpccsystems.ws.client.gen.axis2.wstopology.v1_28.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
