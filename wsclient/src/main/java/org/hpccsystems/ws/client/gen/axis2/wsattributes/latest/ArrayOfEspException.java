...
public class ArrayOfEspException implements org.apache.axis2.databinding.ADBBean {
  ...
  */
   ...
   * Auto generated getter method
   *
   * @return org.hpccsystems.ws.client.gen.axis2.wsattributes.latest.EspException[]
   */
   ...
   *
   * @param param org.hpccsystems.ws.client.gen.axis2.wsattributes.latest.EspException
   */
  public void addException(
      org.hpccsystems.ws.client.gen.axis2.wsattributes.latest.EspException param) {
    if (localException == null) {
      localException =
          new org.hpccsystems.ws.client.gen.axis2.wsattributes.latest.EspException[] {};
    }
    ...
    list.add(param);
    this.localException =
        (org.hpccsystems.ws.client.gen.axis2.wsattributes.latest.EspException[])
            list.toArray(
                new org.hpccsystems.ws.client.gen.axis2.wsattributes.latest.EspException
                    [list.size()]);
  }
        ...
        for (int i = 0; i < localException.length; i++) {
          if (localException[i] != null) {
            localException[i].serialize(
                new javax.xml.namespace.QName("urn:hpccsystems:ws:wsattributes", "Exception"),
                xmlWriter);
          } else {
    ...
    public static ArrayOfEspException parse(javax.xml.stream.XMLStreamReader reader)
      ...
      try {
        ...
        if (reader.isStartElement()
            && new javax.xml.namespace.QName("urn:hpccsystems:ws:wsattributes", "Source")
        ...
        if (reader.isStartElement()
          ...
          list2.add(
              org.hpccsystems.ws.client.gen.axis2.wsattributes.latest.EspException.Factory.parse(
                  reader));
          ...
          while (!loopDone2) {
            ...
            if (reader.isEndElement()) {
              ...
              if (new javax.xml.namespace.QName("urn:hpccsystems:ws:wsattributes", "Exception")
                  .equals(reader.getName())) {
                list2.add(
                    org.hpccsystems.ws.client.gen.axis2.wsattributes.latest.EspException.Factory
                        .parse(reader));
