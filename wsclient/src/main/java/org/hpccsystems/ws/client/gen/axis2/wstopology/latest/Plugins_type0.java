...
public class Plugins_type0 implements org.apache.axis2.databinding.ADBBean {
  ...
  */
  ...
  public void addPlugin(
    ...
    if (localPlugin == null) {
      localPlugin =
          new org.hpccsystems.ws.client.gen.axis2.wstopology.latest.TpEspServicePlugin[] {};
    }
    ...
    list.add(param);
    this.localPlugin =
        (org.hpccsystems.ws.client.gen.axis2.wstopology.latest.TpEspServicePlugin[])
            list.toArray(
                new org.hpccsystems.ws.client.gen.axis2.wstopology.latest.TpEspServicePlugin
                    [list.size()]);
  }
      ...
      if (localPlugin != null) {
        for (int i = 0; i < localPlugin.length; i++) {
          if (localPlugin[i] != null) {
            localPlugin[i].serialize(
                new javax.xml.namespace.QName("urn:hpccsystems:ws:wstopology", "Plugin"),
                xmlWriter);
          } else {
    ...
    public static Plugins_type0 parse(javax.xml.stream.XMLStreamReader reader)
      ...
      try {
        ...
        if (reader.isStartElement()
          ...
          list1.add(
              org.hpccsystems.ws.client.gen.axis2.wstopology.latest.TpEspServicePlugin.Factory
                  .parse(reader));
          ...
          while (!loopDone1) {
            ...
            if (reader.isEndElement()) {
              ...
              if (new javax.xml.namespace.QName("urn:hpccsystems:ws:wstopology", "Plugin")
                  .equals(reader.getName())) {
                list1.add(
                    org.hpccsystems.ws.client.gen.axis2.wstopology.latest.TpEspServicePlugin.Factory
                        .parse(reader));
