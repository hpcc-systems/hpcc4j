...
public class FetchKeyMDResponse implements org.apache.axis2.databinding.ADBBean {
  ...
  public static final javax.xml.namespace.QName MY_QNAME =
      new javax.xml.namespace.QName("urn:hpccsystems:ws:wsstore", "FetchKeyMDResponse", "ns11");
   ...
   * Auto generated getter method
   *
   * @return org.hpccsystems.ws.client.gen.axis2.wsstore.latest.Pairs_type1
   */
   ...
   * @param param Pairs
   */
  public void setPairs(org.hpccsystems.ws.client.gen.axis2.wsstore.latest.Pairs_type1 param) {
  ...
  public void serialize(
    ...
    if (serializeType) {
      ...
      if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
        writeAttribute(
            ...
            "type",
            namespacePrefix + ":FetchKeyMDResponse",
            xmlWriter);
      } else {
        writeAttribute(
            "xsi",
    ...
    if (localPairsTracker) {
      ...
      localPairs.serialize(
          new javax.xml.namespace.QName("urn:hpccsystems:ws:wsstore", "Pairs"), xmlWriter);
    }
    xmlWriter.writeEndElement();
  }
  ...
  public static class Factory {
     ...
     */
    public static FetchKeyMDResponse parse(javax.xml.stream.XMLStreamReader reader)
          ...
          if (reader.isStartElement()) {
            ...
            if (reader.isStartElement()
              ...
              reader.next();
                ...
                && new javax.xml.namespace.QName("urn:hpccsystems:ws:wsstore", "Pairs")
                    .equals(reader.getName())) {

              object.setPairs(
                  org.hpccsystems.ws.client.gen.axis2.wsstore.latest.Pairs_type1.Factory.parse(
                      reader));
