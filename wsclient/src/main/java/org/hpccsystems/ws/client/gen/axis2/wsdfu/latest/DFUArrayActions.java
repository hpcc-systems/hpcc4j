...
public class DFUArrayActions implements org.apache.axis2.databinding.ADBBean {
    ...
    public static final DFUArrayActions value2 = new DFUArrayActions(_value2,
            true);
    public static final DFUArrayActions value3 = new DFUArrayActions(_value3,
            true);
    public static final DFUArrayActions value4 = new DFUArrayActions(_value4,
            true);
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":DFUArrayActions", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "DFUArrayActions", xmlWriter);
            }
        }

        if (localDFUArrayActions == null) {
            throw new org.apache.axis2.databinding.ADBException(
                "DFUArrayActions cannot be null !!");
        } else {
    ...
    public static class Factory {
         ...
         */
        public static DFUArrayActions parse(
