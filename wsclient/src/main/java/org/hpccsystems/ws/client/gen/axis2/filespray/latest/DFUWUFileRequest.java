...
/**
 *  DFUWUFileRequest bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class DFUWUFileRequest implements org.apache.axis2.databinding.ADBBean {
    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("urn:hpccsystems:ws:filespray",
            "DFUWUFileRequest", "ns1");
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":DFUWUFileRequest", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "DFUWUFileRequest", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static DFUWUFileRequest parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            DFUWUFileRequest object = new DFUWUFileRequest();
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"DFUWUFileRequest".equals(type)) {
                            ...
                            return (DFUWUFileRequest) org.hpccsystems.ws.client.gen.axis2.filespray.latest.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                while (!reader.isEndElement()) {
                    if (reader.isStartElement()) {
                        if (reader.isStartElement() &&
                         ...
                         if (reader.isStartElement() &&
                                new javax.xml.namespace.QName(
                                    "urn:hpccsystems:ws:filespray", "PlainText").equals(
                                    reader.getName())) {
                            nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance",
                                    "nil");
