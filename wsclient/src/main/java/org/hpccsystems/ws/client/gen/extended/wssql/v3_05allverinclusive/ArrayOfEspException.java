...
public class ArrayOfEspException  extends org.apache.axis.AxisFault  implements java.io.Serializable {
    ...
    private org.hpccsystems.ws.client.gen.extended.wssql.v3_05allverinclusive.EspException[] exception;
    ...
    public ArrayOfEspException(
           ...
           org.hpccsystems.ws.client.gen.extended.wssql.v3_05allverinclusive.EspException[] exception) {
        this.source = source;
     ...
     * @return exception
     */
    public org.hpccsystems.ws.client.gen.extended.wssql.v3_05allverinclusive.EspException[] getException() {
        return exception;
    }
     ...
     * @param exception
     */
    public void setException(org.hpccsystems.ws.client.gen.extended.wssql.v3_05allverinclusive.EspException[] exception) {
        this.exception = exception;
    }

    public org.hpccsystems.ws.client.gen.extended.wssql.v3_05allverinclusive.EspException getException(int i) {
        return this.exception[i];
    }

    public void setException(int i, org.hpccsystems.ws.client.gen.extended.wssql.v3_05allverinclusive.EspException _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:hpccsystems:ws:wssql", "ArrayOfEspException"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:hpccsystems:ws:wssql", "Exception"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:hpccsystems:ws:wssql", "EspException"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
