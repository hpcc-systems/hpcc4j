...
/**
 *  RenameResponse bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class RenameResponse implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":RenameResponse", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "RenameResponse", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static RenameResponse parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            RenameResponse object = new RenameResponse();
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"RenameResponse".equals(type)) {
                            ...
                            return (RenameResponse) org.hpccsystems.ws.client.gen.axis2.filespray.v1_17.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
