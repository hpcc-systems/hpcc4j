 ...
 * Class name: ResumeQueueWrapper
 * Wraps class: org.hpccsystems.ws.client.gen.axis2.wssmc.latest.ResumeQueue
 * Output package : org.hpccsystems.ws.client.wrappers.gen.wssmc
 * TimeStamp: 2021-10-27T20:17:20.604Z
 */
public class ResumeQueueWrapper
{
    ...
    public ResumeQueueWrapper( org.hpccsystems.ws.client.gen.axis2.wssmc.latest.ResumeQueue resumequeue)
    {
        copy( resumequeue );
    }
    public ResumeQueueWrapper( String _cluster, String _queueName, String _comment, String _serverType, String _networkAddress, int _port )
    {
    ...
    private void copy( org.hpccsystems.ws.client.gen.axis2.wssmc.latest.ResumeQueue raw )
    {
        if (raw == null)
            return;
    ...
    {
        return "ResumeQueueWrapper [" + "cluster = " + local_cluster + ", " + "queueName = " + local_queueName + ", " + "comment = " + local_comment + ", " + "serverType = " + local_serverType + ", " + "networkAddress = " + local_networkAddress + ", " + "port = " + local_port + "]";
    }
    public org.hpccsystems.ws.client.gen.axis2.wssmc.latest.ResumeQueue getRaw()
    {
        org.hpccsystems.ws.client.gen.axis2.wssmc.latest.ResumeQueue raw = new org.hpccsystems.ws.client.gen.axis2.wssmc.latest.ResumeQueue();
