  ...
  public void serialize(
    ...
    if (serializeType) {
      ...
      if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
        ...
        writeAttribute(
            "xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "TpEspServer", xmlWriter);
      }
    }
    if (localNameTracker) {
    ...
    if (localTpBindingsTracker) {
      ...
      localTpBindings.serialize(
          new javax.xml.namespace.QName("urn:hpccsystems:ws:wstopology", "TpBindings"), xmlWriter);
    }
    xmlWriter.writeEndElement();
  }
          ...
          if (reader.isStartElement()) {
            ...
            if (reader.isStartElement()
              ...
              reader.next();
                ...
                && new javax.xml.namespace.QName("urn:hpccsystems:ws:wstopology", "TpBindings")
                    .equals(reader.getName())) {

              object.setTpBindings(
                  org.hpccsystems.ws.client.gen.axis2.wstopology.latest.ArrayOfTpBinding.Factory
                      .parse(reader));
