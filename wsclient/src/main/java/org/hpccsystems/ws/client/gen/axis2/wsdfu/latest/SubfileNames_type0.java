...
/**
 *  SubfileNames_type0 bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class SubfileNames_type0 implements org.apache.axis2.databinding.ADBBean {
    ...
    public void addSubfileName(java.lang.String param) {
        ...
        java.util.List list = org.apache.axis2.databinding.utils.ConverterUtil.toList(localSubfileName);
        list.add(param);
        this.localSubfileName = (java.lang.String[]) list.toArray(new java.lang.String[list.size()]);
    }
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":SubfileNames_type0", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "SubfileNames_type0", xmlWriter);
            }
        }
            ...
            if (localSubfileName != null) {
                ...
                for (int i = 0; i < localSubfileName.length; i++) {
                    if (localSubfileName[i] != null) {
                        writeStartElement(null, namespace, "SubfileName",
                            xmlWriter);
    ...
    public static class Factory {
         ...
         */
        public static SubfileNames_type0 parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            SubfileNames_type0 object = new SubfileNames_type0();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"SubfileNames_type0".equals(type)) {
                            ...
                            return (SubfileNames_type0) org.hpccsystems.ws.client.gen.axis2.wsdfu.latest.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName(
                            "urn:hpccsystems:ws:wsdfu", "SubfileName").equals(
                            reader.getName())) {
                    ...
                    while (!loopDone1) {
                        ...
                        if (reader.isEndElement()) {
                            ...
                            if (new javax.xml.namespace.QName(
                                        "urn:hpccsystems:ws:wsdfu",
                                        "SubfileName").equals(reader.getName())) {
                                list1.add(reader.getElementText());
                            } else {
                                loopDone1 = true;
                            }
                    ...
                    object.setSubfileName((java.lang.String[]) list1.toArray(
