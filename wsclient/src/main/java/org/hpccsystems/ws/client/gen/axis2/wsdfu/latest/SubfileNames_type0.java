...
public class SubfileNames_type0 implements org.apache.axis2.databinding.ADBBean {
  ...
  */
  ...
  public static class Factory {
     ...
     */
    public static SubfileNames_type0 parse(javax.xml.stream.XMLStreamReader reader)
      ...
      try {
        ...
        if (reader.isStartElement()
            && new javax.xml.namespace.QName("urn:hpccsystems:ws:wsdfu", "SubfileName")
          ...
          while (!loopDone1) {
            ...
            if (reader.isEndElement()) {
              ...
              if (new javax.xml.namespace.QName("urn:hpccsystems:ws:wsdfu", "SubfileName")
                  .equals(reader.getName())) {
                list1.add(reader.getElementText());
