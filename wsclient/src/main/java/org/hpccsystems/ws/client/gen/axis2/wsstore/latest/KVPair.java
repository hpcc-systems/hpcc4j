...
public class KVPair implements org.apache.axis2.databinding.ADBBean {
  ...
  */
    ...
    if (serializeType) {
      ...
      if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
        writeAttribute(
            ...
            "type",
            namespacePrefix + ":KVPair",
            xmlWriter);
      } else {
        writeAttribute(
            "xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "KVPair", xmlWriter);
      }
    }
    if (localKeyTracker) {
  ...
  public static class Factory {
     ...
     */
    public static KVPair parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
      KVPair object = new KVPair();
