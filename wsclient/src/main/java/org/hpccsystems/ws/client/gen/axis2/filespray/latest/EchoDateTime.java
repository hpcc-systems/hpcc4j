...
/** EchoDateTime bean class */
@SuppressWarnings({"unchecked", "unused"})
public class EchoDateTime implements org.apache.axis2.databinding.ADBBean {

  public static final javax.xml.namespace.QName MY_QNAME =
      new javax.xml.namespace.QName("urn:hpccsystems:ws:filespray", "EchoDateTime", "ns1");
  ...
  public void serialize(
    ...
    if (serializeType) {
      ...
      if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
        ...
        writeAttribute(
            "xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "EchoDateTime", xmlWriter);
      }
    }
    if (localDtTracker) {
      ...
      if (localDt == null) {
        ...
        xmlWriter.writeCharacters(
            org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localDt));
      }
  ...
  public static class Factory {
     ...
     */
    public static EchoDateTime parse(javax.xml.stream.XMLStreamReader reader)
        throws java.lang.Exception {
      EchoDateTime object = new EchoDateTime();
      ...
      try {
        ...
        while (!reader.isEndElement()) {
          if (reader.isStartElement()) {
            ...
            if (reader.isStartElement()
                && new javax.xml.namespace.QName("urn:hpccsystems:ws:filespray", "dt")
