...
public class WriteFileDataRequest implements org.apache.axis2.databinding.ADBBean {
     ...
     * field for Append
     */
    protected boolean localAppend = org.apache.axis2.databinding.utils.ConverterUtil.convertToBoolean(
            "false");
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":WriteFileDataRequest", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "WriteFileDataRequest", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static WriteFileDataRequest parse(
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"WriteFileDataRequest".equals(type)) {
                            ...
                            return (WriteFileDataRequest) org.hpccsystems.ws.client.gen.axis2.wsfileio.latest.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                    ...
                    if (reader.isStartElement()) {
                        if (reader.isStartElement() &&
                         ...
                         if (reader.isStartElement() &&
                                new javax.xml.namespace.QName(
                                    "urn:hpccsystems:ws:wsfileio",
                                    "DestNetAddress").equals(reader.getName())) {
                            nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance",
                                    "nil");
                            ...
                            if ("true".equals(nillableValue) ||
                                    "1".equals(nillableValue)) {
                                throw new org.apache.axis2.databinding.ADBException(
                                    "The element: " + "DestNetAddress" +
                                    "  cannot be null");
                            }

                            java.lang.String content = reader.getElementText();

                            object.setDestNetAddress(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                                    content));
