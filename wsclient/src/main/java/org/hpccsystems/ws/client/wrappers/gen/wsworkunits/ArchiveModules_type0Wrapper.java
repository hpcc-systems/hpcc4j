 ...
 * Class name: ArchiveModules_type0Wrapper
 * Wraps class: org.hpccsystems.ws.client.gen.axis2.wsworkunits.latest.ArchiveModules_type0
 * Output package : org.hpccsystems.ws.client.wrappers.gen.wsworkunits
 * TimeStamp: 2022-07-22T20:33:16.771Z
 */
public class ArchiveModules_type0Wrapper
{
    ...
    public ArchiveModules_type0Wrapper( org.hpccsystems.ws.client.gen.axis2.wsworkunits.latest.ArchiveModules_type0 archivemodules_type0)
    {
        copy( archivemodules_type0 );
    }
    public ArchiveModules_type0Wrapper( List<WUArchiveModuleWrapper> _archiveModule )
    {
        this.local_archiveModule = _archiveModule;

    }

    private void copy( org.hpccsystems.ws.client.gen.axis2.wsworkunits.latest.ArchiveModules_type0 raw )
    {
        if (raw == null)
            return;
    ...
    {
        return "ArchiveModules_type0Wrapper [" + "archiveModule = " + local_archiveModule + "]";
    }
    public org.hpccsystems.ws.client.gen.axis2.wsworkunits.latest.ArchiveModules_type0 getRaw()
    {
        org.hpccsystems.ws.client.gen.axis2.wsworkunits.latest.ArchiveModules_type0 raw = new org.hpccsystems.ws.client.gen.axis2.wsworkunits.latest.ArchiveModules_type0();
