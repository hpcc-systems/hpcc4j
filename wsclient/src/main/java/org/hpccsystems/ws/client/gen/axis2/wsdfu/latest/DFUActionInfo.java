...
/**
 *  DFUActionInfo bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class DFUActionInfo implements org.apache.axis2.databinding.ADBBean {
    ...
    /**
     * field for ActionResult
     */
    protected java.lang.String localActionResult;

    /*  This tracker boolean wil be used to detect whether the user called the set method
     *   for this attribute. It will be used to determine whether to include this field
     *   in the serialized XML
     */
    protected boolean localActionResultTracker = false;
    ...
    public boolean isActionResultSpecified() {
        return localActionResultTracker;
    }
    ...
    /**
     * Auto generated setter method
     * @param param ActionResult
     */
    public void setActionResult(java.lang.String param) {
        localActionResultTracker = param != null;

        this.localActionResult = param;
    }
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":DFUActionInfo", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "DFUActionInfo", xmlWriter);
            }
        }
        ...
        if (localActionResultTracker) {
            namespace = "urn:hpccsystems:ws:wsdfu";
            writeStartElement(null, namespace, "ActionResult", xmlWriter);

            if (localActionResult == null) {
                // write the nil attribute
                throw new org.apache.axis2.databinding.ADBException(
                    "ActionResult cannot be null!!");
            } else {
                xmlWriter.writeCharacters(localActionResult);
            }
    ...
    public static class Factory {
         ...
         */
        public static DFUActionInfo parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            DFUActionInfo object = new DFUActionInfo();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"DFUActionInfo".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (DFUActionInfo) org.hpccsystems.ws.client.gen.axis2.wsdfu.latest.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                while (!reader.isEndElement()) {
                    if (reader.isStartElement()) {
                        if (reader.isStartElement() &&
                         ...
                         if (reader.isStartElement() &&
                                new javax.xml.namespace.QName(
                                    "urn:hpccsystems:ws:wsdfu", "ActionResult").equals(
                                    reader.getName())) {
                            nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance",
                                    "nil");
                            ...
                            if ("true".equals(nillableValue) ||
                                    "1".equals(nillableValue)) {
                                throw new org.apache.axis2.databinding.ADBException(
                                    "The element: " + "ActionResult" +
                                    "  cannot be null");
                            }

                            java.lang.String content = reader.getElementText();

                            object.setActionResult(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                                    content));
                         ...
                         if (reader.isStartElement() &&
                                new javax.xml.namespace.QName(
                                    "urn:hpccsystems:ws:wsdfu", "Failed").equals(
                                    reader.getName())) {
                            nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance",
                                    "nil");
