...
/**
 *  NotInDFS_type0 bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class NotInDFS_type0 implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":NotInDFS_type0", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "NotInDFS_type0", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static NotInDFS_type0 parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            NotInDFS_type0 object = new NotInDFS_type0();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"NotInDFS_type0".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (NotInDFS_type0) org.hpccsystems.ws.client.gen.axis2.wspackageprocess.latest.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
