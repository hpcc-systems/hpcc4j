/**
 * PublishESDLBindingRequest.java
 *
...
public class PublishESDLBindingRequest  implements java.io.Serializable {
    ...
    private java.lang.String espServiceName;
    ...
    private org.hpccsystems.ws.client.gen.wsesdlconfig.v1_3.MethodConfig[] methods;

    private java.lang.Boolean echoBinding;

    public PublishESDLBindingRequest() {
    }
    ...
    /**
     * Gets the espProcName value for this PublishESDLBindingRequest.
     * 
     * @return espProcName
     */
    ...
    /**
     * Sets the espProcName value for this PublishESDLBindingRequest.
     * 
     * @param espProcName
     */
    ...
    /**
     * Gets the espBindingName value for this PublishESDLBindingRequest.
     * 
    ...
    /**
     * Sets the espBindingName value for this PublishESDLBindingRequest.
     * 
    ...
    /**
     * Gets the espPort value for this PublishESDLBindingRequest.
     * 
     * @return espPort
     */
    ...
    /**
     * Sets the espPort value for this PublishESDLBindingRequest.
     * 
     * @param espPort
     */
    ...
    /**
     * Gets the espServiceName value for this PublishESDLBindingRequest.
     * 
     * @return espServiceName
     */
    public java.lang.String getEspServiceName() {
        return espServiceName;
    }


    /**
     * Sets the espServiceName value for this PublishESDLBindingRequest.
     * 
     * @param espServiceName
     */
    public void setEspServiceName(java.lang.String espServiceName) {
        this.espServiceName = espServiceName;
    }


    /**
     * Gets the esdlDefinitionID value for this PublishESDLBindingRequest.
     * 
    ...
    /**
     * Sets the esdlDefinitionID value for this PublishESDLBindingRequest.
     * 
    ...
    /**
     * Gets the esdlServiceName value for this PublishESDLBindingRequest.
     * 
    ...
    /**
     * Sets the esdlServiceName value for this PublishESDLBindingRequest.
     * 
    ...
    /**
     * Gets the overwrite value for this PublishESDLBindingRequest.
     * 
     * @return overwrite
     */
    ...
    /**
     * Sets the overwrite value for this PublishESDLBindingRequest.
     * 
     * @param overwrite
     */
    ...
    /**
     * Gets the config value for this PublishESDLBindingRequest.
     * 
     * @return config
     */
    ...
    /**
     * Sets the config value for this PublishESDLBindingRequest.
     * 
     * @param config
     */
    ...
    /**
     * Gets the methods value for this PublishESDLBindingRequest.
     * 
     * @return methods
     */
    public org.hpccsystems.ws.client.gen.wsesdlconfig.v1_3.MethodConfig[] getMethods() {
        return methods;
    }


    /**
     * Sets the methods value for this PublishESDLBindingRequest.
     * 
     * @param methods
     */
    public void setMethods(org.hpccsystems.ws.client.gen.wsesdlconfig.v1_3.MethodConfig[] methods) {
        this.methods = methods;
    }


    /**
     * Gets the echoBinding value for this PublishESDLBindingRequest.
     * 
     * @return echoBinding
     */
    ...
    /**
     * Sets the echoBinding value for this PublishESDLBindingRequest.
     * 
     * @param echoBinding
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof PublishESDLBindingRequest)) return false;
        PublishESDLBindingRequest other = (PublishESDLBindingRequest) obj;
        ...
        _equals = true && 
            ...
            ((this.espServiceName==null && other.getEspServiceName()==null) || 
             (this.espServiceName!=null &&
              this.espServiceName.equals(other.getEspServiceName()))) &&
    ...
    public synchronized int hashCode() {
        ...
        if (getEspServiceName() != null) {
            _hashCode += getEspServiceName().hashCode();
        }
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(PublishESDLBindingRequest.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:hpccsystems:ws:wsesdlconfig", ">PublishESDLBindingRequest"));
        ...
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("espServiceName");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:hpccsystems:ws:wsesdlconfig", "EspServiceName"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
