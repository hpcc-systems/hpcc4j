...
/** BasePackageStatus bean class */
@SuppressWarnings({"unchecked", "unused"})
public class BasePackageStatus implements org.apache.axis2.databinding.ADBBean {
  /* This type was generated from the piece of schema that had
  name = BasePackageStatus
  ...
  */
    ...
    if (serializeType) {
      ...
      if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
        writeAttribute(
            ...
            "type",
            namespacePrefix + ":BasePackageStatus",
            xmlWriter);
      } else {
        writeAttribute(
            "xsi",
  ...
  public static class Factory {
     ...
     */
    public static BasePackageStatus parse(javax.xml.stream.XMLStreamReader reader)
        throws java.lang.Exception {
      BasePackageStatus object = new BasePackageStatus();
      ...
      try {
        ...
        if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
          ...
          if (fullTypeName != null) {
            ...
            if (!"BasePackageStatus".equals(type)) {
        ...
        while (!reader.isEndElement()) {
          if (reader.isStartElement()) {
            ...
            if (reader.isStartElement()
                && new javax.xml.namespace.QName("urn:hpccsystems:ws:wspackageprocess", "Code")
