 ...
 * Class name: StopQueueWrapper
 * Wraps class: org.hpccsystems.ws.client.gen.axis2.wssmc.latest.StopQueue
 * Output package : org.hpccsystems.ws.client.wrappers.gen.wssmc
 * TimeStamp: 2021-10-27T20:17:20.622Z
 */
public class StopQueueWrapper
{
    ...
    public StopQueueWrapper() {}

    public StopQueueWrapper( org.hpccsystems.ws.client.gen.axis2.wssmc.latest.StopQueue stopqueue)
    {
        copy( stopqueue );
    }
    public StopQueueWrapper( String _cluster, String _queueName, String _comment, String _serverType, String _networkAddress, int _port )
    {
    ...
    private void copy( org.hpccsystems.ws.client.gen.axis2.wssmc.latest.StopQueue raw )
    {
        if (raw == null)
            return;
    ...
    {
        return "StopQueueWrapper [" + "cluster = " + local_cluster + ", " + "queueName = " + local_queueName + ", " + "comment = " + local_comment + ", " + "serverType = " + local_serverType + ", " + "networkAddress = " + local_networkAddress + ", " + "port = " + local_port + "]";
    }
    public org.hpccsystems.ws.client.gen.axis2.wssmc.latest.StopQueue getRaw()
    {
        org.hpccsystems.ws.client.gen.axis2.wssmc.latest.StopQueue raw = new org.hpccsystems.ws.client.gen.axis2.wssmc.latest.StopQueue();
