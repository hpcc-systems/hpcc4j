...
public class WUUpdateQueryEntry implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":WUUpdateQueryEntry", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "WUUpdateQueryEntry", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static WUUpdateQueryEntry parse(
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"WUUpdateQueryEntry".equals(type)) {
                            ...
                            return (WUUpdateQueryEntry) org.hpccsystems.ws.client.gen.axis2.wsworkunits.v1_81.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
