 ...
 * Wraps class: org.hpccsystems.ws.client.gen.axis2.wsworkunits.v1_83.EspSoapFault
...
public class EspSoapFaultWrapper
{
    ...
    public EspSoapFaultWrapper( org.hpccsystems.ws.client.gen.axis2.wsworkunits.latest.EspSoapFault espsoapfault)
    {
        copy( espsoapfault );
    }
    ...
    private void copy( org.hpccsystems.ws.client.gen.axis2.wsworkunits.latest.EspSoapFault raw )
    {
        if (raw == null)
            return;
