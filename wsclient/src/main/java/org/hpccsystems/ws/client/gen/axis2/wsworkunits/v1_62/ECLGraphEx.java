...
/** ECLGraphEx bean class */
@SuppressWarnings({"unchecked", "unused"})
public class ECLGraphEx implements org.apache.axis2.databinding.ADBBean {
  ...
  */
    ...
    if (serializeType) {
      ...
      if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
        writeAttribute(
            ...
            "type",
            namespacePrefix + ":ECLGraphEx",
            xmlWriter);
      } else {
        writeAttribute(
            "xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "ECLGraphEx", xmlWriter);
      }
    }
    if (localNameTracker) {
  ...
  public static class Factory {
     ...
     */
    public static ECLGraphEx parse(javax.xml.stream.XMLStreamReader reader)
        throws java.lang.Exception {
      ECLGraphEx object = new ECLGraphEx();
