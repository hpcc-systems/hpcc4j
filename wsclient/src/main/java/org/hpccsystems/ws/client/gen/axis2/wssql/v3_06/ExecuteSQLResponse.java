...
/**
 *  ExecuteSQLResponse bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class ExecuteSQLResponse implements org.apache.axis2.databinding.ADBBean {
    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("urn:hpccsystems:ws:wssql",
            "ExecuteSQLResponse", "ns12");
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":ExecuteSQLResponse", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "ExecuteSQLResponse", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static ExecuteSQLResponse parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            ExecuteSQLResponse object = new ExecuteSQLResponse();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"ExecuteSQLResponse".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (ExecuteSQLResponse) org.hpccsystems.ws.client.gen.axis2.wssql.v3_06.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
