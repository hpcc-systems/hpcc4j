...
/**
 *  DFUWUFileResponse bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class DFUWUFileResponse implements org.apache.axis2.databinding.ADBBean {
    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("urn:hpccsystems:ws:filespray",
            "DFUWUFileResponse", "ns2");
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":DFUWUFileResponse", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "DFUWUFileResponse", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static DFUWUFileResponse parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            DFUWUFileResponse object = new DFUWUFileResponse();
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"DFUWUFileResponse".equals(type)) {
                            ...
                            return (DFUWUFileResponse) org.hpccsystems.ws.client.gen.axis2.filespray.v1_17.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                while (!reader.isEndElement()) {
                    if (reader.isStartElement()) {
                        if (reader.isStartElement() &&
                         ...
                         if (reader.isStartElement() &&
                                new javax.xml.namespace.QName(
                                    "urn:hpccsystems:ws:filespray", "file").equals(
                                    reader.getName())) {
