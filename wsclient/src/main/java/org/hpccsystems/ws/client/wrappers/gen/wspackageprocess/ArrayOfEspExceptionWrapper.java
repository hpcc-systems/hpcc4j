 ...
 * Wraps class: org.hpccsystems.ws.client.gen.axis2.wspackageprocess.latest.ArrayOfEspException
 * Output package : org.hpccsystems.ws.client.wrappers.gen.wspackageprocess
 * TimeStamp: 2022-07-25T17:42:18.137Z
 */
public class ArrayOfEspExceptionWrapper
{
    ...
    private void copy( org.hpccsystems.ws.client.gen.axis2.wspackageprocess.latest.ArrayOfEspException raw )
    {
        if (raw == null)
            return;
    ...
    public org.hpccsystems.ws.client.gen.axis2.wspackageprocess.latest.ArrayOfEspException getRaw()
    {
        org.hpccsystems.ws.client.gen.axis2.wspackageprocess.latest.ArrayOfEspException raw = new org.hpccsystems.ws.client.gen.axis2.wspackageprocess.latest.ArrayOfEspException();
        raw.setSource( local_source);
        if (this.local_exception!= null)
        {
            org.hpccsystems.ws.client.gen.axis2.wspackageprocess.latest.EspException[] arr = new org.hpccsystems.ws.client.gen.axis2.wspackageprocess.latest.EspException[this.local_exception.size()];
