...
public class DFUChangeRestriction implements org.apache.axis2.databinding.ADBBean {
  ...
  public static final DFUChangeRestriction value1 = new DFUChangeRestriction(_value1, true);

  public static final DFUChangeRestriction value2 = new DFUChangeRestriction(_value2, true);

  public static final DFUChangeRestriction value3 = new DFUChangeRestriction(_value3, true);
    ...
    if (serializeType) {
      ...
      if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
        writeAttribute(
            ...
            "type",
            namespacePrefix + ":DFUChangeRestriction",
            xmlWriter);
      } else {
        writeAttribute(
            "xsi",
  ...
  public static class Factory {
    ...
    public static DFUChangeRestriction fromString(
      ...
      if (content.indexOf(":") > -1) {
        ...
        return DFUChangeRestriction.Factory.fromString(content, namespaceUri);
      } else {
     ...
     */
    public static DFUChangeRestriction parse(javax.xml.stream.XMLStreamReader reader)
          ...
          if (reader.isStartElement() || reader.hasText()) {
            ...
            if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
              throw new org.apache.axis2.databinding.ADBException(
                  "The element: " + "DFUChangeRestriction" + "  cannot be null");
            }
            ...
            if (content.indexOf(":") > 0) {
              ...
              object = DFUChangeRestriction.Factory.fromString(content, namespaceuri);
            } else {
