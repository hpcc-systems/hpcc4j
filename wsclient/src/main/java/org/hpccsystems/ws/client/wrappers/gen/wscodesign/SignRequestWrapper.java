 ...
 * Wraps class: org.hpccsystems.ws.client.gen.axis2.wscodesign.v1_01.SignRequest
 * Output package : org.hpccsystems.ws.client.wrappers.gen.wscodesign
 * TimeStamp: 2021-03-26T18:27:31.414Z
 */
public class SignRequestWrapper
{
	...
	private void copy( org.hpccsystems.ws.client.gen.axis2.wscodesign.v1_01.SignRequest raw )
	{
		if (raw == null)
			return;
	...
	{
		org.hpccsystems.ws.client.gen.axis2.wscodesign.v1_01.SignRequest raw = new org.hpccsystems.ws.client.gen.axis2.wscodesign.v1_01.SignRequest();
