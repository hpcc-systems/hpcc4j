 ...
 * Wraps class: org.hpccsystems.ws.client.gen.axis2.wsresources.latest.ArrayOfEspException
 * Output package : org.hpccsystems.ws.client.wrappers.gen.wsresources
 * TimeStamp: 2022-07-25T18:03:51.509Z
 */
public class ArrayOfEspExceptionWrapper
{
    ...
    private void copy( org.hpccsystems.ws.client.gen.axis2.wsresources.latest.ArrayOfEspException raw )
    {
        if (raw == null)
            return;
    ...
    public org.hpccsystems.ws.client.gen.axis2.wsresources.latest.ArrayOfEspException getRaw()
    {
        org.hpccsystems.ws.client.gen.axis2.wsresources.latest.ArrayOfEspException raw = new org.hpccsystems.ws.client.gen.axis2.wsresources.latest.ArrayOfEspException();
        raw.setSource( local_source);
        if (this.local_exception!= null)
        {
            org.hpccsystems.ws.client.gen.axis2.wsresources.latest.EspException[] arr = new org.hpccsystems.ws.client.gen.axis2.wsresources.latest.EspException[this.local_exception.size()];
