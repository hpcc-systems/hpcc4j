...
/**
 *  ServerJobQueue bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class ServerJobQueue implements org.apache.axis2.databinding.ADBBean {
     ...
     * field for Queues
     */
    protected org.hpccsystems.ws.client.gen.axis2.wssmc.v1_21.ArrayOfServerJobQueue localQueues;
     ...
     */
    public org.hpccsystems.ws.client.gen.axis2.wssmc.v1_21.ArrayOfServerJobQueue getQueues() {
        return localQueues;
    }
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":ServerJobQueue", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "ServerJobQueue", xmlWriter);
            }
        }
        ...
        if (localQueuesTracker) {
            if (localQueues == null) {
                throw new org.apache.axis2.databinding.ADBException(
                    "Queues cannot be null!!");
            }

            localQueues.serialize(new javax.xml.namespace.QName(
                    "urn:hpccsystems:ws:wssmc", "Queues"), xmlWriter);
        }
    ...
    public static class Factory {
         ...
         */
        public static ServerJobQueue parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            ServerJobQueue object = new ServerJobQueue();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"ServerJobQueue".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (ServerJobQueue) org.hpccsystems.ws.client.gen.axis2.wssmc.v1_21.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                while (!reader.isEndElement()) {
                    if (reader.isStartElement()) {
                        if (reader.isStartElement() &&
                         ...
                         if (reader.isStartElement() &&
                                new javax.xml.namespace.QName(
                                    "urn:hpccsystems:ws:wssmc", "Queues").equals(
                                    reader.getName())) {
                            object.setQueues(org.hpccsystems.ws.client.gen.axis2.wssmc.v1_21.ArrayOfServerJobQueue.Factory.parse(
                                    reader));
                         ...
                         if (reader.isStartElement() &&
                                new javax.xml.namespace.QName(
                                    "urn:hpccsystems:ws:wssmc", "ServerName").equals(
                                    reader.getName())) {
                            nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance",
                                    "nil");
                         ...
                         if (reader.isStartElement() &&
                                new javax.xml.namespace.QName(
                                    "urn:hpccsystems:ws:wssmc", "ServerType").equals(
                                    reader.getName())) {
                            nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance",
                                    "nil");
                            ...
                            if ("true".equals(nillableValue) ||
                                    "1".equals(nillableValue)) {
                                throw new org.apache.axis2.databinding.ADBException(
                                    "The element: " + "ServerType" +
                                    "  cannot be null");
                            }

                            java.lang.String content = reader.getElementText();

                            object.setServerType(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                                    content));
                         ...
                         if (reader.isStartElement() &&
                                new javax.xml.namespace.QName(
                                    "urn:hpccsystems:ws:wssmc", "NetworkAddress").equals(
                                    reader.getName())) {
                            nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance",
                                    "nil");
                            ...
                            if ("true".equals(nillableValue) ||
                                    "1".equals(nillableValue)) {
                                throw new org.apache.axis2.databinding.ADBException(
                                    "The element: " + "NetworkAddress" +
                                    "  cannot be null");
                            }

                            java.lang.String content = reader.getElementText();

                            object.setNetworkAddress(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                                    content));
                         ...
                         if (reader.isStartElement() &&
                                new javax.xml.namespace.QName(
                                    "urn:hpccsystems:ws:wssmc", "Port").equals(
                                    reader.getName())) {
                            nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance",
                                    "nil");
