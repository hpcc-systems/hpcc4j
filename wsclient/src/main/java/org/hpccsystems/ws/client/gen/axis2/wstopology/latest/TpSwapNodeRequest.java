...
/**
 *  TpSwapNodeRequest bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class TpSwapNodeRequest implements org.apache.axis2.databinding.ADBBean {
    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("urn:hpccsystems:ws:wstopology",
            "TpSwapNodeRequest", "ns3");
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":TpSwapNodeRequest", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "TpSwapNodeRequest", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static TpSwapNodeRequest parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            TpSwapNodeRequest object = new TpSwapNodeRequest();
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"TpSwapNodeRequest".equals(type)) {
                            ...
                            return (TpSwapNodeRequest) org.hpccsystems.ws.client.gen.axis2.wstopology.latest.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                while (!reader.isEndElement()) {
                    if (reader.isStartElement()) {
                        if (reader.isStartElement() &&
                         ...
                         if (reader.isStartElement() &&
                                new javax.xml.namespace.QName(
                                    "urn:hpccsystems:ws:wstopology", "NewIP").equals(
                                    reader.getName())) {
                            nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance",
                                    "nil");
                            ...
                            object.setNewIP(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                                    content));
