...
/**
 *  DfuMonitorResponse bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class DfuMonitorResponse implements org.apache.axis2.databinding.ADBBean {
    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("urn:hpccsystems:ws:filespray",
            "DfuMonitorResponse", "ns2");
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":DfuMonitorResponse", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "DfuMonitorResponse", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static DfuMonitorResponse parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            DfuMonitorResponse object = new DfuMonitorResponse();
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"DfuMonitorResponse".equals(type)) {
                            ...
                            return (DfuMonitorResponse) org.hpccsystems.ws.client.gen.axis2.filespray.v1_16.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
