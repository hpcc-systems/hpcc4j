...
public class QuerysetImportActivation implements org.apache.axis2.databinding.ADBBean {
  ...
  public static final javax.xml.namespace.QName MY_QNAME =
      new javax.xml.namespace.QName(
          "urn:hpccsystems:ws:wsworkunits", "QuerysetImportActivation", "ns13");
        ...
        while (!reader.isEndElement()) {
          if (reader.isStartElement() || reader.hasText()) {
            ...
            if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
              throw new org.apache.axis2.databinding.ADBException(
                  "The element: " + "QuerysetImportActivation" + "  cannot be null");
            }
            ...
            if (content.indexOf(":") > 0) {
              ...
              object = QuerysetImportActivation.Factory.fromString(content, namespaceuri);
            } else {
