...
public class WUGetDependancyTreesResponse implements org.apache.axis2.databinding.ADBBean {
    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("urn:hpccsystems:ws:wsworkunits",
            "WUGetDependancyTreesResponse", "ns8");
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":WUGetDependancyTreesResponse", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "WUGetDependancyTreesResponse", xmlWriter);
            }
        }
            ...
            if (localDependancyTrees != null) {
                try {
                    org.apache.axiom.util.stax.XMLStreamWriterUtils.writeDataHandler(xmlWriter,
                        localDependancyTrees, null, true);
                } catch (java.io.IOException ex) {
                    throw new javax.xml.stream.XMLStreamException("Unable to read data handler for DependancyTrees",
                        ex);
                }
            } else {
            }
    ...
    public static class Factory {
         ...
         */
        public static WUGetDependancyTreesResponse parse(
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"WUGetDependancyTreesResponse".equals(type)) {
                            ...
                            return (WUGetDependancyTreesResponse) org.hpccsystems.ws.client.gen.axis2.wsworkunits.v1_74.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                    ...
                    if (reader.isStartElement()) {
                        if (reader.isStartElement() &&
                         ...
                         if (reader.isStartElement() &&
                                new javax.xml.namespace.QName(
                                    "urn:hpccsystems:ws:wsworkunits",
                                    "DependancyTrees").equals(reader.getName())) {
                            object.setDependancyTrees(org.apache.axiom.util.stax.XMLStreamReaderUtils.getDataHandlerFromElement(
                                    reader));
