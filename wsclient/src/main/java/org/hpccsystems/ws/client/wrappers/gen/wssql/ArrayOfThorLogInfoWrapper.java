 ...
 * Wraps class: org.hpccsystems.ws.client.gen.axis2.wssql.latest.ArrayOfThorLogInfo
...
public class ArrayOfThorLogInfoWrapper
{
    ...
    public ArrayOfThorLogInfoWrapper( org.hpccsystems.ws.client.gen.axis2.wssql.latest.ArrayOfThorLogInfo arrayofthorloginfo)
    {
    ...
    private void copy( org.hpccsystems.ws.client.gen.axis2.wssql.latest.ArrayOfThorLogInfo raw )
    {
        if (raw == null)
            return;
    ...
    public org.hpccsystems.ws.client.gen.axis2.wssql.latest.ArrayOfThorLogInfo getRaw()
    {
        org.hpccsystems.ws.client.gen.axis2.wssql.latest.ArrayOfThorLogInfo raw = new org.hpccsystems.ws.client.gen.axis2.wssql.latest.ArrayOfThorLogInfo();
        if (this.local_thorLogInfo!= null)
        {
            org.hpccsystems.ws.client.gen.axis2.wssql.latest.ThorLogInfo[] arr = new org.hpccsystems.ws.client.gen.axis2.wssql.latest.ThorLogInfo[this.local_thorLogInfo.size()];
