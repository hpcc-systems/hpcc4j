...
public class BrowseResourcesResponseWrapper
{
    ...
    public BrowseResourcesResponseWrapper( ArrayOfEspExceptionWrapper _exceptions, String _portalURL, String _eSPInstance, String _netAddress, int _oS, boolean _useResource, ArrayOfHPCCResourceRepositoryWrapper _hPCCResourceRepositories )
    {
    ...
    {
        return "BrowseResourcesResponseWrapper [" + "exceptions = " + local_exceptions + ", " + "portalURL = " + local_portalURL + ", " + "eSPInstance = " + local_eSPInstance + ", " + "netAddress = " + local_netAddress + ", " + "oS = " + local_oS + ", " + "useResource = " + local_useResource + ", " + "hPCCResourceRepositories = " + local_hPCCResourceRepositories + "]";
    }
