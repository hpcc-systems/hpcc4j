 ...
 * Wraps class: org.hpccsystems.ws.client.gen.axis2.wsdfuxref.v1_01.DFULogicalFile
 * Output package : org.hpccsystems.ws.client.wrappers.gen.wsdfuxref
 * TimeStamp: 2021-01-20T21:52:27.243Z
 */
public class DFULogicalFileWrapper
{
	...
	private void copy( org.hpccsystems.ws.client.gen.axis2.wsdfuxref.v1_01.DFULogicalFile raw )
	{
		if (raw == null)
			return;
	...
	{
		return "DFULogicalFileWrapper [" + "prefix = " + local_prefix + ", " + "clusterName = " + local_clusterName + ", " + "directory = " + local_directory + ", " + "description = " + local_description + ", " + "parts = " + local_parts + ", " + "name = " + local_name + ", " + "owner = " + local_owner + ", " + "totalsize = " + local_totalsize + ", " + "recordCount = " + local_recordCount + ", " + "modified = " + local_modified + ", " + "longSize = " + local_longSize + ", " + "longRecordCount = " + local_longRecordCount + ", " + "isSuperfile = " + local_isSuperfile + ", " + "isZipfile = " + local_isZipfile + ", " + "isDirectory = " + local_isDirectory + ", " + "replicate = " + local_replicate + ", " + "intSize = " + local_intSize + ", " + "intRecordCount = " + local_intRecordCount + "]";
	}
	public org.hpccsystems.ws.client.gen.axis2.wsdfuxref.v1_01.DFULogicalFile getRaw()
	{
		org.hpccsystems.ws.client.gen.axis2.wsdfuxref.v1_01.DFULogicalFile raw = new org.hpccsystems.ws.client.gen.axis2.wsdfuxref.v1_01.DFULogicalFile();
