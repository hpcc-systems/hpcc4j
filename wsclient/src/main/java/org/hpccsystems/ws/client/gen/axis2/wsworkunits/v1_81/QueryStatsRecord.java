...
public class QueryStatsRecord implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":QueryStatsRecord", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
    ...
    public static class Factory {
         ...
         */
        public static QueryStatsRecord parse(
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"QueryStatsRecord".equals(type)) {
                            ...
                            return (QueryStatsRecord) org.hpccsystems.ws.client.gen.axis2.wsworkunits.v1_81.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                    ...
                    if (reader.isStartElement()) {
                        if (reader.isStartElement() &&
                         ...
                         if (reader.isStartElement() &&
                                new javax.xml.namespace.QName(
                                    "urn:hpccsystems:ws:wsworkunits",
                                    "ElapsedTimeMs").equals(reader.getName())) {
                            nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance",
                                    "nil");
                            ...
                            if ("true".equals(nillableValue) ||
                                    "1".equals(nillableValue)) {
                                throw new org.apache.axis2.databinding.ADBException(
                                    "The element: " + "ElapsedTimeMs" +
                                    "  cannot be null");
                            }

                            java.lang.String content = reader.getElementText();

                            object.setElapsedTimeMs(org.apache.axis2.databinding.utils.ConverterUtil.convertToLong(
                                    content));
                         ...
                         if (reader.isStartElement() &&
                            ...
                            object.setMemoryUsed(org.apache.axis2.databinding.utils.ConverterUtil.convertToLong(
                                    content));
                         ...
                         if (reader.isStartElement() &&
                                new javax.xml.namespace.QName(
                                    "urn:hpccsystems:ws:wsworkunits", "BytesOut").equals(
                                    reader.getName())) {
                            nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance",
                                    "nil");
                            ...
                            if ("true".equals(nillableValue) ||
                                    "1".equals(nillableValue)) {
                                throw new org.apache.axis2.databinding.ADBException(
                                    "The element: " + "BytesOut" +
                                    "  cannot be null");
                            }

                            java.lang.String content = reader.getElementText();

                            object.setBytesOut(org.apache.axis2.databinding.utils.ConverterUtil.convertToLong(
                                    content));
                         ...
                         if (reader.isStartElement() &&
                                new javax.xml.namespace.QName(
                                    "urn:hpccsystems:ws:wsworkunits",
                                    "SlavesReplyLen").equals(reader.getName())) {
                            nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance",
                                    "nil");
                            ...
                            if ("true".equals(nillableValue) ||
                                    "1".equals(nillableValue)) {
                                throw new org.apache.axis2.databinding.ADBException(
                                    "The element: " + "SlavesReplyLen" +
                                    "  cannot be null");
                            }

                            java.lang.String content = reader.getElementText();

                            object.setSlavesReplyLen(org.apache.axis2.databinding.utils.ConverterUtil.convertToInt(
                                    content));
