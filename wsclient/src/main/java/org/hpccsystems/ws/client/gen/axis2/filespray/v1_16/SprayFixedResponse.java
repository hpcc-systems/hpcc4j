...
/**
 *  SprayFixedResponse bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class SprayFixedResponse implements org.apache.axis2.databinding.ADBBean {
    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("urn:hpccsystems:ws:filespray",
            "SprayFixedResponse", "ns2");
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":SprayFixedResponse", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "SprayFixedResponse", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static SprayFixedResponse parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            SprayFixedResponse object = new SprayFixedResponse();
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"SprayFixedResponse".equals(type)) {
                            ...
                            return (SprayFixedResponse) org.hpccsystems.ws.client.gen.axis2.filespray.v1_16.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
