...
public class LockWrapper
{
    ...
    public LockWrapper( org.hpccsystems.ws.client.gen.axis2.wssmc.latest.Lock lock)
    {
        copy( lock );
    }
    ...
    private void copy( org.hpccsystems.ws.client.gen.axis2.wssmc.latest.Lock raw )
    {
        if (raw == null)
            return;
    ...
    public org.hpccsystems.ws.client.gen.axis2.wssmc.latest.Lock getRaw()
    {
        org.hpccsystems.ws.client.gen.axis2.wssmc.latest.Lock raw = new org.hpccsystems.ws.client.gen.axis2.wssmc.latest.Lock();
