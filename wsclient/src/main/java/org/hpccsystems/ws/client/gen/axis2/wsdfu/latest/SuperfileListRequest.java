...
/**
 *  SuperfileListRequest bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class SuperfileListRequest implements org.apache.axis2.databinding.ADBBean {
    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("urn:hpccsystems:ws:wsdfu",
            "SuperfileListRequest", "ns1");
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":SuperfileListRequest", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "SuperfileListRequest", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static SuperfileListRequest parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            SuperfileListRequest object = new SuperfileListRequest();
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"SuperfileListRequest".equals(type)) {
                            ...
                            return (SuperfileListRequest) org.hpccsystems.ws.client.gen.axis2.wsdfu.latest.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
