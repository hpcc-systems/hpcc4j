...
/**
 *  AbortDFUWorkunit bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class AbortDFUWorkunit implements org.apache.axis2.databinding.ADBBean {
    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("urn:hpccsystems:ws:filespray",
            "AbortDFUWorkunit", "ns1");
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":AbortDFUWorkunit", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "AbortDFUWorkunit", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static AbortDFUWorkunit parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            AbortDFUWorkunit object = new AbortDFUWorkunit();
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"AbortDFUWorkunit".equals(type)) {
                            ...
                            return (AbortDFUWorkunit) org.hpccsystems.ws.client.gen.axis2.filespray.latest.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
