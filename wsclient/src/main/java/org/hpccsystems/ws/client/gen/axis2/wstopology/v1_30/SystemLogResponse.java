...
/**
 *  SystemLogResponse bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class SystemLogResponse implements org.apache.axis2.databinding.ADBBean {
    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("urn:hpccsystems:ws:wstopology",
            "SystemLogResponse", "ns5");
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":SystemLogResponse", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "SystemLogResponse", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static SystemLogResponse parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            SystemLogResponse object = new SystemLogResponse();
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"SystemLogResponse".equals(type)) {
                            ...
                            return (SystemLogResponse) org.hpccsystems.ws.client.gen.axis2.wstopology.v1_30.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
