...
public class EraseHistoryResponse implements org.apache.axis2.databinding.ADBBean {
  ...
  public static final javax.xml.namespace.QName MY_QNAME =
      new javax.xml.namespace.QName("urn:hpccsystems:ws:wsdfu", "EraseHistoryResponse", "ns1");
   ...
   * @param param History
   */
  public void setHistory(org.hpccsystems.ws.client.gen.axis2.wsdfu.latest.History_type1 param) {
  ...
  public void serialize(
    ...
    if (serializeType) {
      ...
      if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
        writeAttribute(
            ...
            "type",
            namespacePrefix + ":EraseHistoryResponse",
            xmlWriter);
      } else {
        writeAttribute(
            "xsi",
    ...
    if (localHistoryTracker) {
      if (localHistory == null) {
        throw new org.apache.axis2.databinding.ADBException("History cannot be null!!");
      }
      localHistory.serialize(
          new javax.xml.namespace.QName("urn:hpccsystems:ws:wsdfu", "History"), xmlWriter);
    }
  ...
  public static class Factory {
     ...
     */
    public static EraseHistoryResponse parse(javax.xml.stream.XMLStreamReader reader)
          ...
          if (reader.isStartElement()) {
            ...
            if (reader.isStartElement()
              ...
              reader.next();
                ...
                && new javax.xml.namespace.QName("urn:hpccsystems:ws:wsdfu", "History")
                    .equals(reader.getName())) {

              object.setHistory(
                  org.hpccsystems.ws.client.gen.axis2.wsdfu.latest.History_type1.Factory.parse(
                      reader));
