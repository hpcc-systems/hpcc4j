...
/**
 *  TpMachineQueryRequest bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class TpMachineQueryRequest implements org.apache.axis2.databinding.ADBBean {
    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("urn:hpccsystems:ws:wstopology",
            "TpMachineQueryRequest", "ns3");
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":TpMachineQueryRequest", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "TpMachineQueryRequest", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static TpMachineQueryRequest parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            TpMachineQueryRequest object = new TpMachineQueryRequest();
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"TpMachineQueryRequest".equals(type)) {
                            ...
                            return (TpMachineQueryRequest) org.hpccsystems.ws.client.gen.axis2.wstopology.latest.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
