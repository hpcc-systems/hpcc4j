 ...
 * Wraps class: org.hpccsystems.ws.client.gen.axis2.wspackageprocess.latest.EspException
 * Output package : org.hpccsystems.ws.client.wrappers.gen.wspackageprocess
 * TimeStamp: 2022-07-25T17:42:18.155Z
 */
public class EspExceptionWrapper
{
    ...
    public EspExceptionWrapper( org.hpccsystems.ws.client.gen.axis2.wspackageprocess.latest.EspException espexception)
    {
        copy( espexception );
    }
    ...
    private void copy( org.hpccsystems.ws.client.gen.axis2.wspackageprocess.latest.EspException raw )
    {
        if (raw == null)
            return;
    ...
    public org.hpccsystems.ws.client.gen.axis2.wspackageprocess.latest.EspException getRaw()
    {
        org.hpccsystems.ws.client.gen.axis2.wspackageprocess.latest.EspException raw = new org.hpccsystems.ws.client.gen.axis2.wspackageprocess.latest.EspException();
