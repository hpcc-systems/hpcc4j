...
/**
 *  ListPackagesRequest bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class ListPackagesRequest implements org.apache.axis2.databinding.ADBBean {
    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("urn:hpccsystems:ws:wspackageprocess",
            "ListPackagesRequest", "ns7");
    ...
    /**
     * field for ProcessFilter
     */
    protected java.lang.String localProcessFilter;

    /*  This tracker boolean wil be used to detect whether the user called the set method
     *   for this attribute. It will be used to determine whether to include this field
     *   in the serialized XML
     */
    protected boolean localProcessFilterTracker = false;
    ...
    public boolean isProcessFilterSpecified() {
        return localProcessFilterTracker;
    }
    ...
    public java.lang.String getProcessFilter() {
        return localProcessFilter;
    }

    /**
     * Auto generated setter method
     * @param param ProcessFilter
     */
    public void setProcessFilter(java.lang.String param) {
        localProcessFilterTracker = param != null;

        this.localProcessFilter = param;
    }
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":ListPackagesRequest", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "ListPackagesRequest", xmlWriter);
            }
        }
        ...
        if (localProcessFilterTracker) {
            namespace = "urn:hpccsystems:ws:wspackageprocess";
            writeStartElement(null, namespace, "ProcessFilter", xmlWriter);

            if (localProcessFilter == null) {
                // write the nil attribute
                throw new org.apache.axis2.databinding.ADBException(
                    "ProcessFilter cannot be null!!");
            } else {
                xmlWriter.writeCharacters(localProcessFilter);
            }
    ...
    public static class Factory {
         ...
         */
        public static ListPackagesRequest parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            ListPackagesRequest object = new ListPackagesRequest();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"ListPackagesRequest".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (ListPackagesRequest) org.hpccsystems.ws.client.gen.axis2.wspackageprocess.latest.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                    ...
                    if (reader.isStartElement()) {
                        if (reader.isStartElement() &&
                         ...
                         if (reader.isStartElement() &&
                                new javax.xml.namespace.QName(
                                    "urn:hpccsystems:ws:wspackageprocess",
                                    "ProcessFilter").equals(reader.getName())) {
                            nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance",
                                    "nil");
                            ...
                            if ("true".equals(nillableValue) ||
                                    "1".equals(nillableValue)) {
                                throw new org.apache.axis2.databinding.ADBException(
                                    "The element: " + "ProcessFilter" +
                                    "  cannot be null");
                            }

                            java.lang.String content = reader.getElementText();

                            object.setProcessFilter(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                                    content));
