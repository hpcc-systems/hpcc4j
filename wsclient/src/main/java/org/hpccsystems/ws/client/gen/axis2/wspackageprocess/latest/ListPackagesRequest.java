...
public class ListPackagesRequest implements org.apache.axis2.databinding.ADBBean {
  ...
  public static final javax.xml.namespace.QName MY_QNAME =
      new javax.xml.namespace.QName(
          "urn:hpccsystems:ws:wspackageprocess", "ListPackagesRequest", "ns1");
  ...
  public void serialize(
    ...
    if (serializeType) {
      ...
      if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
        writeAttribute(
            ...
            "type",
            namespacePrefix + ":ListPackagesRequest",
            xmlWriter);
      } else {
        writeAttribute(
            "xsi",
    ...
    if (localProcessFilterTracker) {
      ...
      if (localProcessFilter == null) {
        ...
        throw new org.apache.axis2.databinding.ADBException("ProcessFilter cannot be null!!");
  ...
  public static class Factory {
     ...
     */
    public static ListPackagesRequest parse(javax.xml.stream.XMLStreamReader reader)
          ...
          if (reader.isStartElement()) {
            ...
            if (reader.isStartElement()
              ...
              reader.next();
                ...
                && new javax.xml.namespace.QName(
                        "urn:hpccsystems:ws:wspackageprocess", "ProcessFilter")
                    .equals(reader.getName())) {
              ...
              if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
                throw new org.apache.axis2.databinding.ADBException(
                    "The element: " + "ProcessFilter" + "  cannot be null");
              }

              java.lang.String content = reader.getElementText();

              object.setProcessFilter(
                  org.apache.axis2.databinding.utils.ConverterUtil.convertToString(content));
