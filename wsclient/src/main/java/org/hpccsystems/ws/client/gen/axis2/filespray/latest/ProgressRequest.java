...
/**
 *  ProgressRequest bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class ProgressRequest implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":ProgressRequest", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "ProgressRequest", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static ProgressRequest parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            ProgressRequest object = new ProgressRequest();
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"ProgressRequest".equals(type)) {
                            ...
                            return (ProgressRequest) org.hpccsystems.ws.client.gen.axis2.filespray.latest.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
