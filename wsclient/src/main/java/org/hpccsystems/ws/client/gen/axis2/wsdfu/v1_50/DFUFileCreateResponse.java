...
public class DFUFileCreateResponse implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":DFUFileCreateResponse", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "DFUFileCreateResponse", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static DFUFileCreateResponse parse(
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"DFUFileCreateResponse".equals(type)) {
                            ...
                            return (DFUFileCreateResponse) org.hpccsystems.ws.client.gen.axis2.wsdfu.v1_50.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                while (!reader.isEndElement()) {
                    if (reader.isStartElement()) {
                        if (reader.isStartElement() &&
                         ...
                         if (reader.isStartElement() &&
                                new javax.xml.namespace.QName(
                                    "urn:hpccsystems:ws:wsdfu", "FileId").equals(
                                    reader.getName())) {
                            ...
                            object.setFileId(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                                    content));
