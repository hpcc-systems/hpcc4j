...
/**
 *  ClusterNames_type0 bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class ClusterNames_type0 implements org.apache.axis2.databinding.ADBBean {
    ...
    public void addClusterName(java.lang.String param) {
        ...
        java.util.List list = org.apache.axis2.databinding.utils.ConverterUtil.toList(localClusterName);
        list.add(param);
        this.localClusterName = (java.lang.String[]) list.toArray(new java.lang.String[list.size()]);
    }
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":ClusterNames_type0", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "ClusterNames_type0", xmlWriter);
            }
        }
            ...
            if (localClusterName != null) {
                ...
                for (int i = 0; i < localClusterName.length; i++) {
                    if (localClusterName[i] != null) {
                        writeStartElement(null, namespace, "ClusterName",
                            xmlWriter);
    ...
    public static class Factory {
         ...
         */
        public static ClusterNames_type0 parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            ClusterNames_type0 object = new ClusterNames_type0();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"ClusterNames_type0".equals(type)) {
                            ...
                            return (ClusterNames_type0) org.hpccsystems.ws.client.gen.axis2.filespray.latest.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName(
                            "urn:hpccsystems:ws:filespray", "ClusterName").equals(
                            reader.getName())) {
                    ...
                    object.setClusterName((java.lang.String[]) list1.toArray(
