...
public class ArrayOfEspException implements org.apache.axis2.databinding.ADBBean {
  ...
  */
  ...
  public void addException(
    ...
    list.add(param);
    this.localException =
        (org.hpccsystems.ws.client.gen.axis2.wsworkunits.v1_56.EspException[])
            list.toArray(
                new org.hpccsystems.ws.client.gen.axis2.wsworkunits.v1_56.EspException
                    [list.size()]);
  }
    ...
    public static ArrayOfEspException parse(javax.xml.stream.XMLStreamReader reader)
      ...
      try {
        ...
        if (reader.isStartElement()
          ...
          list2.add(
              org.hpccsystems.ws.client.gen.axis2.wsworkunits.v1_56.EspException.Factory.parse(
                  reader));
          ...
          while (!loopDone2) {
            ...
            if (reader.isEndElement()) {
              ...
              if (new javax.xml.namespace.QName("urn:hpccsystems:ws:wsworkunits", "Exception")
                  .equals(reader.getName())) {
                list2.add(
                    org.hpccsystems.ws.client.gen.axis2.wsworkunits.v1_56.EspException.Factory
                        .parse(reader));
