...
/**
 *  GetDFUExceptions bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class GetDFUExceptions implements org.apache.axis2.databinding.ADBBean {
    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("urn:hpccsystems:ws:filespray",
            "GetDFUExceptions", "ns1");
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":GetDFUExceptions", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "GetDFUExceptions", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static GetDFUExceptions parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            GetDFUExceptions object = new GetDFUExceptions();
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"GetDFUExceptions".equals(type)) {
                            ...
                            return (GetDFUExceptions) org.hpccsystems.ws.client.gen.axis2.filespray.latest.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
