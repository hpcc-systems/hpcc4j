...
/**
 *  RemoveJob bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class RemoveJob implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":RemoveJob", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "RemoveJob", xmlWriter);
    ...
    public static class Factory {
         ...
         */
        public static RemoveJob parse(javax.xml.stream.XMLStreamReader reader)
            throws java.lang.Exception {
            RemoveJob object = new RemoveJob();
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"RemoveJob".equals(type)) {
                            ...
                            return (RemoveJob) org.hpccsystems.ws.client.gen.axis2.wssmc.latest.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
