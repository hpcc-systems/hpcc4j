...
public class GetBuildInfoResponse implements org.apache.axis2.databinding.ADBBean {
  ...
  public static final javax.xml.namespace.QName MY_QNAME =
      new javax.xml.namespace.QName("urn:hpccsystems:ws:wssmc", "GetBuildInfoResponse", "ns9");
  ...
  public void serialize(
    ...
    if (serializeType) {
      ...
      if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
        writeAttribute(
            ...
            "type",
            namespacePrefix + ":GetBuildInfoResponse",
            xmlWriter);
      } else {
        writeAttribute(
            "xsi",
    ...
    if (localBuildInfoTracker) {
      if (localBuildInfo == null) {
        throw new org.apache.axis2.databinding.ADBException("BuildInfo cannot be null!!");
      }
      localBuildInfo.serialize(
          new javax.xml.namespace.QName("urn:hpccsystems:ws:wssmc", "BuildInfo"), xmlWriter);
    }
  ...
  public static class Factory {
     ...
     */
    public static GetBuildInfoResponse parse(javax.xml.stream.XMLStreamReader reader)
          ...
          if (reader.isStartElement()) {
            ...
            if (reader.isStartElement()
              ...
              reader.next();
                ...
                && new javax.xml.namespace.QName("urn:hpccsystems:ws:wssmc", "BuildInfo")
                    .equals(reader.getName())) {

              object.setBuildInfo(
                  org.hpccsystems.ws.client.gen.axis2.wssmc.latest.ArrayOfNamedValue.Factory.parse(
                      reader));
