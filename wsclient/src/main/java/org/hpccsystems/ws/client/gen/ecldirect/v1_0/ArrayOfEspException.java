...
public class ArrayOfEspException  extends org.apache.axis.AxisFault  implements java.io.Serializable {
    ...
    private org.hpccsystems.ws.client.gen.ecldirect.v1_0.EspException[] exception;
    ...
    public ArrayOfEspException(
           ...
           org.hpccsystems.ws.client.gen.ecldirect.v1_0.EspException[] exception) {
        this.source = source;
     ...
     * @return exception
     */
    public org.hpccsystems.ws.client.gen.ecldirect.v1_0.EspException[] getException() {
        return exception;
    }
     ...
     * @param exception
     */
    public void setException(org.hpccsystems.ws.client.gen.ecldirect.v1_0.EspException[] exception) {
        this.exception = exception;
    }

    public org.hpccsystems.ws.client.gen.ecldirect.v1_0.EspException getException(int i) {
        return this.exception[i];
    }

    public void setException(int i, org.hpccsystems.ws.client.gen.ecldirect.v1_0.EspException _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:hpccsystems:ws:ecldirect", "ArrayOfEspException"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:hpccsystems:ws:ecldirect", "Exception"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:hpccsystems:ws:ecldirect", "EspException"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
