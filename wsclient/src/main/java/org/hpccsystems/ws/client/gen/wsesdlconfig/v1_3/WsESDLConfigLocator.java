...
public class WsESDLConfigLocator extends org.apache.axis.client.Service implements org.hpccsystems.ws.client.gen.wsesdlconfig.v1_3.WsESDLConfig {
    ...
    public org.hpccsystems.ws.client.gen.wsesdlconfig.v1_3.WsESDLConfigServiceSoap getWsESDLConfigServiceSoap() throws javax.xml.rpc.ServiceException {
    ...
    public org.hpccsystems.ws.client.gen.wsesdlconfig.v1_3.WsESDLConfigServiceSoap getWsESDLConfigServiceSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            org.hpccsystems.ws.client.gen.wsesdlconfig.v1_3.WsESDLConfigServiceSoapStub _stub = new org.hpccsystems.ws.client.gen.wsesdlconfig.v1_3.WsESDLConfigServiceSoapStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (org.hpccsystems.ws.client.gen.wsesdlconfig.v1_3.WsESDLConfigServiceSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                org.hpccsystems.ws.client.gen.wsesdlconfig.v1_3.WsESDLConfigServiceSoapStub _stub = new org.hpccsystems.ws.client.gen.wsesdlconfig.v1_3.WsESDLConfigServiceSoapStub(new java.net.URL(WsESDLConfigServiceSoap_address), this);
                _stub.setPortName(getWsESDLConfigServiceSoapWSDDServiceName());
                return _stub;
            }
        }
