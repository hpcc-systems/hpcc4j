...
/**
 *  TpGetComponentFileResponse bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class TpGetComponentFileResponse implements org.apache.axis2.databinding.ADBBean {
    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("urn:hpccsystems:ws:wstopology",
            "TpGetComponentFileResponse", "ns5");
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":TpGetComponentFileResponse", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "TpGetComponentFileResponse", xmlWriter);
            }
        }
            ...
            if (localFileContents != null) {
                try {
                    org.apache.axiom.util.stax.XMLStreamWriterUtils.writeDataHandler(xmlWriter,
                        localFileContents, null, true);
                } catch (java.io.IOException ex) {
                    throw new javax.xml.stream.XMLStreamException("Unable to read data handler for FileContents",
                        ex);
                }
            } else {
            }
    ...
    public static class Factory {
         ...
         */
        public static TpGetComponentFileResponse parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            TpGetComponentFileResponse object = new TpGetComponentFileResponse();
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"TpGetComponentFileResponse".equals(type)) {
                            ...
                            return (TpGetComponentFileResponse) org.hpccsystems.ws.client.gen.axis2.wstopology.v1_30.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                    ...
                    if (reader.isStartElement()) {
                        if (reader.isStartElement() &&
                         ...
                         if (reader.isStartElement() &&
                                new javax.xml.namespace.QName(
                                    "urn:hpccsystems:ws:wstopology",
                                    "FileContents").equals(reader.getName())) {
                            object.setFileContents(org.apache.axiom.util.stax.XMLStreamReaderUtils.getDataHandlerFromElement(
                                    reader));
