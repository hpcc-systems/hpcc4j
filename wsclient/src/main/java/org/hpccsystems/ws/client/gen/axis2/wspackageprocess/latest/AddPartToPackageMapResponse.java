...
public class AddPartToPackageMapResponse implements org.apache.axis2.databinding.ADBBean {
  ...
  public static final javax.xml.namespace.QName MY_QNAME =
      new javax.xml.namespace.QName(
          "urn:hpccsystems:ws:wspackageprocess", "AddPartToPackageMapResponse", "ns1");
  ...
  protected org.hpccsystems.ws.client.gen.axis2.wspackageprocess.latest.FilesNotFound_type1
      localFilesNotFound;
   ...
   * Auto generated getter method
   *
   * @return org.hpccsystems.ws.client.gen.axis2.wspackageprocess.latest.FilesNotFound_type1
   */
  public org.hpccsystems.ws.client.gen.axis2.wspackageprocess.latest.FilesNotFound_type1
      getFilesNotFound() {
  ...
  public void serialize(
    ...
    if (serializeType) {
      ...
      if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
        writeAttribute(
            ...
            "type",
            namespacePrefix + ":AddPartToPackageMapResponse",
            xmlWriter);
      } else {
        writeAttribute(
            "xsi",
    ...
    if (localFilesNotFoundTracker) {
      if (localFilesNotFound == null) {
        throw new org.apache.axis2.databinding.ADBException("FilesNotFound cannot be null!!");
      }
      localFilesNotFound.serialize(
          new javax.xml.namespace.QName("urn:hpccsystems:ws:wspackageprocess", "FilesNotFound"),
          xmlWriter);
    }
  ...
  public static class Factory {
     ...
     */
    public static AddPartToPackageMapResponse parse(javax.xml.stream.XMLStreamReader reader)
        ...
        while (!reader.isEndElement()) {
          if (reader.isStartElement()) {
            ...
            if (reader.isStartElement()
              ...
              object.setFilesNotFound(
                  org.hpccsystems.ws.client.gen.axis2.wspackageprocess.latest.FilesNotFound_type1
                      .Factory.parse(reader));
              ...
              reader.next();
                ...
                && new javax.xml.namespace.QName(
                        "urn:hpccsystems:ws:wspackageprocess", "DfuPublisherState")
                    .equals(reader.getName())) {
