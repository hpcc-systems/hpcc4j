 ...
 * Wraps class: org.hpccsystems.ws.client.gen.axis2.filespray.latest.Rename
 * Output package : org.hpccsystems.ws.client.wrappers.gen.filespray
 * TimeStamp: 2021-10-27T18:52:06.495Z
 */
public class RenameWrapper
{
    ...
    public RenameWrapper( org.hpccsystems.ws.client.gen.axis2.filespray.latest.Rename rename)
    {
        copy( rename );
    }
    ...
    private void copy( org.hpccsystems.ws.client.gen.axis2.filespray.latest.Rename raw )
    {
        if (raw == null)
            return;
    ...
    public org.hpccsystems.ws.client.gen.axis2.filespray.latest.Rename getRaw()
    {
        org.hpccsystems.ws.client.gen.axis2.filespray.latest.Rename raw = new org.hpccsystems.ws.client.gen.axis2.filespray.latest.Rename();
