...
public class AttributeType implements org.apache.axis2.databinding.ADBBean {
  ...
  */
    ...
    if (serializeType) {
      ...
      if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
        writeAttribute(
            ...
            "type",
            namespacePrefix + ":AttributeType",
            xmlWriter);
      } else {
        writeAttribute(
            "xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "AttributeType", xmlWriter);
      }
    }
    if (localIDTracker) {
  ...
  public static class Factory {
     ...
     */
    public static AttributeType parse(javax.xml.stream.XMLStreamReader reader)
      ...
      try {
        ...
        while (!reader.isEndElement()) {
          if (reader.isStartElement()) {
            ...
            if (reader.isStartElement()
                && new javax.xml.namespace.QName("urn:hpccsystems:ws:wsattributes", "ID")
