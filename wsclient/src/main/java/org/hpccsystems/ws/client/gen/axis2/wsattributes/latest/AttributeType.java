...
public class AttributeType implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":AttributeType", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "AttributeType", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static AttributeType parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            AttributeType object = new AttributeType();
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"AttributeType".equals(type)) {
                            ...
                            return (AttributeType) org.hpccsystems.ws.client.gen.axis2.wsattributes.latest.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                    ...
                    if (reader.isStartElement()) {
                        if (reader.isStartElement() &&
                                new javax.xml.namespace.QName(
                                    "urn:hpccsystems:ws:wsattributes", "ID").equals(
                                    reader.getName())) {
