 ...
 * Class name: Files_type3Wrapper
 * Wraps class: org.hpccsystems.ws.client.gen.axis2.wsworkunits.latest.Files_type3
...
public class Files_type3Wrapper
{
    ...
    public Files_type3Wrapper( org.hpccsystems.ws.client.gen.axis2.wsworkunits.latest.Files_type3 files_type3)
    {
        copy( files_type3 );
    }
    public Files_type3Wrapper( List<FileUsedByQueryWrapper> _file )
    {
        this.local_file = _file;

    }

    private void copy( org.hpccsystems.ws.client.gen.axis2.wsworkunits.latest.Files_type3 raw )
    {
        if (raw == null)
            return;
    ...
    {
        return "Files_type3Wrapper [" + "file = " + local_file + "]";
    }
    public org.hpccsystems.ws.client.gen.axis2.wsworkunits.latest.Files_type3 getRaw()
    {
        org.hpccsystems.ws.client.gen.axis2.wsworkunits.latest.Files_type3 raw = new org.hpccsystems.ws.client.gen.axis2.wsworkunits.latest.Files_type3();
