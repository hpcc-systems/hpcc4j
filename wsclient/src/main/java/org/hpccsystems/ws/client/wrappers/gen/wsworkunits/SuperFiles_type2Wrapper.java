 ...
 * Class name: SuperFiles_type2Wrapper
 * Wraps class: org.hpccsystems.ws.client.gen.axis2.wsworkunits.latest.SuperFiles_type2
 * Output package : org.hpccsystems.ws.client.wrappers.gen.wsworkunits
 * TimeStamp: 2022-07-22T20:33:16.869Z
 */
public class SuperFiles_type2Wrapper
{
    ...
    public SuperFiles_type2Wrapper( org.hpccsystems.ws.client.gen.axis2.wsworkunits.latest.SuperFiles_type2 superfiles_type2)
    {
        copy( superfiles_type2 );
    }
    public SuperFiles_type2Wrapper( List<QuerySuperFileWrapper> _superFile )
    {
        this.local_superFile = _superFile;

    }

    private void copy( org.hpccsystems.ws.client.gen.axis2.wsworkunits.latest.SuperFiles_type2 raw )
    {
        if (raw == null)
            return;
    ...
    {
        return "SuperFiles_type2Wrapper [" + "superFile = " + local_superFile + "]";
    }
    public org.hpccsystems.ws.client.gen.axis2.wsworkunits.latest.SuperFiles_type2 getRaw()
    {
        org.hpccsystems.ws.client.gen.axis2.wsworkunits.latest.SuperFiles_type2 raw = new org.hpccsystems.ws.client.gen.axis2.wsworkunits.latest.SuperFiles_type2();
