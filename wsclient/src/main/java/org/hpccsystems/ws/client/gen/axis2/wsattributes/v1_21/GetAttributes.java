...
/**
 *  GetAttributes bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class GetAttributes implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":GetAttributes", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "GetAttributes", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static GetAttributes parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            GetAttributes object = new GetAttributes();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"GetAttributes".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (GetAttributes) org.hpccsystems.ws.client.gen.axis2.wsattributes.v1_21.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
