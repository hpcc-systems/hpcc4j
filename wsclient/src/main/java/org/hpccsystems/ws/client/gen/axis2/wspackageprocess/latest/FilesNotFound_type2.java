...
/**
 *  FilesNotFound_type2 bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class FilesNotFound_type2 implements org.apache.axis2.databinding.ADBBean {
    /* This type was generated from the piece of schema that had
       name = FilesNotFound_type2
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":FilesNotFound_type2", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "FilesNotFound_type2", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static FilesNotFound_type2 parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            FilesNotFound_type2 object = new FilesNotFound_type2();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"FilesNotFound_type2".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (FilesNotFound_type2) org.hpccsystems.ws.client.gen.axis2.wspackageprocess.latest.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName(
                            "urn:hpccsystems:ws:wspackageprocess", "File").equals(
                            reader.getName())) {
                    ...
                    object.setFile((java.lang.String[]) list1.toArray(
