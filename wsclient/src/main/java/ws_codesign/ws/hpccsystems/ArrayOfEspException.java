...
public class ArrayOfEspException implements org.apache.axis2.databinding.ADBBean {
  ...
  */
  ...
  protected ws_codesign.ws.hpccsystems.EspException[] localException;
   ...
   * Auto generated getter method
   *
   * @return ws_codesign.ws.hpccsystems.EspException[]
   */
  public ws_codesign.ws.hpccsystems.EspException[] getException() {
    return localException;
  }

  /** validate the array for Exception */
  protected void validateException(ws_codesign.ws.hpccsystems.EspException[] param) {}
   ...
   */
  public void setException(ws_codesign.ws.hpccsystems.EspException[] param) {
   ...
   *
   * @param param ws_codesign.ws.hpccsystems.EspException
   */
  public void addException(ws_codesign.ws.hpccsystems.EspException param) {
    if (localException == null) {
      localException = new ws_codesign.ws.hpccsystems.EspException[] {};
    }
    ...
    list.add(param);
    this.localException =
        (ws_codesign.ws.hpccsystems.EspException[])
            list.toArray(new ws_codesign.ws.hpccsystems.EspException[list.size()]);
  }
    ...
    public static ArrayOfEspException parse(javax.xml.stream.XMLStreamReader reader)
      ...
      try {
        ...
        if (reader.isStartElement()
          ...
          list2.add(ws_codesign.ws.hpccsystems.EspException.Factory.parse(reader));
          ...
          object.setException(
              (ws_codesign.ws.hpccsystems.EspException[])
                  org.apache.axis2.databinding.utils.ConverterUtil.convertToArray(
                      ws_codesign.ws.hpccsystems.EspException.class, list2));
