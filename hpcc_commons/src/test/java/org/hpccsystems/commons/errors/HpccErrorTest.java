...
public class HpccErrorTest {
    ...
    public void testHpccError() throws Exception 
    {
        ...
        //output error
        System.out.println(err.toECLErrorString());
    ...
    public void testHpccErrorBlock() throws Exception 
    {
        ...
        System.out.println(eb.toECLErrorString());
        System.out.println(eb.toString());
        System.out.println(eb.toMessageString());
        System.out.println(eb.toHtmlErrorString());
