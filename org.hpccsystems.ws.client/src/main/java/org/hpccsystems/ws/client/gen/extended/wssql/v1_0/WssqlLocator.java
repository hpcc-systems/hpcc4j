...
public class WssqlLocator extends org.apache.axis.client.Service implements org.hpccsystems.ws.client.gen.extended.wssql.v1_0.Wssql {
    ...
    public org.hpccsystems.ws.client.gen.extended.wssql.v1_0.WssqlServiceSoap getwssqlServiceSoap() throws javax.xml.rpc.ServiceException {
    ...
    public org.hpccsystems.ws.client.gen.extended.wssql.v1_0.WssqlServiceSoap getwssqlServiceSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            org.hpccsystems.ws.client.gen.extended.wssql.v1_0.WssqlServiceSoapStub _stub = new org.hpccsystems.ws.client.gen.extended.wssql.v1_0.WssqlServiceSoapStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (org.hpccsystems.ws.client.gen.extended.wssql.v1_0.WssqlServiceSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                org.hpccsystems.ws.client.gen.extended.wssql.v1_0.WssqlServiceSoapStub _stub = new org.hpccsystems.ws.client.gen.extended.wssql.v1_0.WssqlServiceSoapStub(new java.net.URL(wssqlServiceSoap_address), this);
                _stub.setPortName(getwssqlServiceSoapWSDDServiceName());
                return _stub;
            }
        }
