...
public class GetDFUExceptionsResponse  implements java.io.Serializable {
    ...
    private org.hpccsystems.ws.client.soap.filespray.DFUException[] result;
    ...
    public GetDFUExceptionsResponse(
           ...
           org.hpccsystems.ws.client.soap.filespray.DFUException[] result) {
     ...
     * @return result
     */
    public org.hpccsystems.ws.client.soap.filespray.DFUException[] getResult() {
        return result;
    }
     ...
     * @param result
     */
    public void setResult(org.hpccsystems.ws.client.soap.filespray.DFUException[] result) {
        this.result = result;
    }
