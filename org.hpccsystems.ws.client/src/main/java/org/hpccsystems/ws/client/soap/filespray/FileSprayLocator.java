...
public class FileSprayLocator extends org.apache.axis.client.Service implements org.hpccsystems.ws.client.soap.filespray.FileSpray {
    ...
    public org.hpccsystems.ws.client.soap.filespray.FileSprayServiceSoap getFileSprayServiceSoap() throws javax.xml.rpc.ServiceException {
    ...
    public org.hpccsystems.ws.client.soap.filespray.FileSprayServiceSoap getFileSprayServiceSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            org.hpccsystems.ws.client.soap.filespray.FileSprayServiceSoapStub _stub = new org.hpccsystems.ws.client.soap.filespray.FileSprayServiceSoapStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (org.hpccsystems.ws.client.soap.filespray.FileSprayServiceSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                org.hpccsystems.ws.client.soap.filespray.FileSprayServiceSoapStub _stub = new org.hpccsystems.ws.client.soap.filespray.FileSprayServiceSoapStub(new java.net.URL(FileSprayServiceSoap_address), this);
                _stub.setPortName(getFileSprayServiceSoapWSDDServiceName());
                return _stub;
            }
        }
