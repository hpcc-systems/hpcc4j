...
public class EclDirectServiceSoapStub extends org.apache.axis.client.Stub implements org.hpccsystems.ws.client.soap.ecldirect.EclDirectServiceSoap {
    ...
    private static void _initOperationDesc1(){
        ...
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("urn:hpccsystems:ws:ecldirect", "RunEclExRequest"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("urn:hpccsystems:ws:ecldirect", ">RunEclExRequest"), org.hpccsystems.ws.client.soap.ecldirect.RunEclExRequest.class, false, false);
        oper.addParameter(param);
        oper.setReturnType(new javax.xml.namespace.QName("urn:hpccsystems:ws:ecldirect", ">RunEclExResponse"));
        oper.setReturnClass(org.hpccsystems.ws.client.soap.ecldirect.RunEclExResponse.class);
        ...
        oper.addFault(new org.apache.axis.description.FaultDesc(
                      ...
                      "org.hpccsystems.ws.client.soap.ecldirect.ArrayOfEspException",
    ...
    public EclDirectServiceSoapStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        ...
        ((org.apache.axis.client.Service)super.service).setTypeMappingVersion("1.2");
            ...
            cls = org.hpccsystems.ws.client.soap.ecldirect.RunEclExRequest.class;
            ...
            cachedSerQNames.add(qName);
            cls = org.hpccsystems.ws.client.soap.ecldirect.RunEclExResponse.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = org.hpccsystems.ws.client.soap.ecldirect.ECLDirectException[].class;
            cachedSerClasses.add(cls);
            ...
            cachedSerQNames.add(qName);
            cls = org.hpccsystems.ws.client.soap.ecldirect.ArrayOfEspException.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = org.hpccsystems.ws.client.soap.ecldirect.EspException.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = org.hpccsystems.ws.client.soap.ecldirect.RunEclExFormat.class;
            cachedSerClasses.add(cls);
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {parameters});
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            try {
                return (org.hpccsystems.ws.client.soap.ecldirect.RunEclExResponse) _resp;
            } catch (java.lang.Exception _exception) {
                return (org.hpccsystems.ws.client.soap.ecldirect.RunEclExResponse) org.apache.axis.utils.JavaUtils.convert(_resp, org.hpccsystems.ws.client.soap.ecldirect.RunEclExResponse.class);
            }
        }
    ...
    if (axisFaultException.detail != null) {
        ...
        if (axisFaultException.detail instanceof org.hpccsystems.ws.client.soap.ecldirect.ArrayOfEspException) {
              throw (org.hpccsystems.ws.client.soap.ecldirect.ArrayOfEspException) axisFaultException.detail;
         }
   }
