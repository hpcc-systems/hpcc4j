...
public class RunEclExRequest  implements java.io.Serializable {
    ...
    private org.hpccsystems.ws.client.soap.ecldirect.RunEclExFormat format;
    ...
    public RunEclExRequest(
           ...
           org.hpccsystems.ws.client.soap.ecldirect.RunEclExFormat format,
     ...
     * @return format
     */
    public org.hpccsystems.ws.client.soap.ecldirect.RunEclExFormat getFormat() {
        return format;
    }
     ...
     * @param format
     */
    public void setFormat(org.hpccsystems.ws.client.soap.ecldirect.RunEclExFormat format) {
        this.format = format;
    }
