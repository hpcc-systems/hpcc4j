...
public class WsWorkunitsLocator extends org.apache.axis.client.Service implements org.hpccsystems.ws.client.soap.wsworkunits.WsWorkunits {
    ...
    public org.hpccsystems.ws.client.soap.wsworkunits.WsWorkunitsServiceSoap getWsWorkunitsServiceSoap() throws javax.xml.rpc.ServiceException {
    ...
    public org.hpccsystems.ws.client.soap.wsworkunits.WsWorkunitsServiceSoap getWsWorkunitsServiceSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            org.hpccsystems.ws.client.soap.wsworkunits.WsWorkunitsServiceSoapStub _stub = new org.hpccsystems.ws.client.soap.wsworkunits.WsWorkunitsServiceSoapStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (org.hpccsystems.ws.client.soap.wsworkunits.WsWorkunitsServiceSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                org.hpccsystems.ws.client.soap.wsworkunits.WsWorkunitsServiceSoapStub _stub = new org.hpccsystems.ws.client.soap.wsworkunits.WsWorkunitsServiceSoapStub(new java.net.URL(WsWorkunitsServiceSoap_address), this);
                _stub.setPortName(getWsWorkunitsServiceSoapWSDDServiceName());
                return _stub;
            }
        }
