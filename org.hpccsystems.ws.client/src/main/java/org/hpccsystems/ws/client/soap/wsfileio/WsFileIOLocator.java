...
public class WsFileIOLocator extends org.apache.axis.client.Service implements org.hpccsystems.ws.client.soap.wsfileio.WsFileIO {
    ...
    public org.hpccsystems.ws.client.soap.wsfileio.WsFileIOServiceSoap getWsFileIOServiceSoap() throws javax.xml.rpc.ServiceException {
    ...
    public org.hpccsystems.ws.client.soap.wsfileio.WsFileIOServiceSoap getWsFileIOServiceSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            org.hpccsystems.ws.client.soap.wsfileio.WsFileIOServiceSoapStub _stub = new org.hpccsystems.ws.client.soap.wsfileio.WsFileIOServiceSoapStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (org.hpccsystems.ws.client.soap.wsfileio.WsFileIOServiceSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                org.hpccsystems.ws.client.soap.wsfileio.WsFileIOServiceSoapStub _stub = new org.hpccsystems.ws.client.soap.wsfileio.WsFileIOServiceSoapStub(new java.net.URL(WsFileIOServiceSoap_address), this);
                _stub.setPortName(getWsFileIOServiceSoapWSDDServiceName());
                return _stub;
            }
        }
