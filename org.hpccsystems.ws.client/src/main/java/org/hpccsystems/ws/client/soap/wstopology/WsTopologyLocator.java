...
public class WsTopologyLocator extends org.apache.axis.client.Service implements org.hpccsystems.ws.client.soap.wstopology.WsTopology {
    ...
    public org.hpccsystems.ws.client.soap.wstopology.WsTopologyServiceSoap getWsTopologyServiceSoap() throws javax.xml.rpc.ServiceException {
    ...
    public org.hpccsystems.ws.client.soap.wstopology.WsTopologyServiceSoap getWsTopologyServiceSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            org.hpccsystems.ws.client.soap.wstopology.WsTopologyServiceSoapStub _stub = new org.hpccsystems.ws.client.soap.wstopology.WsTopologyServiceSoapStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (org.hpccsystems.ws.client.soap.wstopology.WsTopologyServiceSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                org.hpccsystems.ws.client.soap.wstopology.WsTopologyServiceSoapStub _stub = new org.hpccsystems.ws.client.soap.wstopology.WsTopologyServiceSoapStub(new java.net.URL(WsTopologyServiceSoap_address), this);
                _stub.setPortName(getWsTopologyServiceSoapWSDDServiceName());
                return _stub;
            }
        }
