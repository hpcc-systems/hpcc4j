...
public class WsDfuLocator extends org.apache.axis.client.Service implements org.hpccsystems.ws.client.soap.wsdfu.WsDfu {
    ...
    public org.hpccsystems.ws.client.soap.wsdfu.WsDfuServiceSoap getWsDfuServiceSoap() throws javax.xml.rpc.ServiceException {
    ...
    public org.hpccsystems.ws.client.soap.wsdfu.WsDfuServiceSoap getWsDfuServiceSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            org.hpccsystems.ws.client.soap.wsdfu.WsDfuServiceSoapStub _stub = new org.hpccsystems.ws.client.soap.wsdfu.WsDfuServiceSoapStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (org.hpccsystems.ws.client.soap.wsdfu.WsDfuServiceSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                org.hpccsystems.ws.client.soap.wsdfu.WsDfuServiceSoapStub _stub = new org.hpccsystems.ws.client.soap.wsdfu.WsDfuServiceSoapStub(new java.net.URL(WsDfuServiceSoap_address), this);
                _stub.setPortName(getWsDfuServiceSoapWSDDServiceName());
                return _stub;
            }
        }
