...
public class EclDirectLocator extends org.apache.axis.client.Service implements org.hpccsystems.ws.client.soap.ecldirect.EclDirect {
    ...
    public org.hpccsystems.ws.client.soap.ecldirect.EclDirectServiceSoap getEclDirectServiceSoap() throws javax.xml.rpc.ServiceException {
    ...
    public org.hpccsystems.ws.client.soap.ecldirect.EclDirectServiceSoap getEclDirectServiceSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            org.hpccsystems.ws.client.soap.ecldirect.EclDirectServiceSoapStub _stub = new org.hpccsystems.ws.client.soap.ecldirect.EclDirectServiceSoapStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (org.hpccsystems.ws.client.soap.ecldirect.EclDirectServiceSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                org.hpccsystems.ws.client.soap.ecldirect.EclDirectServiceSoapStub _stub = new org.hpccsystems.ws.client.soap.ecldirect.EclDirectServiceSoapStub(new java.net.URL(EclDirectServiceSoap_address), this);
                _stub.setPortName(getEclDirectServiceSoapWSDDServiceName());
                return _stub;
            }
        }
