...
public class ArrayOfEspException  extends org.apache.axis.AxisFault  implements java.io.Serializable {
    ...
    private org.hpccsystems.ws.client.legacy.soap.EspException[] exception;
    ...
    public ArrayOfEspException(
           ...
           org.hpccsystems.ws.client.legacy.soap.EspException[] exception) {
        this.source = source;
     ...
     * @return exception
     */
    public org.hpccsystems.ws.client.legacy.soap.EspException[] getException() {
        return exception;
    }
     ...
     * @param exception
     */
    public void setException(org.hpccsystems.ws.client.legacy.soap.EspException[] exception) {
        this.exception = exception;
    }

    public org.hpccsystems.ws.client.legacy.soap.EspException getException(int i) {
        return this.exception[i];
    }

    public void setException(int i, org.hpccsystems.ws.client.legacy.soap.EspException _value) {
