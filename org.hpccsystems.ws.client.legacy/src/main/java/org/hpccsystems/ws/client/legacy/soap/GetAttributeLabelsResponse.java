...
public class GetAttributeLabelsResponse  implements java.io.Serializable {
    ...
    private org.hpccsystems.ws.client.legacy.soap.ECLAttributeLabel[] labels;
    ...
    public GetAttributeLabelsResponse(
           ...
           org.hpccsystems.ws.client.legacy.soap.ECLAttributeLabel[] labels) {
     ...
     * @return labels
     */
    public org.hpccsystems.ws.client.legacy.soap.ECLAttributeLabel[] getLabels() {
        return labels;
    }
     ...
     * @param labels
     */
    public void setLabels(org.hpccsystems.ws.client.legacy.soap.ECLAttributeLabel[] labels) {
        this.labels = labels;
    }
