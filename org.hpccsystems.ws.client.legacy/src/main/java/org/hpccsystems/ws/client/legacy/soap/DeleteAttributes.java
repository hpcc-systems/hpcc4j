...
public class DeleteAttributes  implements java.io.Serializable {
    private org.hpccsystems.ws.client.legacy.soap.DeleteAttributeRequest[] attributes;

    public DeleteAttributes() {
    }

    public DeleteAttributes(
           org.hpccsystems.ws.client.legacy.soap.DeleteAttributeRequest[] attributes) {
     ...
     * @return attributes
     */
    public org.hpccsystems.ws.client.legacy.soap.DeleteAttributeRequest[] getAttributes() {
        return attributes;
    }
     ...
     * @param attributes
     */
    public void setAttributes(org.hpccsystems.ws.client.legacy.soap.DeleteAttributeRequest[] attributes) {
        this.attributes = attributes;
    }
