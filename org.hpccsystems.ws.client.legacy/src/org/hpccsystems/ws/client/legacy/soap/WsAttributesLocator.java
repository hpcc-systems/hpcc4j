...
public class WsAttributesLocator extends org.apache.axis.client.Service implements org.hpccsystems.ws.client.legacy.soap.WsAttributes {
    ...
    public org.hpccsystems.ws.client.legacy.soap.WsAttributesServiceSoap getWsAttributesServiceSoap() throws javax.xml.rpc.ServiceException {
    ...
    public org.hpccsystems.ws.client.legacy.soap.WsAttributesServiceSoap getWsAttributesServiceSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            org.hpccsystems.ws.client.legacy.soap.WsAttributesServiceSoapStub _stub = new org.hpccsystems.ws.client.legacy.soap.WsAttributesServiceSoapStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (org.hpccsystems.ws.client.legacy.soap.WsAttributesServiceSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                org.hpccsystems.ws.client.legacy.soap.WsAttributesServiceSoapStub _stub = new org.hpccsystems.ws.client.legacy.soap.WsAttributesServiceSoapStub(new java.net.URL(WsAttributesServiceSoap_address), this);
                _stub.setPortName(getWsAttributesServiceSoapWSDDServiceName());
                return _stub;
            }
        }
