...
public class ListAttributeTypesResponse  implements java.io.Serializable {
    private org.hpccsystems.ws.client.legacy.soap.AttributeType[] types;

    public ListAttributeTypesResponse() {
    }

    public ListAttributeTypesResponse(
           org.hpccsystems.ws.client.legacy.soap.AttributeType[] types) {
           this.types = types;
    }
     ...
     * @return types
     */
    public org.hpccsystems.ws.client.legacy.soap.AttributeType[] getTypes() {
        return types;
    }
     ...
     * @param types
     */
    public void setTypes(org.hpccsystems.ws.client.legacy.soap.AttributeType[] types) {
        this.types = types;
    }
