...
public class DefToken
{
    ...
    private DefToken(JsonToken tok, Integer parent, String name, String s, int lvl, int pos)
    {
        this.tok = tok;
        this.parent = parent;
        this.name = name;
    ...
    private DefToken(JsonToken tok, Integer parent, String name, double d, int lvl, int pos)
    {
        this.tok = tok;
        this.parent = parent;
        this.name = name;
    ...
    private DefToken(JsonToken tok, Integer parent, String name, long l, int lvl, int pos)
    {
        this.tok = tok;
        this.parent = parent;
        this.name = name;
    ...
    private DefToken(JsonToken tok, Integer parent, String name, boolean b, int lvl, int pos)
    {
        this.tok = tok;
        this.parent = parent;
        this.name = name;
    ...
    {
        return this.tok == JsonToken.START_OBJECT;
    }
    ...
    {
        return this.tok == JsonToken.END_ARRAY;
    }
    ...
    {
        return this.tok == JsonToken.START_ARRAY;
    }
    ...
    {
        return this.position == 0 || this.position == this.parent + 1;
    }
    ...
    {
        return (open == JsonToken.START_OBJECT && close == JsonToken.END_OBJECT) || (open == JsonToken.START_ARRAY && close == JsonToken.END_ARRAY);
    }
     ...
     */
    public static DefToken[] parseDefString(String def) throws JsonParseException
    {
            ...
            while (tok != null)
            {
                ...
                switch (tok)
                {
                    ...
                    case VALUE_FALSE:
                        ...
                        break;
                    case VALUE_STRING:
                        String str = (DefToken.hasControlChar(jp.getText())) ? DefToken.escapeControls(jp.getText()) : jp.getText();
