...
public class DataPartition implements /*Partition,*/ Serializable {
   ...
   */
  public int getCopyCount() { return copyLocations.length; }
  /**
  ...
  private static Comparator<DFUFilePartInfo> FilePartInfoComparator
    ...
    public static DataPartition[] createPartitions(DFUFilePartWrapper[] dfuparts, ClusterRemapper clusterremapper,
                                                   int max_parts, FileFilter filter, String fileAccessBlob) throws HpccFileException
    {
